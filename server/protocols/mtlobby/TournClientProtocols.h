...
#ifndef ATF_PROTOCOL_DEFFILE_TOURNCLIENTPROTOCOLS_H
#define ATF_PROTOCOL_DEFFILE_TOURNCLIENTPROTOCOLS_H
...
namespace TournClient
{
	...
	{
		//! 1111 <FIXME>TableCommon::TableStakes</FIXME>  - blindsLevel,handType,structure,hilo, <FIXME>stakes</FIXME> 
		BYTE blindsLevel;
		BYTE handType;
		BYTE structure;
		BYTE hilo;
		TableCommon::TableStakes stakes;
	...
	{
		//! M( <FIXME>TableCommon::TableStakes</FIXME> 44) - M( <FIXME>stakes</FIXME> ,levelTime,addTimeBank)
		TableCommon::TableStakes stakes;
		UINT32 levelTime;
		UINT32 addTimeBank;
	...
	namespace publication
	{
		struct TournSubscr_Static	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_STATIC_LEAF }
		{
			...
			bool _obsolete_3;
			Atf::LAtfVector< P_FppReward, 4 > vppToPublish;
			BYTE speedDisplay;
			PString tournBrand;
			INT32 scalePM;
			...
			INT32 multidayIndex;
			Atf::LAtfVector< LobbyData_MultidayTourn, 4 > multiDayVec;
			PString criteria;
		...
		struct TournSubscr_BettingNew	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_DYNAMIC_BETTING_LEAF_NEW }
		{
			...
			//! M(1111 <FIXME>TableCommon::TableStakes</FIXME> )M(1111 <FIXME>TableCommon::TableStakes</FIXME> )4t2 - M(blindsLevel,handType,structure,hilo, <FIXME>stakes</FIXME> ),M(blindsLevel,handType,structure,hilo, <FIXME>stakes</FIXME> ),nextLevelStart,nextLevelStartTime,olympicLevel
			_CLevelType cLevel;
			_NLevelType nLevel;
		...
		struct TournSubscr_Awards	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_DYNAMIC_AWARDS_LEAF }
		{
			...
			Atf::LAtfVector< INT32, 4 > prizes;
			UINT32 nTickets;	// number of awards with non-0 nextTournIds
			Atf::LAtfVector< UINT32, 4 > nextTournIds;
			INT32 creditPlayer;
		...
		struct TournSubscr_AwardsPrelim	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_DYNAMIC_PRELIM_AWARDS_LEAF }
		{
			...
			UINT32 numPaid;
			UINT32 numTickets;
			Atf::LAtfVector< P_AwardRange, 4 > awardRanges;
		...
		struct TournSubscr_HappyHours	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_DYNAMIC_HAPPY_HOURS_LEAF }
		{
			...
			Atf::LAtfVector< FppFactor, 2 > happyHourMultipliers;
		...
		struct TournSubscr_Autopublish	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_AUTOPUBLISH_LEAF }
		{
			...
			Atf::LAtfVector< P_AutopublishBody, 4 > autoPublishBodies;
		...
		struct TournSimpleAutoDealSubscr
		{
			...
			Atf::LAtfVector< P_ParticipantsInfo, 4 > participantsInfo;
			INT32 dealExclusion;
			INT8 type0;
			INT8 type1;
			...
			INT8 userAgreed1;
			PString currency;
			Atf::LAtfVector< P_DealPayout, 4 > dealPayouts;
		...
		{
			//! 4<M( <FIXME>TableCommon::TableStakes</FIXME> 44)>4444< <FIXME>BlindLevelIntervalRule</FIXME> > - numStakeLevels<M( <FIXME>stakes</FIXME> ,levelTime,addTimeBank)>,finalTableTimeBank,addRoundTimeBank,currRule,numNumRules< <FIXME>BlindLevelIntervalRule</FIXME> >
			Atf::LAtfVector< ExtraInfo_StakesLevel, 4 > stakeLevels;
			UINT32 finalTableTimeBank;
			UINT32 addRoundTimeBank;
			INT32 currRule;
			Atf::LAtfVector< BlindLevelIntervalRule, 4 > numRules;
		...
		struct TournExtraSubscr_Breaks	// Path { PUBL_TOURN_INFO_ROOT, PUBL_TOURN_INFO_BREAKS_LEAF }
		{
			...
			Atf::LAtfVector< P_BreakPub, 4 > breaks;
		...
		{
			//! 4< <FIXME>TournCommon::P_Event</FIXME> >sb4 - numHandByHandRanges< <FIXME>TournCommon::P_Event</FIXME> >,targetServer,isSatelliteData,fallBackSatTargetSize
			Atf::LAtfVector< TournCommon::P_Event, 4 > handByHandRanges;
		...
		struct TournStormSubscr
		{
			...
			bool stormAllowed;
			Atf::LAtfVector< INT32, 4 > powerCostBase;
			Atf::LAtfVector< Atf::CopyableMsgBody, 4 > powers;
		...
		{
			//! ss4414s142 <FIXME>BrandProt::BrandImageList</FIXME> 8s448 - name,city,place,placeTo,publProp,bounty,country,showCity,imageId,entryNum, <FIXME>brandImageList</FIXME> ,tournId,admission,tChips,tournUsersFlags,pppEntryId
			PString name;
			PString city;
			INT32 place;
			INT32 placeTo;
		...
		{
			//! M(1s4s11444 <FIXME>BrandProt::BrandImageList</FIXME> ) - M(position,userName,chips,cityData,showCity,publProp,headBounty,collectedBountyKnockouts,imageId, <FIXME>brandImageList</FIXME> )
			BYTE position;
			PString userName;
			INT32 chips;
			PString cityData;
		...
		{
			//! 11<M(1s4s11444 <FIXME>BrandProt::BrandImageList</FIXME> )> - oldSubCount,numPlayers<M(position,userName,chips,cityData,showCity,publProp,headBounty,collectedBountyKnockouts,imageId, <FIXME>brandImageList</FIXME> )>
			BYTE oldSubCount;
			Atf::LAtfVector< TournTablePlayerSubscr, 1 > players;
	...
	namespace player
	{
		...
		struct Protocol_MSG_LOBBY_TOURN_REG_INFO_REPLY : public Atf::MessageProtocol
		{
			...
			bool isProportional;
			INT64 admPrice;
			Atf::LAtfVector< P_UserTicketData, 4 > effectiveAdmissions;
			INT64 tournFlags2;
		...
		struct Protocol_MTL_CLI_GOTO_FINISH : public Atf::MessageProtocol
		{
			...
			const char *getMsgIdString() const override { return "MTL_CLI_GOTO_FINISH"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_CLI_GOTO_TABLE : public Atf::MessageProtocol
		{
			...
			const char *getMsgIdString() const override { return "MTL_CLI_GOTO_TABLE"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
