...
#ifndef ATF_PROTOCOL_DEFFILE_UPSERVERPROT_THIN_H
#define ATF_PROTOCOL_DEFFILE_UPSERVERPROT_THIN_H
...
namespace UPServer
{
	...
	struct UserPropertyNotification
	{
		// M(4M()) - M(userIntId,M())
		UINT32 userIntId;
		ThinAtf::CopyableMsgBody userPropBody;
	...
	struct PropertyForServer
	{
		...
		ThinAtf::CopyableMsgBody propertyBody;
	...
	struct UserPropertyNotificationForServer
	{
		...
		UINT32 userIntId;
		bool isObserver;
		ThinAtf::LAtfVector< PropertyForServer, 4 > properties;
	...
	struct Protocol_UPS_Q_USERS_JOIN
	{
		...
		static UINT32 getMsgId() { return UPS_Q_USERS_JOIN; }
		static const char *getMsgIdString() { return "UPS_Q_USERS_JOIN"; }
	...
	struct Protocol_UPS_A_USERS_JOIN
	{
		// 2[s] - errCode[errStr]
		INT16 errCode;
		...
		static UINT32 getMsgId() { return UPS_A_USERS_JOIN; }
		static const char *getMsgIdString() { return "UPS_A_USERS_JOIN"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_Q_USERS_LEFT
	{
		// 4<4> - numUserIntIds<userIntIds>
		ThinAtf::LAtfVector< UINT32, 4 > userIntIds;
		...
		static UINT32 getMsgId() { return UPS_Q_USERS_LEFT; }
		static const char *getMsgIdString() { return "UPS_Q_USERS_LEFT"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_A_USERS_LEFT
	{
		// 2[s] - errCode[errStr]
		INT16 errCode;
		...
		static UINT32 getMsgId() { return UPS_A_USERS_LEFT; }
		static const char *getMsgIdString() { return "UPS_A_USERS_LEFT"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_Q_SET_PROPERTY
	{
		...
		static UINT32 getMsgId() { return UPS_Q_SET_PROPERTY; }
		static const char *getMsgIdString() { return "UPS_Q_SET_PROPERTY"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_A_SET_PROPERTY
	{
		// 2[s] - errCode[errStr]
		INT16 errCode;
		...
		static UINT32 getMsgId() { return UPS_A_SET_PROPERTY; }
		static const char *getMsgIdString() { return "UPS_A_SET_PROPERTY"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	// !!! WARNING !!! If you modify this message, please let testautomation team know.
	struct Protocol_UPS_NOTIFY_PROPERTY_UPDATED
	{
		// 4<M(4M())> - numUserPropertyNotification<M(userIntId,M())>
		ThinAtf::LAtfVector< UserPropertyNotification, 4 > userPropertyNotification;
		...
		static UINT32 getMsgId() { return UPS_NOTIFY_PROPERTY_UPDATED; }
		static const char *getMsgIdString() { return "UPS_NOTIFY_PROPERTY_UPDATED"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_NOTIFY_PROPERTY_UPDATED_SERVER
	{
		// 4<M(4b4<M(4M())>)> - numUserPropertyNotification<M(userIntId,isObserver,numProperties<M(propertyTypeId,M())>)>
		ThinAtf::LAtfVector< UserPropertyNotificationForServer, 4 > userPropertyNotification;
		...
		static UINT32 getMsgId() { return UPS_NOTIFY_PROPERTY_UPDATED_SERVER; }
		static const char *getMsgIdString() { return "UPS_NOTIFY_PROPERTY_UPDATED_SERVER"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_NOTIFY_PROPERTY_ONE_TIME_NOTIFICATION_SERVER
	{
		...
		ThinAtf::MoveableMsgBody notifMsg;
		...
		static UINT32 getMsgId() { return UPS_NOTIFY_PROPERTY_ONE_TIME_NOTIFICATION_SERVER; }
		static const char *getMsgIdString() { return "UPS_NOTIFY_PROPERTY_ONE_TIME_NOTIFICATION_SERVER"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_Q_OBSERVERS_JOIN
	{
		...
		static UINT32 getMsgId() { return UPS_Q_OBSERVERS_JOIN; }
		static const char *getMsgIdString() { return "UPS_Q_OBSERVERS_JOIN"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_A_OBSERVERS_JOIN
	{
		// 2[s] - errCode[errStr]
		INT16 errCode;
		...
		static UINT32 getMsgId() { return UPS_A_OBSERVERS_JOIN; }
		static const char *getMsgIdString() { return "UPS_A_OBSERVERS_JOIN"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_Q_OBSERVERS_LEFT
	{
		// 4<4>81 - numUserIntIds<userIntIds>,gameId,entryType
		ThinAtf::LAtfVector< UINT32, 4 > userIntIds;
		...
		static UINT32 getMsgId() { return UPS_Q_OBSERVERS_LEFT; }
		static const char *getMsgIdString() { return "UPS_Q_OBSERVERS_LEFT"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_UPS_A_OBSERVERS_LEFT
	{
		// 2[s] - errCode[errStr]
		INT16 errCode;
		...
		static UINT32 getMsgId() { return UPS_A_OBSERVERS_LEFT; }
		static const char *getMsgIdString() { return "UPS_A_OBSERVERS_LEFT"; }
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
