	...
	) // IMPORTANT: remember to change composeUserAuthMsgForUserIntId() below at the same time
{
	...
	switch(objectType)
	{
		case OBJ_TYPE_LOBBY:
		case OBJ_TYPE_TABLE:
		case OBJ_TYPE_MT_LOBBY:
		case OBJ_TYPE_CASHIER:
		case OBJ_TYPE_CHATSERV:
		case OBJ_TYPE_AUTH:
		case OBJ_TYPE_VIPSTORE:
		case OBJ_TYPE_REPLAY:
		case OBJ_TYPE_HG_LOBBY:
		case OBJ_TYPE_VOICECONTROL:
		case OBJ_TYPE_VOICEDATA:
		case OBJ_TYPE_AUTH_DK:
		case OBJ_TYPE_REGULATOR:
		case OBJ_TYPE_BLITZ_LOBBY:
		case OBJ_TYPE_WEBCASHIER:
		case OBJ_TYPE_UISTATS: // #21206
		case OBJ_TYPE_WEBTOKENSERVER: // PYR-25104
		case OBJ_TYPE_LOBBY_ETC:		//	PYR-25263
		case OBJ_TYPE_BLITZ_REPLAYER:  // PYR-26767
		case OBJ_TYPE_PMCASHIER: // PYR-26426
		case OBJ_TYPE_SAGLOBBY: // PYR-28752
		case OBJ_TYPE_ICECLIENTPROXY: // PYR-29927
		case _OBJ_TYPE_AUXHUB: // PYR-30319
		case _OBJ_TYPE_TABLE_SUBSCR_OVER_CONN:  // PYR-30088
		case _OBJ_TYPE_WEB_ACCOUNT_SERVICE: // PYR-32117
		case _OBJ_TYPE_SPORTSBOOK: // SBK-57
		case _OBJ_TYPE_RATIONAL_WEB_SERVICES:	// PYR-33799
		case _OBJ_TYPE_DAILY_FANTASY_SPORTS: // PYR-36465
		case _OBJ_TYPE_WEB_PULL_NOTIFICATIONS: // PYR-37887
		case _OBJ_TYPE_WEB_PUSH_NOTIFICATIONS: // PYR-37887
		case _OBJ_TYPE_REGULATOR_FTP_MIGRATE: // PYR-40997
		case _OBJ_TYPE_MG_LOBBY: // PYR-40426
		case _OBJ_TYPE_SNGLOBBY: // PYR-39272
		case _OBJ_TYPE_RCS: // PYR-43217
		case _OBJ_TYPE_POOL_BETTING: // PYR-42410
		case OBJ_TYPE_CRMSERVER: // PYR-54140
		case _OBJ_TYPE_GLOBAL_PUBLISHER: // PYR-52524
		case _OBJ_TYPE_PREDICTOR: // PYR-63214
		case _OBJ_TYPE_INSTANTHANDHISTORY_RETRIEVER:  // PYR-72484
		case _OBJ_TYPE_PERSONALIZATION: // PYR-66899
		case _OBJ_TYPE_SOCIALCASINO: //PYR-77583
		case _OBJ_TYPE_STARSSTORE: // PYR-81644
		case _OBJ_TYPE_PPPLOBBY: // PYR-114749
		case _OBJ_TYPE_HUBFEED: // PYR-124676
		case _OBJ_TYPE_POKER_DOJO: //	PYR-126838
		{
			request
