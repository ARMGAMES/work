...
#ifndef ATF_PROTOCOL_DEFFILE_PPPCLIENTPROT_H
#define ATF_PROTOCOL_DEFFILE_PPPCLIENTPROT_H
...
namespace PPPClient
{
	...
	namespace publication
	{
		...
		struct PppVisibility
		{
			...
			Atf::LAtfVector< PString , 4 > countries;	// country inclusion/exclusion list
		...
		private: // helper functions
			...
			void parseAnonymousMsgBody0(Atf::MsgParserWithJSON& _parser);
		...
		struct PppStaticLeaf	// Leaf { 0, n, 0 }
		{
			...
			Atf::LAtfVector< PppBuyInTierInfo, 4 > buyInTiers;
		...
		struct PppDynamicLeaf	// Leaf { 0, n, 1 }
		{
			...
			Atf::LAtfVector< PppFeaturedKO , 4 > featuredKOs;	// featured KOs info
			Atf::LAtfVector< PppFeaturedFinisher , 4 > featuredFinishers;	// featured finishers info
	...
	namespace client
	{
		struct Protocol_MSG_PPP_REG_INFO : public Atf::MessageProtocol
		{
			...
			UINT32 getMsgId() const override { return MSG_PPP_REG_INFO; }
			const char *getMsgIdString() const override { return "MSG_PPP_REG_INFO"; }
		...
		struct Protocol_MSG_PPP_REG_INFO_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_REG_INFO_REPLY; }
			const char *getMsgIdString() const override { return "MSG_PPP_REG_INFO_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_PPP_REGISTER_USER : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_REGISTER_USER; }
			const char *getMsgIdString() const override { return "MSG_PPP_REGISTER_USER"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_PPP_REGISTER_USER_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_REGISTER_USER_REPLY; }
			const char *getMsgIdString() const override { return "MSG_PPP_REGISTER_USER_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_PPP_UNREGISTER_USER : public Atf::MessageProtocol
		{
			// 48 - pppId,pppEntryId
			UINT32 pppId;
			UINT64 pppEntryId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_UNREGISTER_USER; }
			const char *getMsgIdString() const override { return "MSG_PPP_UNREGISTER_USER"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_PPP_UNREGISTER_USER_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_UNREGISTER_USER_REPLY; }
			const char *getMsgIdString() const override { return "MSG_PPP_UNREGISTER_USER_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_PPP_GET_ENTRIES : public Atf::MessageProtocol
		{
			// empty msg
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_GET_ENTRIES; }
			const char *getMsgIdString() const override { return "MSG_PPP_GET_ENTRIES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_PPP_GET_ENTRIES_REPLY : public Atf::MessageProtocol
		{
			...
			Atf::LAtfVector< PppEntry, 4 > entries;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_GET_ENTRIES_REPLY; }
			const char *getMsgIdString() const override { return "MSG_PPP_GET_ENTRIES_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_PPP_SET_ENTRY_STATUS : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_SET_ENTRY_STATUS; }
			const char *getMsgIdString() const override { return "MSG_PPP_SET_ENTRY_STATUS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_PPP_SET_ENTRY_STATUS_REPLY : public Atf::MessageProtocol
		{
			// 2[s] - errCode[errMsg]
			INT16 errCode;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_PPP_SET_ENTRY_STATUS_REPLY; }
			const char *getMsgIdString() const override { return "MSG_PPP_SET_ENTRY_STATUS_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
