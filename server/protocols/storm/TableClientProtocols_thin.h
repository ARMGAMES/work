...
#ifndef ATF_PROTOCOL_DEFFILE_TABLECLIENTPROTOCOLS_THIN_H
#define ATF_PROTOCOL_DEFFILE_TABLECLIENTPROTOCOLS_THIN_H
...
namespace TableClientThin
{
	...
	{
		//! 1 <FIXME>TableCommonThin::P_Card</FIXME>  - pos, <FIXME>card</FIXME> 
		BYTE pos;
		TableCommonThin::P_Card card;
	...
	struct CardInfo
	{
		//! 11 <FIXME>TableCommonThin::P_Card</FIXME>  - playerOrboard,pos, <FIXME>card</FIXME> 
	...
	struct CardInfoBody
	{
		//! M(11 <FIXME>TableCommonThin::P_Card</FIXME> ) - M(playerOrboard,pos, <FIXME>card</FIXME> )
		CardInfo c;
	...
	namespace player
	{
		struct ClientMsg_TxtEx_NSF	// TODO: is this name okay?
		{
			...
			ThinAtf::CopyableMsgBody clientCurrencyContextShort;
			ThinAtf::CopyableMsgBody rebuyOrAddonData;
		...
		struct Protocol_MSG_TABLE_LOGIN
		{
			...
			static const char *getMsgIdString() { return "LGN"; }
		...
		struct Protocol_MSG_TABLE_LOGIN_REPLY
		{
			...
			ThinAtf::CopyableMsgBody clientMsg_txtEx;	//alias m
			...
			static const char *getMsgIdString() { return "LGNR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_LOGOUT
		{
			...
			static const char *getMsgIdString() { return "LGO"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};
		...
		struct Protocol_MSG_TABLE_LOGOUT_REPLY
		{
			...
			static const char *getMsgIdString() { return "LGOR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_USER_POOL_BLOCK_STATE_UPDATE
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_USER_POOL_BLOCK_STATE_UPDATE; }
			static const char *getMsgIdString() { return "PBU"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SIT1
		{
			// 14 - seat,verifyKey
			...
			static UINT32 getMsgId() { return MSG_TABLE_SIT1; }
			static const char *getMsgIdString() { return "SIT1"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SIT1_REPLY
		{
			...
			ThinAtf::CopyableMsgBody clientMsg_txtEx;	//alias m
			ThinAtf::CopyableMsgBody currencyContextCli;	//alias currency
			...
			static UINT32 getMsgId() { return MSG_TABLE_SIT1_REPLY; }
			static const char *getMsgIdString() { return "SIT1R"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SIT2
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SIT2; }
			static const char *getMsgIdString() { return "SIT2"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SIT2_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SIT2_REPLY; }
			static const char *getMsgIdString() { return "SIT2R"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_TIMEBANK
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_TIMEBANK; }
			static const char *getMsgIdString() { return "TB"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_WARNING_BELL
		{
			// 4 - delaySec
			INT32 delaySec;
			...
			static UINT32 getMsgId() { return MSG_TABLE_WARNING_BELL; }
			static const char *getMsgIdString() { return "BEL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_REQUESTACTION
		{
			//!  <FIXME>vector01<P_PlayerRequestAction></FIXME> 44b4 -  <FIXME>actionOpts</FIXME> ,actionReqSeq,timeoutSec,isNewGame,gameRound
			ThinAtf::AtfVector0< P_PlayerRequestAction, 1 > actionOpts;	//alias aOpts
			...
			static UINT32 getMsgId() { return MSG_TABLE_REQUESTACTION; }
			static const char *getMsgIdString() { return "ARQ"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_ADDCHIPS_AUTO_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_ADDCHIPS_AUTO_REPLY; }
			static const char *getMsgIdString() { return "ADDCHIPSAUTOR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_FORCE_SITOUT
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_FORCE_SITOUT; }
			static const char *getMsgIdString() { return "MSG_TABLE_FORCE_SITOUT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_ADVANCED_BET
		{
			//!  <FIXME>vector01<P_PlayerBetOption></FIXME>  -  <FIXME>betOptions</FIXME> 
			ThinAtf::AtfVector0< P_PlayerBetOption, 1 > betOptions;
			...
			static UINT32 getMsgId() { return MSG_TABLE_ADVANCED_BET; }
			static const char *getMsgIdString() { return "ADB"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_STATISTIC
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_STATISTIC; }
			static const char *getMsgIdString() { return "STS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_HAND_RANK	// nver logged
		{
			//! ss11s11< <FIXME>TableCommonThin::P_Card </FIXME> >1< <FIXME>TableCommonThin::P_Card </FIXME> >1< <FIXME>TableCommonThin::P_Card </FIXME> >s11< <FIXME>TableCommonThin::P_Card </FIXME> > - strHi,strLo,bestHigh,bestLow,strHi2,bestHigh2,numCardsHigh< <FIXME>TableCommonThin::P_Card </FIXME> >,numCardsLow< <FIXME>TableCommonThin::P_Card </FIXME> >,numCardsHigh2< <FIXME>TableCommonThin::P_Card </FIXME> >,strLo2,bestLow2,numCardsLow2< <FIXME>TableCommonThin::P_Card </FIXME> >
			PString strHi;
			PString strLo;
			BYTE bestHigh;
			BYTE bestLow;
			PString strHi2;
			BYTE bestHigh2;
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cardsHigh;
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cardsLow;
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cardsHigh2;
			PString strLo2;
			BYTE bestLow2;
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cardsLow2;
			...
			static UINT32 getMsgId() { return MSG_TABLE_HAND_RANK; }
			static const char *getMsgIdString() { return "MSG_TABLE_HAND_RANK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_ADDCHIPS
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_ADDCHIPS; }
			static const char *getMsgIdString() { return "ADDCHIPS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_ADDCHIPS_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_ADDCHIPS_REPLY; }
			static const char *getMsgIdString() { return "ADDCHIPSR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_REBUYCHIPS
		{
			// 2 - numRebuys
			INT16 numRebuys;
			...
			static UINT32 getMsgId() { return MSG_TABLE_REBUYCHIPS; }
			static const char *getMsgIdString() { return "REBUYCHIPS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_REBUYCHIPS_REPLY
		{
			//! 1[sM()|4444444s822244444 <FIXME>TournCommonThin::TournSpendLimit</FIXME> ] - errcode[errstr,M()|chips,money,pChips,fppTaken,tChips,wChips,infoType,info,pChips64,rebuysDone,addonsDone,rebuysLeft,finalFlightTournId,moneyAfter,realMoney,realTChips,tChipsAfter, <FIXME>tournSpendLimit</FIXME> ]
			BYTE errcode;
			...
			static UINT32 getMsgId() { return MSG_TABLE_REBUYCHIPS_REPLY; }
			static const char *getMsgIdString() { return "REBUYCHIPSR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_ADDONCHIPS
		{
			// empty
			...
			static UINT32 getMsgId() { return MSG_TABLE_ADDONCHIPS; }
			static const char *getMsgIdString() { return "ADDON"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_ADDONCHIPS_REPLY
		{
			//! 1[sM()|4444444s822244444 <FIXME>TournCommonThin::TournSpendLimit</FIXME> ] - errcode[errstr,M()|chips,money,pChips,fppTaken,tChips,wChips,infoType,info,pChips64,rebuysDone,addonsDone,rebuysLeft,finalFlightTournId,moneyAfter,realMoney,realTChips,tChipsAfter, <FIXME>tournSpendLimit</FIXME> ]
			BYTE errcode;
			...
			static UINT32 getMsgId() { return MSG_TABLE_ADDONCHIPS_REPLY; }
			static const char *getMsgIdString() { return "ADDONR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_CHAT2
		{
			...
			static const char *getMsgIdString() { return "CHAT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_CHAT2_REPLY
		{
			...
			static const char *getMsgIdString() { return "CHATR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SITIN
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SITIN; }
			static const char *getMsgIdString() { return "SITIN"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SITIN_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SITIN_REPLY; }
			static const char *getMsgIdString() { return "SITINR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SITOUT
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SITOUT; }
			static const char *getMsgIdString() { return "SITOUT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SITOUT_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SITOUT_REPLY; }
			static const char *getMsgIdString() { return "SITOUTR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SITOUT_NEXTHAND
		{
			// 1 - checked
			...
			static UINT32 getMsgId() { return MSG_TABLE_SITOUT_NEXTHAND; }
			static const char *getMsgIdString() { return "SITOUTNH"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_CHIPSAVAIL
		{
			// empty
			...
			static UINT32 getMsgId() { return MSG_TABLE_CHIPSAVAIL; }
			static const char *getMsgIdString() { return "CHIPSAVAIL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_CHIPSAVAIL_REPLY
		{
			...
			ThinAtf::CopyableMsgBody clientMsg_txtEx;	//alias m
			ThinAtf::CopyableMsgBody currencyContext;	//alias currency
			...
			static UINT32 getMsgId() { return MSG_TABLE_CHIPSAVAIL_REPLY; }
			static const char *getMsgIdString() { return "CHIPSAVAILR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SET_AUTO_REBUY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SET_AUTO_REBUY; }
			static const char *getMsgIdString() { return "SETAREBUY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SET_AUTO_REBUY_REPLY
		{
			// 1 - errcode
			BYTE errcode;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SET_AUTO_REBUY_REPLY; }
			static const char *getMsgIdString() { return "SETAREBUYR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SET_SHOW_WHEN_ALLIN
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SET_SHOW_WHEN_ALLIN; }
			static const char *getMsgIdString() { return "SETALLIN"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SET_DEAL
		{
			// b - setOptions
			...
			static UINT32 getMsgId() { return MSG_TABLE_SET_DEAL; }
			static const char *getMsgIdString() { return "SETDEAL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SET_RUN_IT_TWICE_AND_MORE
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SET_RUN_IT_TWICE_AND_MORE; }
			static const char *getMsgIdString() { return "SETRIT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_REQUESTACTION_REPLY
		{
			// empty
			...
			static UINT32 getMsgId() { return MSG_TABLE_REQUESTACTION_REPLY; }
			static const char *getMsgIdString() { return "ARQR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_FAST_FOLD
		{
			// 81 - handId,flags
			...
			static UINT32 getMsgId() { return MSG_TABLE_FAST_FOLD; }
			static const char *getMsgIdString() { return "FASTFOLD"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_GOTO_NEXTHAND
		{
			// 8 - handId
			UINT64 handId;	//alias hI	// not limited
			...
			static UINT32 getMsgId() { return MSG_TABLE_GOTO_NEXTHAND; }
			static const char *getMsgIdString() { return "GNEXTH"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_REFRESH
		{
			// empty
			...
			static UINT32 getMsgId() { return MSG_TABLE_REFRESH; }
			static const char *getMsgIdString() { return "REFRESH"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_REFRESH_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_REFRESH_REPLY; }
			static const char *getMsgIdString() { return "REFRESH_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_PLAYNOW
		{
			// empty
			...
			static UINT32 getMsgId() { return MSG_TABLE_PLAYNOW; }
			static const char *getMsgIdString() { return "PLAYNOW"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_ENTROPY	// never logged
		{
			// v - enthropy
			PBlock enthropy;
			...
			static UINT32 getMsgId() { return MSG_TABLE_ENTROPY; }
			static const char *getMsgIdString() { return "MSG_TABLE_ENTROPY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_GET_DEAL
		{
			// empty
			...
			static UINT32 getMsgId() { return MSG_TABLE_GET_DEAL; }
			static const char *getMsgIdString() { return "GETDEAL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_GET_DEAL_REPLY
		{
			// b - dealOptionSet
			bool dealOptionSet;
			...
			static UINT32 getMsgId() { return MSG_TABLE_GET_DEAL_REPLY; }
			static const char *getMsgIdString() { return "GETDEALR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_ACTION
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_ACTION; }
			static const char *getMsgIdString() { return "ACT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_CANCELACTION
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_CANCELACTION; }
			static const char *getMsgIdString() { return "CXACT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		{
			//! s4[ <FIXME>TableCommonThin::P_ScheduledTournament</FIXME> ]4 - socialToken,nextRecurringTournId[ <FIXME>nextSchedTourn</FIXME> ],headBounty
			PString socialToken;	//alias token
			UINT32 nextRecurringTournId;	//alias nextId

			TableCommonThin::P_ScheduledTournament nextSchedTourn;
		...
		struct Protocol_MSG_TABLE_SIT_KICK
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SIT_KICK; }
			static const char *getMsgIdString() { return "SITKICK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SIT2_KICK
		{
			// sM() - kickstr,M()
			PString kickstr;
			ThinAtf::CopyableMsgBody clientMsg_txtEx;	//alias m
			...
			static UINT32 getMsgId() { return MSG_TABLE_SIT2_KICK; }
			static const char *getMsgIdString() { return "SIT2KICK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_MTT_CHANGETABLE
		{
			// 1s - errcode,msg
			BYTE errcode;
			PString msg;
			...
			static UINT32 getMsgId() { return MSG_TABLE_MTT_CHANGETABLE; }
			static const char *getMsgIdString() { return "CHGTBL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_ADMIN_INFO
		{
			// sM() - errstr,M()
			PString errstr;
			ThinAtf::CopyableMsgBody clientMsg_txtEx;	//alias m
			...
			static UINT32 getMsgId() { return MSG_TABLE_ADMIN_INFO; }
			static const char *getMsgIdString() { return "MSG_TABLE_ADMIN_INFO"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SAGMAX_USER_DRAW
		{
			// 4 - action
			...
			static UINT32 getMsgId() { return MSG_TABLE_SAGMAX_USER_DRAW; }
			static const char *getMsgIdString() { return "SAGDRAW"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SITTING_STATUS
		{
			// 1 - sittingStatus
			BYTE sittingStatus;	//alias ss
			...
			static UINT32 getMsgId() { return MSG_TABLE_SITTING_STATUS; }
			static const char *getMsgIdString() { return "SS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_BOUNTY_GREETINGS
		{
			//!  <FIXME>vector04<P_BOUNTY_GREETINGS></FIXME> 4 -  <FIXME>vec</FIXME> ,goldenSngBountyStub
			ThinAtf::AtfVector0< P_BOUNTY_GREETINGS, 4 > vec;
			...
			static UINT32 getMsgId() { return MSG_TABLE_BOUNTY_GREETINGS; }
			static const char *getMsgIdString() { return "BNTY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_START_CAMPING_PREVENTION
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_START_CAMPING_PREVENTION; }
			static const char *getMsgIdString() { return "STCAMP"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_AUTO_RELOAD_STACKS_NOTIFY
		{
			// 4 - stacksReloaded
			...
			static UINT32 getMsgId() { return MSG_TABLE_AUTO_RELOAD_STACKS_NOTIFY; }
			static const char *getMsgIdString() { return "ARSTACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_INVITE_CHOOSE_STARTING_STACKS
		{
			// 4 - unusedStacks
			INT32 unusedStacks;
			...
			static UINT32 getMsgId() { return MSG_TABLE_INVITE_CHOOSE_STARTING_STACKS; }
			static const char *getMsgIdString() { return "CHSSTACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_NSTACK_RELOAD
		{
			// 4 - reqStacks
			...
			static UINT32 getMsgId() { return MSG_TABLE_NSTACK_RELOAD; }
			static const char *getMsgIdString() { return "RLDSTACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_NSTACK_RELOAD_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_NSTACK_RELOAD_REPLY; }
			static const char *getMsgIdString() { return "RLDSTACKR"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_BLITZ_MTT_KICK
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_BLITZ_MTT_KICK; }
			static const char *getMsgIdString() { return "BMKICK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};
		...
		struct Protocol_MSG_TABLE_USER_SPECIFIC_BROADCAST
		{
			// 4<I4> - numNotifs<str,msgSeqId>
			ThinAtf::LAtfVector< PlayerNotifI18NMsg, 4 > notifs;
			...
			static UINT32 getMsgId() { return MSG_TABLE_USER_SPECIFIC_BROADCAST; }
			static const char *getMsgIdString() { return "USERSPEC"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_USER_CHAT_WARN
		{
			// 2s - warnMsgId,chat
			UINT16 warnMsgId;
			PString chat;
			...
			static UINT32 getMsgId() { return MSG_TABLE_USER_CHAT_WARN; }
			static const char *getMsgIdString() { return "CHATWARN"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_USER_CHAT_BAN
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_USER_CHAT_BAN; }
			static const char *getMsgIdString() { return "CHATBAN"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct HoleCardSnapshot
		{
			//! M(11< <FIXME>TableCommonThin::CardDictionaryItem</FIXME> >) - M(round,numHoleCards< <FIXME>TableCommonThin::CardDictionaryItem</FIXME> >)
			INT8 round;
			ThinAtf::LAtfVector< TableCommonThin::CardDictionaryItem, 1 > holeCards;
		...
		struct Protocol_MSG_TABLE_PLAYER_CARD_DICTIONARY_UPDATE	// never logged
		{
			//! 81< <FIXME>TableCommonThin::CardDictionaryItem</FIXME> >1< <FIXME>TableCommonThin::CardDictionaryItem</FIXME> >1<M(11< <FIXME>TableCommonThin::CardDictionaryItem</FIXME> >)> - handId,numMyHoleCards< <FIXME>TableCommonThin::CardDictionaryItem</FIXME> >,numOtherCards< <FIXME>TableCommonThin::CardDictionaryItem</FIXME> >,numOldHoleCards<M(round,numHoleCards< <FIXME>TableCommonThin::CardDictionaryItem</FIXME> >)>
			UINT64 handId;	//alias hI
			ThinAtf::LAtfVector< TableCommonThin::CardDictionaryItem, 1 > myHoleCards;
			ThinAtf::LAtfVector< TableCommonThin::CardDictionaryItem, 1 > otherCards;	// could be the old hole cards mapping or sensed cards in power-up
			ThinAtf::LAtfVector< HoleCardSnapshot, 1 > oldHoleCards;	// for draw or swap game (empty if no card drawn)
			...
			static UINT32 getMsgId() { return MSG_TABLE_PLAYER_CARD_DICTIONARY_UPDATE; }
			static const char *getMsgIdString() { return "MSG_TABLE_PLAYER_CARD_DICTIONARY_UPDATE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		{
			//! M(ss <FIXME>BrandProtThin::BrandImageList</FIXME> ) - M(alias,userId, <FIXME>img</FIXME> )
			PString alias;
			PString userId;
			BrandProtThin::BrandImageList img;
		...
		struct Protocol_MSG_TABLE_USER_DICTIONARY_UPDATE
		{
			//! 84<M(ss <FIXME>BrandProtThin::BrandImageList</FIXME> )> - handId,numUsers<M(alias,userId, <FIXME>img</FIXME> )>
			UINT64 handId;	// currently not used
			ThinAtf::LAtfVector< UserDictionaryItem, 4 > users;
			...
			static UINT32 getMsgId() { return MSG_TABLE_USER_DICTIONARY_UPDATE; }
			static const char *getMsgIdString() { return "MSG_TABLE_USER_DICTIONARY_UPDATE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_BLITZ_KICK
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_BLITZ_KICK; }
			static const char *getMsgIdString() { return "BKICK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		//=====================================

		struct Protocol_MSG_TABLE_POWER_CHOOSE_POWER_SLOTS
		{
			...
			ThinAtf::LAtfVector< INT32 , 4 > powers;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHOOSE_POWER_SLOTS; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHOOSE_POWER_SLOTS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_ACK
		{
			// 4 - powerActionSeqId
			UINT32 powerActionSeqId;	//alias pasq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_ACK; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_ACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_REPLY
		{
			// 44<4> - powerActionSeqId,numPowersChosen<powersChosen>
			UINT32 powerActionSeqId;	//alias pasq
			ThinAtf::LAtfVector< INT32 , 4 > powersChosen;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_CANCEL
		{
			// 4 - powerActionSeqId
			UINT32 powerActionSeqId;	//alias pasq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_CANCEL; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHOOSE_POWER_SLOTS_CANCEL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};
		...
		struct Protocol_MSG_TABLE_POWER_POSSESSION
		{
			// 4<M(444)> - numPowers<M(powerId,status,powerCardUniqueId)>
			ThinAtf::LAtfVector< PowerInfoBody , 4 > powers;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_POSSESSION; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_POSSESSION"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_STATUS_UPDATE
		{
			// 4<M(444)> - numUpdates<M(powerId,newStatus,powerCardUniqueId)>
			ThinAtf::LAtfVector< PowerStatus, 4 > updates;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_STATUS_UPDATE; }
			static const char *getMsgIdString() { return "T_POW_SU"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD
		{
			//! 444111< <FIXME>TableCommonThin::P_Card </FIXME> > - powerActionSeqId,powerId,timerInterval,minCardsChosen,maxCardsChosen,numHoleCards< <FIXME>TableCommonThin::P_Card </FIXME> >
			UINT32 powerActionSeqId;	//alias pasq
			INT32 powerId;	//alias pI
			UINT32 timerInterval;
			BYTE minCardsChosen;
			BYTE maxCardsChosen;
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > holeCards;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_ACK
		{
			// 4 - powerActionSeqId
			UINT32 powerActionSeqId;	//alias pasq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_ACK; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_ACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_REPLY
		{
			//! 41< <FIXME>TableCommonThin::P_Card </FIXME> > - powerActionSeqId,numCards< <FIXME>TableCommonThin::P_Card </FIXME> >
			UINT32 powerActionSeqId;	//alias pasq
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cards;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_CANCEL
		{
			// 4 - powerActionSeqId
			UINT32 powerActionSeqId;	//alias pasq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_CANCEL; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHOOSE_HOLECARDS_DISCARD_CANCEL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct ReloadHoleCardsPowerExtInfo
		{
			//! 1< <FIXME>TableCommonThin::P_Card </FIXME> > - numCards< <FIXME>TableCommonThin::P_Card </FIXME> >
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cards;
		...
		struct Protocol_MSG_TABLE_POWER_CARD_PLAY
		{
			//! 441 <FIXME>TableCommonThin::P_Card</FIXME>  <FIXME>TableCommonThin::P_Card</FIXME> 4M() - actionRequestId,powerId,targetPlayer, <FIXME>targetHoleCard</FIXME> , <FIXME>targetBoardCard</FIXME> ,powerCardUniqueId,M()
			UINT32 actionRequestId;	//alias aRqI	// this number could be found in MSG_TABLE_REQUESTACTION
			INT32 powerId;	//alias pI
			INT8 targetPlayer;
			TableCommonThin::P_Card targetHoleCard;
			TableCommonThin::P_Card targetBoardCard;
			INT32 powerCardUniqueId;
			ThinAtf::CopyableMsgBody extInfo;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CARD_PLAY; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CARD_PLAY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_CARD_PLAY_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CARD_PLAY_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CARD_PLAY_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_CARD_PRESELECT
		{
			//! 4b1 <FIXME>TableCommonThin::P_Card</FIXME>  <FIXME>TableCommonThin::P_Card</FIXME> 4 - powerId,selectOrUnselect,targetPlayer, <FIXME>targetHoleCard</FIXME> , <FIXME>targetBoardCard</FIXME> ,powerCardUniqueId
			INT32 powerId;	//alias pI
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CARD_PRESELECT; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CARD_PRESELECT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_DETECT_HOLECARDS
		{
			//! 11< <FIXME>TableCommonThin::P_Card </FIXME> > - targetPlayer,numCards< <FIXME>TableCommonThin::P_Card </FIXME> >
			INT8 targetPlayer;
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cards;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_DETECT_HOLECARDS; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_DETECT_HOLECARDS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_REDRAW
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_REDRAW; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_REDRAW"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_REDRAW_ACK
		{
			// 4 - seqId
			UINT32 seqId;	//alias sq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_REDRAW_ACK; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_REDRAW_ACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_REDRAW_REPLY
		{
			// 4b2<4> - seqId,isFinal,numPowersToRedraw<powersToRedraw>
			UINT32 seqId;	//alias sq
			bool isFinal;
			ThinAtf::LAtfVector< INT32, 2 > powersToRedraw;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_REDRAW_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_REDRAW_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_REDRAW_CANCEL
		{
			// 4 - seqId
			UINT32 seqId;	//alias sq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_REDRAW_CANCEL; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_REDRAW_CANCEL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_CHANGE_FUTURE
		{
			//! 41< <FIXME>TableCommonThin::P_Card </FIXME> >41<2> - seqId,numCards< <FIXME>TableCommonThin::P_Card </FIXME> >,timeoutSec,numCardVisibilityMasks<cardVisibilityMasks>
			UINT32 seqId;	//alias sq
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cards;
			INT32 timeoutSec;	//alias TO
			ThinAtf::LAtfVector< INT16, 1 > cardVisibilityMasks;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHANGE_FUTURE; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHANGE_FUTURE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_CHANGE_FUTURE_ACK
		{
			// 4 - seqId
			UINT32 seqId;	//alias sq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHANGE_FUTURE_ACK; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHANGE_FUTURE_ACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_CHANGE_FUTURE_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHANGE_FUTURE_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHANGE_FUTURE_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_CHANGE_FUTURE_CANCEL
		{
			// 4 - seqId
			UINT32 seqId;	//alias sq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_CHANGE_FUTURE_CANCEL; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_CHANGE_FUTURE_CANCEL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_PLAYERS_CHOICE
		{
			//! 41< <FIXME>TableCommonThin::P_Card </FIXME> >41<2> - seqId,numCards< <FIXME>TableCommonThin::P_Card </FIXME> >,timeoutSec,numCardVisibilityMasks<cardVisibilityMasks>
			UINT32 seqId;	//alias sq
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cards;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_PLAYERS_CHOICE; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_PLAYERS_CHOICE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_PLAYERS_CHOICE_ACK
		{
			// 4 - seqId
			UINT32 seqId;	//alias sq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_PLAYERS_CHOICE_ACK; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_PLAYERS_CHOICE_ACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_PLAYERS_CHOICE_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_PLAYERS_CHOICE_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_PLAYERS_CHOICE_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_PLAYERS_CHOICE_CANCEL
		{
			// 4 - seqId
			UINT32 seqId;	//alias sq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_PLAYERS_CHOICE_CANCEL; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_PLAYERS_CHOICE_CANCEL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_PRIVATE_EFFECT
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_PRIVATE_EFFECT; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_PRIVATE_EFFECT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_SABOTAGE_TRAPPED_CARDS
		{
			// 1<111> - numTrappedCards<boardNumber,cardNumber,bombsCount>
			ThinAtf::LAtfVector< SabotageTrappedCard, 1 > trappedCards;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_SABOTAGE_TRAPPED_CARDS; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_SABOTAGE_TRAPPED_CARDS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_USER_MINI_CHAT_REQUEST
		{
			// 2 - textId
			INT16 textId;
			...
			static UINT32 getMsgId() { return MSG_TABLE_USER_MINI_CHAT_REQUEST; }
			static const char *getMsgIdString() { return "MSG_TABLE_USER_MINI_CHAT_REQUEST"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_DARK_BET
		{
			// 41<4>4 - seqId,numValues<values>,timeoutSec
			UINT32 seqId;	//alias sq
			ThinAtf::LAtfVector< INT32 , 1 > values;
			INT32 timeoutSec;	//alias TO
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_DARK_BET; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_DARK_BET"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_POWER_DARK_BET_ACK
		{
			// 4 - seqId
			UINT32 seqId;	//alias sq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_DARK_BET_ACK; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_DARK_BET_ACK"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_DARK_BET_REPLY
		{
			// 44 - seqId,value
			UINT32 seqId;	//alias sq
			INT32 value;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_DARK_BET_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_DARK_BET_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_DARK_BET_CANCEL
		{
			// 4 - seqId
			UINT32 seqId;	//alias sq
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_DARK_BET_CANCEL; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_DARK_BET_CANCEL"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_POWER_MOUSE_OVER
		{
			// 1 - position
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_MOUSE_OVER; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_MOUSE_OVER"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		// for player private power effect messages for animation

		struct Protocol_MSG_TABLE_POWER_PRIVATE_ANIMATION
		{
			// 84M() - handId,powerId,M()
			UINT64 handId;	//alias hI
			UINT32 powerId;	//alias pI
			ThinAtf::CopyableMsgBody effectbody;
			...
			static UINT32 getMsgId() { return MSG_TABLE_POWER_PRIVATE_ANIMATION; }
			static const char *getMsgIdString() { return "MSG_TABLE_POWER_PRIVATE_ANIMATION"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct PrivDealingPowerCardsAnimationEffect
		{
			...
			ThinAtf::LAtfVector< PowerCardInfo, 4 > powerCards;
		...
		// PYR-98733
		struct Protocol_MSG_TABLE_THROW
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_THROW; }
			static const char *getMsgIdString() { return "MSG_TABLE_THROW"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_THROW_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_THROW_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_THROW_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	namespace publication
	{
		struct ClientExtraForTakeFromPotEvent
		{
			...
			BYTE bestHigh;
			ThinAtf::AtfVector0< INT8, 1 > kickerRanks;
			BYTE boardNum;
		...
		struct Protocol_MSG_TABLE_SUBSCR_ACTION
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_ACTION; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_ACTION"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_ACTIVESEAT
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_ACTIVESEAT; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_ACTIVESEAT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_BEGINHAND
		{
			// 1 - dealer
			INT8 dealer;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_BEGINHAND; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_BEGINHAND"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_CHAT_BUBBLE
		{
			// 1s - seat,chat
			INT8 seat;	//alias s
			PString chat;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_CHAT_BUBBLE; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_CHAT_BUBBLE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SUBSCR_DEALBOARD
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_DEALBOARD; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_DEALBOARD"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_DEALBOARD_RIT
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_DEALBOARD_RIT; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_DEALBOARD_RIT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_DEALPLAYERCARDS
		{
			//!  <FIXME>vector_FF<P_SuscrPlayerCards></FIXME> 1 -  <FIXME>playerCardInfos</FIXME> ,dealerPos
			ThinAtf::AtfVectorWithSpecialTerminator< P_SuscrPlayerCards > playerCardInfos;
			INT8 dealerPos;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_DEALPLAYERCARDS; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_DEALPLAYERCARDS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SUBSCR_ENDHAND
		{
			// 1 - handStatus
			BYTE handStatus;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_ENDHAND; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_ENDHAND"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_I18N_MESSAGE
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_I18N_MESSAGE; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_I18N_MESSAGE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		{
			//! 114441 <FIXME>TableCommonThin::TableStakes</FIXME>  - handType,potStruct,stakeSmall,stakeBig,ante,round, <FIXME>tableStakes</FIXME> 
			BYTE handType;
			BYTE potStruct;
			UINT32 stakeSmall;
			UINT32 stakeBig;
		...
		{
			//! 11444 <FIXME>TableCommonThin::TableStakes</FIXME>  - handType,potStruct,stakeSmall,stakeBig,ante, <FIXME>tableStakes</FIXME> 
			BYTE handType;
			BYTE potStruct;
			UINT32 stakeSmall;
			UINT32 stakeBig;
		...
		struct ClientMsg_TxtEx_Milestone_Winners
		{
			...
			ThinAtf::LAtfVector< PString , 4 > tables;
			UINT32 nWinners;
			TournMileStonePrize prize;
		...
		{
			//! 1< <FIXME>TableCommonThin::P_Card </FIXME> > - numHoleCardsDict< <FIXME>TableCommonThin::P_Card </FIXME> >
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > holeCardsDict;
		...
		{
			//! 11s <FIXME>TableCommonThin::P_Card</FIXME>  <FIXME>vector01<INT8></FIXME> 1 - cmp,bestHigh,bestHighHand, <FIXME>kicker</FIXME> , <FIXME>extraKickerRanks</FIXME> ,boardNum
			INT8 cmp;
			BYTE bestHigh;
			PString bestHighHand;
			TableCommonThin::P_Card kicker;
			ThinAtf::AtfVector0< INT8, 1 > extraKickerRanks;
			BYTE boardNum;
		...
		struct Protocol_MSG_TABLE_SUBSCR_MESSAGE
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_MESSAGE; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_MESSAGE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SUBSCR_MESSAGE2
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_MESSAGE2; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_MESSAGE2"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SUBSCR_MOVEFROMPOT
		{
			//! 1 <FIXME>vector_FFFF<P_PotInfo></FIXME> 1 - potNum, <FIXME>pots</FIXME> ,potCategoryId
			BYTE potNum;
			ThinAtf::AtfVectorWithSpecialTerminator< P_PotInfo > pots;
			BYTE potCategoryId;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_MOVEFROMPOT; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_MOVEFROMPOT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SUBSCR_MOVETOPOT
		{
			//! 1 <FIXME>vector_FFFF<P_PotInfo></FIXME> 1 - potNum, <FIXME>pots</FIXME> ,potCategoryId
			BYTE potNum;
			ThinAtf::AtfVectorWithSpecialTerminator< P_PotInfo > pots;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_MOVETOPOT; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_MOVETOPOT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SUBSCR_NEWGAME
		{
			//! 444111 <FIXME>TableCommonThin::TableStakes</FIXME>  - stakeSmall,stakeBig,ante,handType,isHiLo,potStruct, <FIXME>tableStakes</FIXME> 
			INT32 stakeSmall;
			INT32 stakeBig;
			INT32 ante;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_NEWGAME; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_NEWGAME"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_SUBSCR_SET_RECORDING_PAUSE
		{
			// b - pause
			bool pause;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_SET_RECORDING_PAUSE; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_SET_RECORDING_PAUSE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_DELAYED_TABLECLOSE
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_DELAYED_TABLECLOSE; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_DELAYED_TABLECLOSE"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_REVEAL_UNFOLD_ACTIONS
		{
			// 2 - playersUnfolded
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_REVEAL_UNFOLD_ACTIONS; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_REVEAL_UNFOLD_ACTIONS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_SHOW_POT_WINNERS	// currently on unfold pot has this animation msg
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_SHOW_POT_WINNERS; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_SHOW_POT_WINNERS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_RETURN_UNCALLED_BET	// currently on unfold pot when there is only one player played unfold
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_RETURN_UNCALLED_BET; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_RETURN_UNCALLED_BET"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		// ============ for new animations ============

		struct Protocol_MSG_TABLE_SUBSCR_POWER_PLAY
		{
			...
			ThinAtf::CopyableMsgBody powerAttr;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_POWER_PLAY; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_POWER_PLAY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct XRayAnimation
		{
			...
			ThinAtf::LAtfVector< XRayCard, 4 > cards;
		...
		{
			//! b1< <FIXME>TableCommonThin::P_Card </FIXME> > <FIXME>TableCommonThin::P_Card</FIXME>  - startOrEnd,numCards< <FIXME>TableCommonThin::P_Card </FIXME> >, <FIXME>chosenCard</FIXME> 
			bool startOrEnd;
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > cards;
			TableCommonThin::P_Card chosenCard;
		...
		{
			//! 11b1< <FIXME>TableCommonThin::P_Card</FIXME> > - player,NumCards,isFirstEffect,numSensedCardIndexes< <FIXME>TableCommonThin::P_Card</FIXME> >
			BYTE player;
			BYTE NumCards;
			bool isFirstEffect;
			ThinAtf::LAtfVector< TableCommonThin::P_Card, 1 > sensedCardIndexes;
		...
		{
			//! 1<1 <FIXME>TableCommonThin::P_Card</FIXME> > - numCardIndexes<pos, <FIXME>card</FIXME> >
			ThinAtf::LAtfVector< CardWithPosition, 1 > cardIndexes;
		...
		{
			//! 11<M(11 <FIXME>TableCommonThin::P_Card</FIXME> )> - boardWidth,numCards<M(playerOrboard,pos, <FIXME>card</FIXME> )>
			BYTE boardWidth;	// max_number_of_cards_in_board_line
			ThinAtf::LAtfVector< CardInfoBody, 1 > cards;
		...
		struct PacifyAnimation
		{
			...
			ThinAtf::LAtfVector< PacifyAnimPlayer, 1 > players;
		...
		struct ChaosCard
		{
			//! M( <FIXME>TableCommonThin::P_Card</FIXME> 11b) - M( <FIXME>card</FIXME> ,boardNo,cardPos,isBlocked)
			TableCommonThin::P_Card card;
			BYTE boardNo;
			BYTE cardPos;
			bool isBlocked;
		...
		{
			//! 1<M( <FIXME>TableCommonThin::P_Card</FIXME> 11b)> - numChaos<M( <FIXME>card</FIXME> ,boardNo,cardPos,isBlocked)>
			ThinAtf::LAtfVector< ChaosCard, 1 > chaos;
		...
		struct WinnerInfo
		{
			//! M(1811<1>1<M(11 <FIXME>TableCommonThin::P_Card</FIXME> )>) - M(seat,winningAmount,handRank,numKickerRanks<kickerRanks>,numWinningCards<M(playerOrboard,pos, <FIXME>card</FIXME> )>)
			INT8 seat;	//alias s
			INT64 winningAmount;
			BYTE handRank;	// 1 - 9
			ThinAtf::LAtfVector< INT8, 1 > kickerRanks;
			ThinAtf::LAtfVector< CardInfoBody, 1 > winningCards;
		...
		struct Protocol_MSG_TABLE_SUBSCR_POT_DISTRIBUTION	// for showdown animations
		{
			//! 1881<1>1<M(1811<1>1<M(11 <FIXME>TableCommonThin::P_Card</FIXME> )>)>1b - potNo,startAmount,endAmount,numPlayersInPot<playersInPot>,numWinners<M(seat,winningAmount,handRank,numKickerRanks<kickerRanks>,numWinningCards<M(playerOrboard,pos, <FIXME>card</FIXME> )>)>,boardNo,isLoHand
			BYTE potNo;
			INT64 startAmount;
			INT64 endAmount;	// maybe half amount if pot is split, usually zero if no split
			ThinAtf::LAtfVector< BYTE, 1 > playersInPot;	// if no showdown reached, this vector is empty
			ThinAtf::LAtfVector< WinnerInfo, 1 > winners;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_POT_DISTRIBUTION; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_POT_DISTRIBUTION"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_TABLE_USER_MINI_CHAT_BROADCAST
		{
			// 12 - seat,textId
			INT8 seat;	//alias s
			INT16 textId;
			...
			static UINT32 getMsgId() { return MSG_TABLE_USER_MINI_CHAT_BROADCAST; }
			static const char *getMsgIdString() { return "MSG_TABLE_USER_MINI_CHAT_BROADCAST"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_SUBSCR_ANIMATION
		{
			// s14M() - userId,seat,animationTypeId,M()
			PString userId;	//alias u
			INT8 seat;	//alias s
			UINT32 animationTypeId;	// defined in upserver.h
			ThinAtf::CopyableMsgBody extraInfo;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_ANIMATION; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_ANIMATION"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		// PYR-98733
		struct Protocol_MSG_TABLE_SUBSCR_THROW
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_THROW; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_THROW"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};
		...
		struct KnockedOut
		{
			...
			INT8 seat;
			ThinAtf::LAtfVector< KnockedOutBy , 4 > knockedOutBy;
		...
		struct Protocol_MSG_TABLE_SUBSCR_KNOCKOUT
		{
			...
			ThinAtf::LAtfVector< KnockedOut , 4 > knockedOut;
			...
			static UINT32 getMsgId() { return MSG_TABLE_SUBSCR_KNOCKOUT; }
			static const char *getMsgIdString() { return "MSG_TABLE_SUBSCR_KNOCKOUT"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct TableSubscr_Chat	// Path {0}
		{
			...
			ThinAtf::CopyableMsgBody msgClientExtra;
		...
		struct TableSubscr_Static	// Path {1}
		{
			...
			{
				ThinAtf::LAtfVector< TableCommonThin::P_FppFactor , 2 > fppFactors;	// TODO: to be retired
				ThinAtf::LAtfVector< TableCommonThin::P_FppFactorEx , 2 > fppFactorSiteMasks;
				mutable bool _is_empty_internal;
			...
			//! ss41111111ss1s44244s4s41bsssss44M(2< <FIXME>TableCommonThin::P_FppFactor </FIXME> >2< <FIXME>TableCommonThin::P_FppFactorEx </FIXME> >)4848 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m - serverVersion,protocolVersion,tableId32Obsolete,handType,potStruct,tournamentType,isHiLo,isPlayMoney,isOneToOne,numOfSeats,tableName,nameSuffix,multiGameType,multiGameTypeDesc,stakeSmall,stakeBig,chatLang,minChipsLimit,maxBuyIn,currency,cap,itSessionId,clubId,dealOptions,isShowCity,createdBy,cancelledBy,voiceObjectAddress,voiceObjectUdpAddress,voiceObjectName,accessMask,scalePM,M(numFppFactors< <FIXME>TableCommonThin::P_FppFactor </FIXME> >,numFppFactorSiteMasks< <FIXME>TableCommonThin::P_FppFactorEx </FIXME> >),showObservFlags,tableId,noVppGainSiteId,tableFlags2, <FIXME>tableStakesObsolete</FIXME> ,numVariableAntes<variableAntes>,noVppGainSiteMask
			...
			UINT64 tableFlags2;
			TableCommonThin::TableStakes tableStakesObsolete;	// found to be duplicated with tableStakes in TableSubscr_Hand, so deprecated.
			ThinAtf::LAtfVector< INT64, 4 > variableAntes;	// only populated if variable antes is available, indexed by "variableAnteIndex" in TableSubscr_Hand
		...
		{
			//! 84418s14442I8s4M()1 <FIXME>TableCommonThin::TableStakes</FIXME>  - handId,stakeSmall,stakeBig,dealer,lastHandId,adminMsg,round,ante,tableFlags,multiGameHands,clientMsgStrId,advertiseI18n,milestoneHandId,superstarShowdownResults,banner,M(),variableAnteIndex, <FIXME>tableStakes</FIXME> 
			...
			INT32 banner;
			ThinAtf::CopyableMsgBody tournMileStoneWinMsg;
		...
		struct PotCat	// define pot category info
		{
			...
			BYTE potCategoryId;
			ThinAtf::LAtfVector< SidePot, 1 > pots;	// main pot also included here
			INT32 rake;
		...
		struct TableSubscr_ActivePlayer	// Path {3}
		{
			...
			UINT32 rake;	// rake
			ThinAtf::LAtfVector< UINT32, 1 > pots;	// pot amounts
			ThinAtf::LAtfVector< UINT32, 1 > columns;	// chips columns
			...
			ThinAtf::LAtfVector< PotCat, 1 > potCats;	// pot categories //TODO: temporary not comparison
		...
		{
			//! 1< <FIXME>TableCommonThin::P_Card </FIXME> > - numActiveBoardCards< <FIXME>TableCommonThin::P_Card </FIXME> >
			ThinAtf::LAtfVector< TableCommonThin::P_Card , 1 > activeBoardCards;
		...
		struct TableSubscr_PlayerProfile	// Path {5,x,1}
		{
			...
			UINT32 mileStoneAward;
			UINT32 clientDevice;
			ThinAtf::CopyableMsgBody userPropertyMsg;
		...
		{
			//! M(1 <FIXME>TableCommonThin::P_Card</FIXME> 21<M(41)>) - M(showFlag, <FIXME>cardOrIndex</FIXME> ,visibilityMask,numPowers<M(powerId,powerPlayer)>)
			BYTE showFlag;
			TableCommonThin::P_Card cardOrIndex;
			INT16 visibilityMask;
			ThinAtf::LAtfVector< PowerOnCard, 1 > powers;
		...
		{
			//! 1<M(1 <FIXME>TableCommonThin::P_Card</FIXME> 21<M(41)>)>11 - numPlayerCards<M(showFlag, <FIXME>cardOrIndex</FIXME> ,visibilityMask,numPowers<M(powerId,powerPlayer)>)>,numSwapped,swapRound
			ThinAtf::LAtfVector< SubscrPlayerCard, 1 > playerCards;
		...
		{
			//! 1<1< <FIXME>TableCommonThin::P_Card </FIXME> >> - numAllBoards<numActiveBoardCards< <FIXME>TableCommonThin::P_Card </FIXME> >>
			ThinAtf::LAtfVector< TableSubscr_Board, 1 > allBoards;
		...
		struct TablePowerSubscr_PowerList	// Path {9,0}
		{
			...
			ThinAtf::LAtfVector< PowerBasicInfo, 4 > oldPowers;	// obsoleted, no data will be populated in this vector
		...
		{
			//! M( <FIXME>TableCommonThin::P_Card</FIXME>  <FIXME>TableCommonThin::P_Card</FIXME> ) - M( <FIXME>newCard</FIXME> , <FIXME>oldCard</FIXME> )
			TableCommonThin::P_Card newCard;
			TableCommonThin::P_Card oldCard;
		...
		{
			//! 1<M( <FIXME>TableCommonThin::P_Card</FIXME>  <FIXME>TableCommonThin::P_Card</FIXME> )>1<1>1<1>1<1>1<M(1<M(41)>1)>1<M(1<M(41)>1)>1 - numBoardCardChangesOld<M( <FIXME>newCard</FIXME> , <FIXME>oldCard</FIXME> )>,numBoard1CardsFlagsOld<board1CardsFlagsOld>,numBoard2CardsFlagsOld<board2CardsFlagsOld>,numBoardCardsStreet<boardCardsStreet>,numBoard1<M(numPowers<M(powerId,powerPlayer)>,flag)>,numBoard2<M(numPowers<M(powerId,powerPlayer)>,flag)>,maxBoardWidth
			ThinAtf::LAtfVector< CardRedealt, 1 > boardCardChangesOld;	// obsoleted
			ThinAtf::LAtfVector< INT8, 1 > board1CardsFlagsOld;	// obsoleted
			ThinAtf::LAtfVector< INT8, 1 > board2CardsFlagsOld;	// obsoleted
			ThinAtf::LAtfVector< INT8, 1 > boardCardsStreet;
			ThinAtf::LAtfVector< PowerInfoOnBoardCard, 1 > board1;
			ThinAtf::LAtfVector< PowerInfoOnBoardCard, 1 > board2;
		...
		struct TablePowerSubscr_SenseStateInfo	// Path {9,4,1}
		{
			...
			ThinAtf::LAtfVector< INT16, 1 > tokensNum;
		...
		struct TablePowerSubscr_CloakedStateInfo	// Path {9,4,2}
		{
			...
			ThinAtf::LAtfVector< INT8, 1 > cloakedSeatsNow;
			ThinAtf::LAtfVector< INT8, 1 > cloakedSeatsPerHand;
		...
		{
			//! M( <FIXME>TableCommonThin::P_Card</FIXME> 21<M(41)>) - M( <FIXME>cardOrIndex</FIXME> ,visibilityMask,numPowers<M(powerId,powerPlayer)>)
			TableCommonThin::P_Card cardOrIndex;	// when the sensed card visible for everybody, publish card value
			INT16 visibilityMask;
			ThinAtf::LAtfVector< PowerOnCard, 1 > powers;
		...
		{
			//! 1<112>1<M( <FIXME>TableCommonThin::P_Card</FIXME> 21<M(41)>)> - numVisInfo<seat,position,visibilityMask>,numSensedCards<M( <FIXME>cardOrIndex</FIXME> ,visibilityMask,numPowers<M(powerId,powerPlayer)>)>
			ThinAtf::LAtfVector< CardVisibility, 1 > visInfo;	// obsoleted, no data will be populated!
			ThinAtf::LAtfVector< SensedCardIndex, 1 > sensedCards;
		...
		struct TablePowerSubscr_PowerIndicators	// Path {9,7}
		{
			...
			ThinAtf::LAtfVector< PowerIndicator, 1 > powers;
		...
		struct TablePowerSubscr_PowerInfo	// Path {9,8,x}
		{
			...
			ThinAtf::CopyableMsgBody paramBody;	// for power static parameters client needs
		...
		struct AllInCashout_ResumingHand_Data
		{
			...
			ThinAtf::AtfVector0< PString, 1 > activePlayers;
	...
	namespace ihh
	{
		struct Protocol_MSG_TABLE_IHH_GET_HANDBLOB
		{
			// 8 - handId
			UINT64 handId;
			...
			static UINT32 getMsgId() { return MSG_TABLE_IHH_GET_HANDBLOB; }
			static const char *getMsgIdString() { return "MSG_TABLE_IHH_GET_HANDBLOB"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_TABLE_IHH_GET_HANDBLOB_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_TABLE_IHH_GET_HANDBLOB_REPLY; }
			static const char *getMsgIdString() { return "MSG_TABLE_IHH_GET_HANDBLOB_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
