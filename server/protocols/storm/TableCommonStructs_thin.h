...
#ifndef ATF_PROTOCOL_DEFFILE_TABLECOMMONSTRUCTS_THIN_H
#define ATF_PROTOCOL_DEFFILE_TABLECOMMONSTRUCTS_THIN_H
...
namespace TableCommonThin
{
	...
	struct P_IniFile_Section
	{
		...
		PString name;
		ThinAtf::LAtfVector< P_IniFile_Item, 4 > items;
	...
	struct P_IniFile
	{
		...
		ThinAtf::LAtfVector< P_IniFile_Section, 4 > sections;
		...
		// @Override
		const TableCommonThin::P_IniFile_Section* getSection( const char * name ) const;
	...
	struct TableStakes
	{
		...
		ThinAtf::LAtfVector< INT64 , 4 > antes;	// When removing this optional parsing, also remove the obsolete TableStakes field from the table publication
		ThinAtf::LAtfVector< INT64 , 4 > blinds;
		ThinAtf::LAtfVector< INT64 , 4 > stakes;
		ThinAtf::LAtfVector< INT64 , 4 > bringIns;
