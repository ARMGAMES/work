...
#ifndef ATF_PROTOCOL_DEFFILE_STORMHH_H
#define ATF_PROTOCOL_DEFFILE_STORMHH_H
...
namespace StormHH
{
	...
	namespace invoke
	{
		...
		struct MindControl
		{
			...
			{
				INT32 stolenPowerId;
				Atf::LAtfVector< INT32, 4 > powersLeft;
				mutable bool _is_empty_internal;
	...
	namespace effect
	{
		...
		struct ReplaceMultiBoardCards
		{
			struct _PubDataType
			{
				Atf::LAtfVector< PString, 4 > oldCards;
				Atf::LAtfVector< PString, 4 > newCards;
				mutable bool _is_empty_internal;
		...
		struct RebootEffect
		{
			...
			struct _PrivDataType
			{
				Atf::LAtfVector< INT32, 4 > discardedPowers;
				Atf::LAtfVector< INT32, 4 > reloadedPowers;
				mutable bool _is_empty_internal;
		...
		struct MindControlDrawNewPowersEffect
		{
			...
			struct _PrivDataType
			{
				Atf::LAtfVector< INT32, 4 > newPowerIds;
				mutable bool _is_empty_internal;
