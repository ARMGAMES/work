...
#ifndef ATF_PROTOCOL_DEFFILE_MINIGAMESCLIENTPROT_H
#define ATF_PROTOCOL_DEFFILE_MINIGAMESCLIENTPROT_H
...
#include "cvl/cvlclientprotocol.h"
...
namespace MiniGameClient
{
	...
	struct MiniGamePrize
	{
		...
		Atf::LAtfVector< NameValuePair, 4 > prizeProperties;	//vector of prize properties from MG_CATALOG_PRIZE_PROPERTIES, only applicable to catalog prizes
	...
	struct MiniGamePrizeBucket
	{
		...
		Atf::LAtfVector< MiniGamePrize , 4 > prizes;
	...
	struct MiniGamePrizeBucketLocalized
	{
		...
		Atf::LAtfVector< MiniGamePrizeLocalized , 4 > prizes;
	...
	struct MiniGameDefinition
	{
		...
		MiniGameBuyIn buyIn;
		Atf::LAtfVector< MiniGamePrizeBucket , 4 > prizeTable;
	...
	struct MiniGameDefinitionLocalized
	{
		...
		INT32 delayToPayoutAutoplay;
		MiniGameBuyIn buyIn;
		Atf::LAtfVector< MiniGamePrizeBucketLocalized , 4 > prizeTable;

		Atf::MsgBodyWithJSON gameDefMsgBody;	// contains additional game-specific definition
	...
	struct MiniGameVisibility
	{
		...
		Atf::LAtfVector< PString , 4 > countries;	// country inlcusion/exclusion list
	...
	struct MiniGameMetaData
	{
		...
		Atf::LAtfVector< INT32 , 4 > metaData;
	...
	struct MiniGameRound
	{
		...
		Atf::LAtfVector< INT32 , 4 > decisions;	// decisions made in the round
		Atf::LAtfVector< INT32 , 4 > results;	// results of the decisions made in the round
		...
		Atf::LAtfVector< MiniGameMetaData , 4 > metaData;	// A way to pass game specific round information to the client (eg: prizes left on a card by card basis in the deal)
	...
	struct MiniGameState
	{
		...
		UINT32 minigameId;
		Atf::LAtfVector< MiniGameRound , 4 > rounds;
	...
	{
		//! b4s <FIXME>BrandProt::BrandImageList</FIXME> 844M(84M(4<M(44<4>4<4>4M(44<M(4<4>)>))>)) - active,timestamp,playerId, <FIXME>playerBrandImages</FIXME> ,jackpotAmountInCents,winnerShareAmount,playerShareAmount,M(minigamePlayId,minigameId,M(numRounds<M(timestamp,numDecisions<decisions>,numResults<results>,prizeBucket,M(state,numMetaData<M(numMetaData<metaData>)>))>))
		...
		PString playerId;
		BrandProt::BrandImageList playerBrandImages;
	...
	// !!! WARNING !!! If you modify this message, please let testautomation team know.
	struct Protocol_MINIGAME_MSG_ACTIVE_GAMES : public Atf::MessageProtocol
	{
		// 8 - requestId
		INT64 requestId;
		...
		UINT32 getMsgId() const override { return MINIGAME_MSG_ACTIVE_GAMES; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_ACTIVE_GAMES"; }
	...
	struct Protocol_MINIGAME_MSG_ACTIVE_GAMES_REPLY : public Atf::MessageProtocol
	{
		...
		Atf::LAtfVector< MiniGameState , 4 > states;
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_ACTIVE_GAMES_REPLY; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_ACTIVE_GAMES_REPLY"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	// !!! WARNING !!! If you modify this message, please let testautomation team know.
	struct Protocol_MINIGAME_MSG_START_GAME : public Atf::MessageProtocol
	{
		...
		Atf::LAtfVector< INT32 , 4 > initialDecisions;	// apply these decisions to round 0
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_START_GAME; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_START_GAME"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_START_GAME_REPLY : public Atf::MessageProtocol
	{
		...
		Atf::LAtfVector< GameTicketWithMiniGame , 4 > ticketsWithMinigames;
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_START_GAME_REPLY; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_START_GAME_REPLY"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	// !!! WARNING !!! If you modify this message, please let testautomation team know.
	struct Protocol_MINIGAME_MSG_PLAY_NEXT_ROUND : public Atf::MessageProtocol
	{
		...
		Atf::LAtfVector< INT32 , 4 > decisions;	// this message isn't used at the moment so max size is 0
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_PLAY_NEXT_ROUND; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_PLAY_NEXT_ROUND"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	// !!! WARNING !!! If you modify this message, please let testautomation team know.
	struct Protocol_MINIGAME_MSG_GAME_STATE : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_GAME_STATE; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_GAME_STATE"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_GAME_STATE_REPLY : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_GAME_STATE_REPLY; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_GAME_STATE_REPLY"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_SERVER_RESTARTING : public Atf::MessageProtocol
	{
		//empty
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_SERVER_RESTARTING; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_SERVER_RESTARTING"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_TICKET_LOOKUP : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_TICKET_LOOKUP; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_TICKET_LOOKUP"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_TICKET_LOOKUP_REPLY : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_TICKET_LOOKUP_REPLY; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_TICKET_LOOKUP_REPLY"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_GET_TICKETS : public Atf::MessageProtocol
	{
		// 8 - requestId
		INT64 requestId;
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_GET_TICKETS; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_GET_TICKETS"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_GET_TICKETS_REPLY : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_GET_TICKETS_REPLY; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_GET_TICKETS_REPLY"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_GET_STACKED_TICKETS : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_GET_STACKED_TICKETS; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_GET_STACKED_TICKETS"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MINIGAME_MSG_GET_STACKED_TICKETS_REPLY : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_GET_STACKED_TICKETS_REPLY; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_GET_STACKED_TICKETS_REPLY"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	namespace client	// between native client and MGLobby through msgbody format. MGLobby is the client access point.
	{
		...
		struct Protocol_SIDEGAME_MSG_USER_GAME_MESSAGE_TO_SERVER : public Atf::MessageProtocol	// C->S
		{
			...
			UINT32 gameMsgId;
			Atf::MsgBodyWithJSON gameMsgBody;	// the concrete game message is transparent to the MGLobby (maxsize=1Mb)
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_USER_GAME_MESSAGE_TO_SERVER; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_USER_GAME_MESSAGE_TO_SERVER"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_USER_GAME_MESSAGE_TO_PLAYER : public Atf::MessageProtocol	// S->C
		{
			...
			UINT32 gameMsgId;
			Atf::MsgBodyWithJSON gameMsgBody;	// the concrete game message, MGLobby wraps the JSON string into msgbody (maxsize=1Mb)
			Atf::MsgBodyWithJSON gameStateMetaDataMsgBody;	// GameStateMetaData (maxsize=1Mb)
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_USER_GAME_MESSAGE_TO_PLAYER; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_USER_GAME_MESSAGE_TO_PLAYER"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct GameStateMetaData
		{
			...
			Atf::MsgBodyWithJSON stateMsgBody;	// game specific information
		...
		struct SideGameAnim
		{
			...
			Atf::CopyableMsgBody animMsgBody;	// structure depends on SideGameAnimType
		...
		struct Protocol_SIDEGAME_MSG_TRIGGER_ANIMATION : public Atf::MessageProtocol	// S->C
		{
			// 84<M(44M())> - handId,numAnims<M(animType,location,M())>
			UINT64 handId;
			Atf::LAtfVector< SideGameAnim , 4 > anims;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_TRIGGER_ANIMATION; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_TRIGGER_ANIMATION"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	namespace sidegame	// between html5 client and MGLobby server through JSON format
	{
		...
		struct PickAnObjectGameState
		{
			...
			INT32 lifeCycleState;	// in progress or done
			INT32 animationSeed;	// random number generated to seed variation in animation display
			Atf::LAtfVector< INT32, 4 > prizeObjectIndices;	// vector of prizeBucketIndices indicating the position of each prize object that the client will display
		...
		struct ChestGameState
		{
			...
			Atf::LAtfVector< CvlClientUserBarNotification, 4 > cvlBarUpdates;
			Atf::LAtfVector< CvlConfigParams, 4 > cvlConfigParams;
		...
		struct SuitRaceGameState
		{
			...
			Atf::LAtfVector< SuitRacePlayerProgress , 4 > playerProgress;
			BYTE chosenSuit;
		...
		struct SideGameState
		{
			...
			Atf::MsgBodyWithJSON stateMsgBody;	// game-specific structure, interpreted based on minigameId. For CardMatch, this is a CardMatchGameState.
		...
		struct PokerSideBetAvailableBet
		{
			...
			Atf::LAtfVector< PokerSideBetResultPayout, 4 > oddsTable;
		...
		struct PokerSideBetGameDefBody
		{
			...
			Atf::LAtfVector< PokerSideBetAvailableBet, 4 > availableBets;
			Atf::LAtfVector< INT64, 4 > allowedBetAmounts;
			Atf::LAtfVector< INT16, 4 > allowedNumberOfAutoBets;	// either allowedNumberOfAutoBets or allowedBetIncrements will be populated
			Atf::LAtfVector< INT64, 4 > allowedBetIncrements;	// either allowedNumberOfAutoBets or allowedBetIncrements will be populated
			INT64 maxBuyIn;
		...
		struct Protocol_SIDEGAME_MSG_START_GAME : public Atf::MessageProtocol	// GC->GS
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_START_GAME; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_START_GAME"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_START_GAME_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_START_GAME_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_START_GAME_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_START_GAME_NEW : public Atf::MessageProtocol	// GC->GS
		{
			...
			UINT64 minigameEntryRefId;	// depends on minigameEntryMode
			bool autoPlay;
			Atf::MsgBodyWithJSON sideGameEntryMetaData;	// (maxsize=1Mb)
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_START_GAME_NEW; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_START_GAME_NEW"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_ACTIVE_GAMES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_ACTIVE_GAMES; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_ACTIVE_GAMES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_ACTIVE_GAMES_REPLY : public Atf::MessageProtocol
		{
			...
			Atf::LAtfVector< SideGameState , 4 > states;

			Atf::LAtfVector< MaxGamesReachedEntry , 4 > maxGamesReached;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_ACTIVE_GAMES_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_ACTIVE_GAMES_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GAME_STATE : public Atf::MessageProtocol
		{
			// 88 - requestId,minigamePlayId
			INT64 requestId;
			UINT64 minigamePlayId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GAME_STATE; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GAME_STATE"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GAME_STATE_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GAME_STATE_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GAME_STATE_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_MAX_GAMES_REACHED : public Atf::MessageProtocol
		{
			// 8 - requestId
			INT64 requestId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_MAX_GAMES_REACHED; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_MAX_GAMES_REACHED"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_MAX_GAMES_REACHED_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_MAX_GAMES_REACHED_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_MAX_GAMES_REACHED_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_CLAIM_PRIZE : public Atf::MessageProtocol	// GC->GS
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_CLAIM_PRIZE; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_CLAIM_PRIZE"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_CLAIM_PRIZE_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			// 82[s|M(84184M()88)b] - requestId,errCode[errStr|M(minigamePlayId,minigameId,gameType,gameId,entryId,M(),ringSessionId,subGameId),hasHistoricGames]
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_CLAIM_PRIZE_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_CLAIM_PRIZE_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GAME_DEF : public Atf::MessageProtocol	// GC->GS
		{
			// 844 - requestId,minigameId,gameTicketTypeId
			INT64 requestId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GAME_DEF; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GAME_DEF"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GAME_DEF_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GAME_DEF_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GAME_DEF_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GAME_DEF_LOCALIZED : public Atf::MessageProtocol	// GC->GS
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GAME_DEF_LOCALIZED; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GAME_DEF_LOCALIZED"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GAME_DEF_LOCALIZED_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GAME_DEF_LOCALIZED_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GAME_DEF_LOCALIZED_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_HISTORIC_GAMES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_HISTORIC_GAMES; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_HISTORIC_GAMES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_HISTORIC_GAMES_REPLY : public Atf::MessageProtocol
		{
			...
			Atf::LAtfVector< SideGameState , 4 > historicGames;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_HISTORIC_GAMES_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_HISTORIC_GAMES_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_FORFEIT : public Atf::MessageProtocol	// GC->GS
		{
			// 88 - requestId,minigamePlayId
			INT64 requestId;
			UINT64 minigamePlayId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_FORFEIT; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_FORFEIT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_FORFEIT_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			// 82[s|M(84184M()88)b] - requestId,errCode[errStr|M(minigamePlayId,minigameId,gameType,gameId,entryId,M(),ringSessionId,subGameId),hasHistoricGames]
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_FORFEIT_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_FORFEIT_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GET_TICKET_BALANCE : public Atf::MessageProtocol	// GC->GS
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GET_TICKET_BALANCE; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GET_TICKET_BALANCE"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GET_TICKET_BALANCE_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			// 82[s|4] - requestId,errCode[errStr|playsRemaining]
			INT64 requestId;
			INT16 errCode;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GET_TICKET_BALANCE_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GET_TICKET_BALANCE_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GET_STARSREWARDS_BAR : public Atf::MessageProtocol
		{
			// 88 - requestId,barId
			INT64 requestId;
			UINT64 barId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GET_STARSREWARDS_BAR; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GET_STARSREWARDS_BAR"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GET_STARSREWARDS_BAR_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GET_STARSREWARDS_BAR_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GET_STARSREWARDS_BAR_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_SKIP_DELAY : public Atf::MessageProtocol
		{
			// 88 - requestId,minigamePlayId
			INT64 requestId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_SKIP_DELAY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_SKIP_DELAY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GET_RING_SESSIONID : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GET_RING_SESSIONID; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GET_RING_SESSIONID"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_GET_RING_SESSIONID_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_GET_RING_SESSIONID_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_GET_RING_SESSIONID_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_CANCEL_PLAY : public Atf::MessageProtocol	// GC->GS
		{
			// 88 - requestId,minigamePlayId
			INT64 requestId;
			UINT64 minigamePlayId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_CANCEL_PLAY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_CANCEL_PLAY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_CANCEL_PLAY_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			// 82[s|M(84184M()88)b] - requestId,errCode[errStr|M(minigamePlayId,minigameId,gameType,gameId,entryId,M(),ringSessionId,subGameId),hasHistoricGames]
			INT64 requestId;
			INT16 errCode;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_CANCEL_PLAY_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_CANCEL_PLAY_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct AutoPlayContextData
		{
			...
			Atf::LAtfVector< Atf::MsgBodyWithJSON, 4 > sideGameEntryMetaData;	// original sideGameEntryMetaData set by SIDEGAME_MSG_START_AUTOPLAY
			Atf::LAtfVector< UINT64, 4 > pendingMGPlays;	// vector of plays for future hands that haven't started yet
			Atf::LAtfVector< UINT64, 4 > startedMGPlays;	// vector of plays that have started but have not yet been resolved
			Atf::LAtfVector< UINT64, 4 > resolvedMGPlays;	// vector of plays that have been resolved (this is cleared after the end ends)
		...
		struct Protocol_SIDEGAME_MSG_START_AUTOPLAY : public Atf::MessageProtocol	// GC->GS
		{
			...
			UINT32 flags;	// see enum SideGameAutoPlayFlags
			Atf::LAtfVector< Atf::MsgBodyWithJSON, 4 > sideGameEntryMetaData;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_START_AUTOPLAY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_START_AUTOPLAY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_START_AUTOPLAY_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_START_AUTOPLAY_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_START_AUTOPLAY_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_STOP_AUTOPLAY : public Atf::MessageProtocol	// GC->GS
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_STOP_AUTOPLAY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_STOP_AUTOPLAY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_STOP_AUTOPLAY_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_STOP_AUTOPLAY_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_STOP_AUTOPLAY_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_AUTOPLAY_STATE : public Atf::MessageProtocol	// GC->GS
		{
			// 8M(418488) - requestId,M(minigameId,gameType,gameId,entryId,ringSessionId,subGameId)
			INT64 requestId;
			SideGameContext sideGameContext;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_AUTOPLAY_STATE; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_AUTOPLAY_STATE"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_AUTOPLAY_STATE_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			// 82[s|M(118844<M()>4<8>4<8>4<8>)M(118844<M()>4<8>4<8>4<8>)] - requestId,errCode[errStr|M(numAutoPlaysRemainingToDisplay,numAutoPlays,singleWinThreshold,totalLossesThreshold,flags,numSideGameEntryMetaData<M()>,numPendingMGPlays<pendingMGPlays>,numStartedMGPlays<startedMGPlays>,numResolvedMGPlays<resolvedMGPlays>),M(numAutoPlaysRemainingToDisplay,numAutoPlays,singleWinThreshold,totalLossesThreshold,flags,numSideGameEntryMetaData<M()>,numPendingMGPlays<pendingMGPlays>,numStartedMGPlays<startedMGPlays>,numResolvedMGPlays<resolvedMGPlays>)]
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_AUTOPLAY_STATE_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_AUTOPLAY_STATE_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_REPLAY_AUTOPLAY : public Atf::MessageProtocol	// GC->GS
		{
			// 8M(418488) - requestId,M(minigameId,gameType,gameId,entryId,ringSessionId,subGameId)
			INT64 requestId;
			SideGameContext sideGameContext;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_REPLAY_AUTOPLAY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_REPLAY_AUTOPLAY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_REPLAY_AUTOPLAY_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_REPLAY_AUTOPLAY_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_REPLAY_AUTOPLAY_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_CANCEL_REPLAY_AUTOPLAY : public Atf::MessageProtocol	// GC->GS
		{
			// 8M(418488) - requestId,M(minigameId,gameType,gameId,entryId,ringSessionId,subGameId)
			INT64 requestId;
			SideGameContext sideGameContext;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_CANCEL_REPLAY_AUTOPLAY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_CANCEL_REPLAY_AUTOPLAY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_SIDEGAME_MSG_CANCEL_REPLAY_AUTOPLAY_REPLY : public Atf::MessageProtocol	// GS->GC
		{
			// 82[s] - requestId,errCode[errStr]
			INT64 requestId;
			INT16 errCode;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return SIDEGAME_MSG_CANCEL_REPLAY_AUTOPLAY_REPLY; }
			const char *getMsgIdString() const override { return "SIDEGAME_MSG_CANCEL_REPLAY_AUTOPLAY_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	// PYR-120600
	struct Protocol_MINIGAME_MSG_REG_TO_FIXED_PRIZE_DRAW : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_REG_TO_FIXED_PRIZE_DRAW; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_REG_TO_FIXED_PRIZE_DRAW"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	// PYR-120600
	struct Protocol_MINIGAME_MSG_REG_TO_FIXED_PRIZE_DRAW_REPLY : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MINIGAME_MSG_REG_TO_FIXED_PRIZE_DRAW_REPLY; }
		const char *getMsgIdString() const override { return "MINIGAME_MSG_REG_TO_FIXED_PRIZE_DRAW_REPLY"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
