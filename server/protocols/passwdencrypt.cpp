...
/*static*/ const char PasswdEncryptDecrypt::spwd[] = "f4â-seyvjF§¦ëà?HnïdìjHnFyT-ëà?54dDn½d-ñsDÆÑsñ?@âs-D";

/*static*/ void PasswdEncryptDecrypt::encrypt(const char *clearPasswd, PString & encryptedPasswd)
{
...
/*static*/ bool PasswdEncryptDecrypt::decrypt(const char *encryptedPasswd, PString & clearPasswd)
{
	PBlock tmp;
