...
#ifndef ATF_PROTOCOL_DEFFILE_MLOBBYNG_ATF_THIN_H
#define ATF_PROTOCOL_DEFFILE_MLOBBYNG_ATF_THIN_H
...
#include "sitemasks.h"
#include "../ppp/pppclientprot_thin.h"
...
namespace MLobbyNG
{
	...
	namespace cli
	{
		struct TournSelectionFilter
		{
			...
			PString country;
			bool isPM;
			ThinAtf::LAtfVector< UINT32, 4 > tournGroups;	// enum TournGroupTypes
			INT32 lateRegCutoff;
		...
		struct TournStaticData
		{
			...
			ThinAtf::LAtfVector< PString, 4 > admissions;	// PYR-73971
			PString serverObj;
		...
		struct SagMaxMods
		{
			...
			BYTE numUsers;
			ThinAtf::LAtfVector< SpinnerPrizeStruct, 4 > spinnerPrizes;
		...
		struct StatesByCountryStruct
		{
			...
			PString country;
			bool stateInversion;
			ThinAtf::LAtfVector< PString, 4 > states;
		...
		struct MLobbyNGSagStaticDataStruct
		{
			...
			ThinAtf::LAtfVector< UINT32, 4 > eligibleGroups;	// PYR-109262
		...
		struct ZoomDynaDataStruct
		{
			...
			BYTE avgVpip;
			INT32 earlyBirdMins;
			ThinAtf::LAtfVector< EarlyBirdMultiplier, 4 > earlyBirdMultipliers;	// deprecated, use licenseEarlyBirdMultiplier instead
		...
		struct PrizeData
		{
			...
			INT32 max;
			INT32 numTickets;
			ThinAtf::LAtfVector< WinnerAmountData, 4 > winners;
		...
		struct SngDataStruct
		{
			...
			ThinAtf::LAtfVector< PrizeData, 4 > prizes;	// PYR-82008
			ThinAtf::LAtfVector< TicketData, 4 > tickets;
			INT32 awardScheme;
			PString tournGroupName;	// PYR-66845
			PString tournGroupRef;	// PYR-87937
			PSiteMask tournSitesEx;
		...
		struct TableData
		{
			//! M(M(8sss411111444214444ss4411b4<s>448b444 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m4)) - M(M(tableId,name,server,serverObject,clubId,isOneOnOne,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,tableFlags,tableInstanceFlags,chatLang,structure,loBet,hiBet,ante,cap,specialName,currency,minChipsLimit,maxBuyIn,icon,filter,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,scalePM,defaultBuyIn,tableFlags2,isTableStarter,brandMask,poolBlockMinHands,tableTypeId, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx,seatFinderId))
		...
		struct SuggestedGames2SelectionFilter
		{
			...
			INT64 sngMedianValue;	// no limit
			INT64 ringMedianValue;	// no limit
			ThinAtf::LAtfVector< TournSelectionFilter, 4 > tournFilters;
			ThinAtf::LAtfVector< TableSelectionFilter, 4 > tableFilters;
			ThinAtf::LAtfVector< SngSelectionFilter, 4 > sngFilters;
		...
		struct OrderedTicketTournInfo
		{
			...
			ThinAtf::LAtfVector< SngDataStruct, 4 > sngTypes;
			ThinAtf::LAtfVector< SagDataStruct, 4 > sagTypes;
			ThinAtf::LAtfVector< UINT32, 4 > gameOrder;	// GameCategoryTypes
		...
		struct TicketTournRequestData
		{
			...
			ThinAtf::LAtfVector< ActivityStruct, 4 > activities;
			UINT64 gameMask;	// NGGameTypes
		...
		struct Protocol_MSG_MLOBBYNG_GET_GAME_LIST
		{
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_GAME_LIST; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_GAME_LIST"; }
		...
		struct Protocol_MSG_MLOBBYNG_GET_GAME_LIST_REPLY
		{
			//! 4<M(M(8ssst44411ss14441114444t444b4<s>14ts2s44s241s1121bs4112sss88t4bM( <FIXME>TournClientThin::NStackTournInfoStruct</FIXME> )44s4141444ss444<s>ss4m)M(441414<M(2444tm)>44b4441)tb)>4<M(41111414444s44b4<s>b444444<4>bbt <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>48m)>4<M(44b1111s44414b4<s>4412s41484s48s44t4<s>44<M(4444<M(41)>)>4<M(2s)>4ssmb)>4<M(M(b[444444441111444s444<M(14<M(114s)>)>4<4>sb4<sb4<s>>ss44<s>b4ssm])tb4)>4<M(M(411114444s4444sb4<s>1b4sss142b44s <FIXME>TableCommonThin::TableStakes</FIXME> m8)M(444411144<M(44)>4)t)>4<M(M(411114444s4444sb4<s>ss1b44<4>48b4 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m)M(444444)t)>4<4>4<M( <FIXME>PPPClient::publication::PppStaticLeaf</FIXME> 8t)> - numTourns<M(M(tournamentId,server,targetServer,hasSatellite,whenStart,buyIn,rake,fppBuyIn,isRestricted,isPwdProtected,name,admissionId,isPlayMoney,satelliteTarget,minPlayers,tournFlags,game,isHiLo,structure,tournMask,tournSites,whenStartInt,tournMask2,targetWhenStart,tournMask3,tournMask4,maxPerTable,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,hasDayTwoStart,dayTwoStartSec,dayTwoStart,shortText,chatLang,currency,tournFlagsServInt,knockout,satelliteTargetReference,satelliteTargetReferenceLock,maxPlayers,speedDisplay,nameSnG,step,timedTournType,timedTournTime,timedTournPayout,isFlightTourn,tournBrand,scalePM,progressiveKnockout,awardScheme,numReentries,internalReference,favReference,satelliteTargetName,admissionPrice,tournFlags2,regEndAbs,regEndAbsInt,doNotAllowToUnreg,M( <FIXME>nStackInfo</FIXME> ),tournMask5,tournMask6,satelliteTargetNameMTT,liveEventMask,timedTournPlayersPercent,dummy1,rmPmLobby,brandAccessMask,activeFlags,sngScriptId,customSpeedDisplayName,mobileName,tournGroup,guaranteedPrizePool,numAdmissions<admissions>,serverObj,tournGroupRef,maxPayoutSag,tournSitesEx),M(fakeStatus,entrants,publProp,prizePoolToPublish,prizePoolUnit,numHappyHoursMultipliers<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,goldenSnGMilestoneAwardStub,dummy1,goldenSnGEligibleStub,goldenSnGTotalAddonStub,prizePoolMoneyToPublish,timedTournPlayersThreshold,mixTournSatellite),lastEntry,userHasTicket)>,numTableTypes<M(id,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,structure,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,visible,scalePM,defaultBuyIn,brandMask,seatFinderId,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,isPasswordProtected,isMorphLobby,lastEntry, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,tableFlags,tableFlags2,visibilityMaskEx)>,numSngTypes<M(id,tournSites,visible,game,structure,isHiLo,isPlayMoney,currency,buyIn,rake,knockout,speedDisplay,minPlayers,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,scalePM,brandAccessMask,timedTournType,timedTournTime,visibilityCriteria,maxPerTable,timedTournPlayersPercent,tournFlags,tournFlags2,satelliteTarget,satelliteTargetReference,tournFlagsServInt,regTournId,mobileName,tournGroup,maxPlayers,lastEntry,numAdmissions<admissions>,fppBuyIn,numPrizes<M(min,max,numTickets,numWinners<M(amount,flags)>)>,numTickets<M(ticketId,admission)>,awardScheme,tournGroupName,tournGroupRef,tournSitesEx,userHasTicket)>,numSagTypes<M(M(active[scriptId,flags,brandMask,siteMask,buyin,rake,currency,scalePM,game,isHiLo,structure,speedDisplay,minPrizePool,maxPrizePool,maxPayout,promoRef,minClientVersion,maxClientVersion,numMods<M(numUsers,numSpinnerPrizes<M(level,type,value,targetRef)>)>,numTickets<tickets>,customSpeedDisplayName,restrictCountryInversion,numStatesByCountry<country,stateInversion,numStates<states>>,visibilityCriteria,mobileName,tournGroup,numAdmissions<admissions>,isPlayMoney,tournFlags,tournGroupName,tournGroupRef,tournSites]),lastEntry,userHasTicket,ngSagFlags)>,numZoomTypes<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,isPlayMoney,isMorphLobby,scalePM,server,name,replayerInstance,isOneOnOne,tableFlags,chatLang,quickLobbyVisible,blitzFlags,brandMask,serverObj, <FIXME>tableStakes</FIXME> ,visibilityMaskEx,tableFlags2),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,publProp,avgPlayers,avgVpip,earlyBirdMins,numEarlyBirdMultipliers<M(licenseId,multiplier)>,licenseEarlyBirdMultiplier),lastEntry)>,numSeatFinders<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,replayerAddress,replayerInstance,minPlayersPerTable,isPasswordProtected,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,flags,flags2,isPM,scalePM, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,numTables,numFullTables),lastEntry)>,numGameOrder<gameOrder>,numPppTypes<M( <FIXME>staticData</FIXME> ,buyIn,lastEntry)>
			ThinAtf::LAtfVector< TournDataStruct, 4 > tourns;
			ThinAtf::LAtfVector< TableDataStruct, 4 > tableTypes;
			ThinAtf::LAtfVector< SngDataStruct, 4 > sngTypes;
			ThinAtf::LAtfVector< SagDataStruct, 4 > sagTypes;
			ThinAtf::LAtfVector< ZoomDataStruct, 4 > zoomTypes;
			ThinAtf::LAtfVector< SeatFinderDataStruct, 4 > seatFinders;
			ThinAtf::LAtfVector< UINT32, 4 > gameOrder;	// GameCategoryTypes
			ThinAtf::LAtfVector< PPPDataStruct, 4 > pppTypes;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_GAME_LIST_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_GAME_LIST_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_TABLE_TYPE_COUNTS
		{
			//! M(48b8844s44444884) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4)4 - M(locale,gameMask,isPlayMoney,minStake,maxStake,currencyMask,tableSizeMask,country,gameCategoryMask,capMask,anteMask,minDeepRatio,maxDeepRatio,minBuyIn,maxBuyIn,variantMask), <FIXME>loginExtraData</FIXME> ,M(context),filterTypeToCount
			TableSelectionFilter filter;
			CommonThin::AtfShared::LoginExtra loginExtraData;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_TABLE_TYPE_COUNTS; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_TABLE_TYPE_COUNTS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_TABLE_TYPE_COUNTS_REPLY
		{
			// 44<M(M(888)8)> - filterTypeToCount,numCounts<M(M(intVal1,intVal2,intVal3),value)>
			INT32 filterTypeToCount;	// NGFilterTypes
			ThinAtf::LAtfVector< FilterCountInfo, 4 > counts;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_TABLE_TYPE_COUNTS_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_TABLE_TYPE_COUNTS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_TOURNAMENT_COUNTS
		{
			//! M(484884444444sb4<4>4444) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4)4 - M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,tournTypeMask,currencyMask,tableSizeMask,tournVariantMask,tournStateMask,startingWithin,country,isPM,numTournGroups<tournGroups>,lateRegCutoff,genderRestrictMask,tournDisplayMask,negateTournVariantMask), <FIXME>loginExtraData</FIXME> ,M(context),filterTypeToCount
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_TOURNAMENT_COUNTS; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_TOURNAMENT_COUNTS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_TOURNAMENT_COUNTS_REPLY
		{
			// 44<M(M(888)8)> - filterTypeToCount,numCounts<M(M(intVal1,intVal2,intVal3),value)>
			INT32 filterTypeToCount;	// NGFilterTypes
			ThinAtf::LAtfVector< FilterCountInfo, 4 > counts;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_TOURNAMENT_COUNTS_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_TOURNAMENT_COUNTS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_SNG_COUNTS
		{
			//! M(484884444sb444<4>444) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4)4 - M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,currencyMask,tableSizeMask,tournVariantMask,country,isPM,tableNumMask,gameCategoryMask,numTournGroups<tournGroups>,tournStateMask,negateTournVariantMask,numPlayers), <FIXME>loginExtraData</FIXME> ,M(context),filterTypeToCount
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_SNG_COUNTS; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_SNG_COUNTS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_SNG_COUNTS_REPLY
		{
			// 44<M(M(888)8)> - filterTypeToCount,numCounts<M(M(intVal1,intVal2,intVal3),value)>
			INT32 filterTypeToCount;	// NGFilterTypes
			ThinAtf::LAtfVector< FilterCountInfo, 4 > counts;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_SNG_COUNTS_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_SNG_COUNTS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_GAME_CONN_INFO
		{
			// 4<M(844)>44 - numGame<M(gameId,category,ngSagFlags)>,locale,licenseId
			ThinAtf::LAtfVector< GameConnInfoReqStruct, 4 > game;
			UINT32 locale;
			UINT32 licenseId;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_GAME_CONN_INFO; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_GAME_CONN_INFO"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_GAME_CONN_INFO_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_GAME_CONN_INFO_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_GAME_CONN_INFO_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_TICKET_TOURNS
		{
			//! 4<s>4 <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4) - numTicketNames<ticketNames>,locale, <FIXME>loginExtraData</FIXME> ,M(context)
			ThinAtf::LAtfVector< PString, 4 > ticketNames;
			UINT32 locale;
			CommonThin::AtfShared::LoginExtra loginExtraData;
			ClientMarkers clientMarkers;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_TICKET_TOURNS; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_TICKET_TOURNS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_TICKET_TOURNS_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_TICKET_TOURNS_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_TICKET_TOURNS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_GAME_INFO
		{
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_GAME_INFO; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_GAME_INFO"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};

		struct Protocol_MSG_MLOBBYNG_GET_GAME_INFO_REPLY
		{
			//! 4<M(M(8ssst44411ss14441114444t444b4<s>14ts2s44s241s1121bs4112sss88t4bM( <FIXME>TournClientThin::NStackTournInfoStruct</FIXME> )44s4141444ss444<s>ss4m)M(441414<M(2444tm)>44b4441)tb)>4<M(41111414444s44b4<s>b444444<4>bbt <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>48m)>4<M(44b1111s44414b4<s>4412s41484s48s44t4<s>44<M(4444<M(41)>)>4<M(2s)>4ssmb)>4<M(M(b[444444441111444s444<M(14<M(114s)>)>4<4>sb4<sb4<s>>ss44<s>b4ssm])tb4)>4<M(M(411114444s4444sb4<s>1b4sss142b44s <FIXME>TableCommonThin::TableStakes</FIXME> m8)M(444411144<M(44)>4)t)>4<M(M(411114444s4444sb4<s>ss1b44<4>48b4 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m)M(444444)t)>4<M(M(8sss411111444214444ss4411b4<s>448b444 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m4))> - numTourns<M(M(tournamentId,server,targetServer,hasSatellite,whenStart,buyIn,rake,fppBuyIn,isRestricted,isPwdProtected,name,admissionId,isPlayMoney,satelliteTarget,minPlayers,tournFlags,game,isHiLo,structure,tournMask,tournSites,whenStartInt,tournMask2,targetWhenStart,tournMask3,tournMask4,maxPerTable,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,hasDayTwoStart,dayTwoStartSec,dayTwoStart,shortText,chatLang,currency,tournFlagsServInt,knockout,satelliteTargetReference,satelliteTargetReferenceLock,maxPlayers,speedDisplay,nameSnG,step,timedTournType,timedTournTime,timedTournPayout,isFlightTourn,tournBrand,scalePM,progressiveKnockout,awardScheme,numReentries,internalReference,favReference,satelliteTargetName,admissionPrice,tournFlags2,regEndAbs,regEndAbsInt,doNotAllowToUnreg,M( <FIXME>nStackInfo</FIXME> ),tournMask5,tournMask6,satelliteTargetNameMTT,liveEventMask,timedTournPlayersPercent,dummy1,rmPmLobby,brandAccessMask,activeFlags,sngScriptId,customSpeedDisplayName,mobileName,tournGroup,guaranteedPrizePool,numAdmissions<admissions>,serverObj,tournGroupRef,maxPayoutSag,tournSitesEx),M(fakeStatus,entrants,publProp,prizePoolToPublish,prizePoolUnit,numHappyHoursMultipliers<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,goldenSnGMilestoneAwardStub,dummy1,goldenSnGEligibleStub,goldenSnGTotalAddonStub,prizePoolMoneyToPublish,timedTournPlayersThreshold,mixTournSatellite),lastEntry,userHasTicket)>,numTableTypes<M(id,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,structure,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,visible,scalePM,defaultBuyIn,brandMask,seatFinderId,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,isPasswordProtected,isMorphLobby,lastEntry, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,tableFlags,tableFlags2,visibilityMaskEx)>,numSngTypes<M(id,tournSites,visible,game,structure,isHiLo,isPlayMoney,currency,buyIn,rake,knockout,speedDisplay,minPlayers,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,scalePM,brandAccessMask,timedTournType,timedTournTime,visibilityCriteria,maxPerTable,timedTournPlayersPercent,tournFlags,tournFlags2,satelliteTarget,satelliteTargetReference,tournFlagsServInt,regTournId,mobileName,tournGroup,maxPlayers,lastEntry,numAdmissions<admissions>,fppBuyIn,numPrizes<M(min,max,numTickets,numWinners<M(amount,flags)>)>,numTickets<M(ticketId,admission)>,awardScheme,tournGroupName,tournGroupRef,tournSitesEx,userHasTicket)>,numSagTypes<M(M(active[scriptId,flags,brandMask,siteMask,buyin,rake,currency,scalePM,game,isHiLo,structure,speedDisplay,minPrizePool,maxPrizePool,maxPayout,promoRef,minClientVersion,maxClientVersion,numMods<M(numUsers,numSpinnerPrizes<M(level,type,value,targetRef)>)>,numTickets<tickets>,customSpeedDisplayName,restrictCountryInversion,numStatesByCountry<country,stateInversion,numStates<states>>,visibilityCriteria,mobileName,tournGroup,numAdmissions<admissions>,isPlayMoney,tournFlags,tournGroupName,tournGroupRef,tournSites]),lastEntry,userHasTicket,ngSagFlags)>,numZoomTypes<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,isPlayMoney,isMorphLobby,scalePM,server,name,replayerInstance,isOneOnOne,tableFlags,chatLang,quickLobbyVisible,blitzFlags,brandMask,serverObj, <FIXME>tableStakes</FIXME> ,visibilityMaskEx,tableFlags2),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,publProp,avgPlayers,avgVpip,earlyBirdMins,numEarlyBirdMultipliers<M(licenseId,multiplier)>,licenseEarlyBirdMultiplier),lastEntry)>,numSeatFinders<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,replayerAddress,replayerInstance,minPlayersPerTable,isPasswordProtected,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,flags,flags2,isPM,scalePM, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,numTables,numFullTables),lastEntry)>,numTables<M(M(tableId,name,server,serverObject,clubId,isOneOnOne,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,tableFlags,tableInstanceFlags,chatLang,structure,loBet,hiBet,ante,cap,specialName,currency,minChipsLimit,maxBuyIn,icon,filter,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,scalePM,defaultBuyIn,tableFlags2,isTableStarter,brandMask,poolBlockMinHands,tableTypeId, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx,seatFinderId))>
			ThinAtf::LAtfVector< TournDataStruct, 4 > tourns;
			ThinAtf::LAtfVector< TableDataStruct, 4 > tableTypes;
			ThinAtf::LAtfVector< SngDataStruct, 4 > sngTypes;
			ThinAtf::LAtfVector< SagDataStruct, 4 > sagTypes;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_GAME_INFO_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_GAME_INFO_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_FILTER_GAMES
		{
			//! M(44<M(484884444444sb4<4>4444)>4<M(48b8844s44444884)>4<M(484884444sb444<4>444)>)M(4) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4)4 - M(locale,numTournFilters<M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,tournTypeMask,currencyMask,tableSizeMask,tournVariantMask,tournStateMask,startingWithin,country,isPM,numTournGroups<tournGroups>,lateRegCutoff,genderRestrictMask,tournDisplayMask,negateTournVariantMask)>,numTableFilters<M(locale,gameMask,isPlayMoney,minStake,maxStake,currencyMask,tableSizeMask,country,gameCategoryMask,capMask,anteMask,minDeepRatio,maxDeepRatio,minBuyIn,maxBuyIn,variantMask)>,numSngFilters<M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,currencyMask,tableSizeMask,tournVariantMask,country,isPM,tableNumMask,gameCategoryMask,numTournGroups<tournGroups>,tournStateMask,negateTournVariantMask,numPlayers)>),M(maxItems), <FIXME>loginExtraData</FIXME> ,M(context),licenseId
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_FILTER_GAMES; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_FILTER_GAMES"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_FILTER_GAMES_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_FILTER_GAMES_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_FILTER_GAMES_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_FILTER_GAMES_PS
		{
			//! M(44<M(484884444444sb4<4>4444)>4<M(48b8844s44444884)>4<M(484884444sb444<4>444)>)M(4) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4)4 - M(locale,numTournFilters<M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,tournTypeMask,currencyMask,tableSizeMask,tournVariantMask,tournStateMask,startingWithin,country,isPM,numTournGroups<tournGroups>,lateRegCutoff,genderRestrictMask,tournDisplayMask,negateTournVariantMask)>,numTableFilters<M(locale,gameMask,isPlayMoney,minStake,maxStake,currencyMask,tableSizeMask,country,gameCategoryMask,capMask,anteMask,minDeepRatio,maxDeepRatio,minBuyIn,maxBuyIn,variantMask)>,numSngFilters<M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,currencyMask,tableSizeMask,tournVariantMask,country,isPM,tableNumMask,gameCategoryMask,numTournGroups<tournGroups>,tournStateMask,negateTournVariantMask,numPlayers)>),M(maxItems), <FIXME>loginExtraData</FIXME> ,M(context),licenseId
			FilterGamesSelectionFilter filter;
			FilterGamesResultCriteria criteria;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_FILTER_GAMES_PS; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_FILTER_GAMES_PS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_FILTER_GAMES_PS_REPLY
		{
			//! 4<M(M(8ssst44411ss14441114444t444b4<s>14ts2s44s241s1121bs4112sss88t4bM( <FIXME>TournClientThin::NStackTournInfoStruct</FIXME> )44s4141444ss444<s>ss4m)M(441414<M(2444tm)>44b4441)tb)>4<M(41111414444s44b4<s>b444444<4>bbt <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>48m)>4<M(44b1111s44414b4<s>4412s41484s48s44t4<s>44<M(4444<M(41)>)>4<M(2s)>4ssmb)>4<M(M(b[444444441111444s444<M(14<M(114s)>)>4<4>sb4<sb4<s>>ss44<s>b4ssm])tb4)>4<M(M(411114444s4444sb4<s>1b4sss142b44s <FIXME>TableCommonThin::TableStakes</FIXME> m8)M(444411144<M(44)>4)t)>4<M(M(411114444s4444sb4<s>ss1b44<4>48b4 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m)M(444444)t)>4<4>488M(8444448844) - numTourns<M(M(tournamentId,server,targetServer,hasSatellite,whenStart,buyIn,rake,fppBuyIn,isRestricted,isPwdProtected,name,admissionId,isPlayMoney,satelliteTarget,minPlayers,tournFlags,game,isHiLo,structure,tournMask,tournSites,whenStartInt,tournMask2,targetWhenStart,tournMask3,tournMask4,maxPerTable,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,hasDayTwoStart,dayTwoStartSec,dayTwoStart,shortText,chatLang,currency,tournFlagsServInt,knockout,satelliteTargetReference,satelliteTargetReferenceLock,maxPlayers,speedDisplay,nameSnG,step,timedTournType,timedTournTime,timedTournPayout,isFlightTourn,tournBrand,scalePM,progressiveKnockout,awardScheme,numReentries,internalReference,favReference,satelliteTargetName,admissionPrice,tournFlags2,regEndAbs,regEndAbsInt,doNotAllowToUnreg,M( <FIXME>nStackInfo</FIXME> ),tournMask5,tournMask6,satelliteTargetNameMTT,liveEventMask,timedTournPlayersPercent,dummy1,rmPmLobby,brandAccessMask,activeFlags,sngScriptId,customSpeedDisplayName,mobileName,tournGroup,guaranteedPrizePool,numAdmissions<admissions>,serverObj,tournGroupRef,maxPayoutSag,tournSitesEx),M(fakeStatus,entrants,publProp,prizePoolToPublish,prizePoolUnit,numHappyHoursMultipliers<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,goldenSnGMilestoneAwardStub,dummy1,goldenSnGEligibleStub,goldenSnGTotalAddonStub,prizePoolMoneyToPublish,timedTournPlayersThreshold,mixTournSatellite),lastEntry,userHasTicket)>,numTableTypes<M(id,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,structure,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,visible,scalePM,defaultBuyIn,brandMask,seatFinderId,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,isPasswordProtected,isMorphLobby,lastEntry, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,tableFlags,tableFlags2,visibilityMaskEx)>,numSngTypes<M(id,tournSites,visible,game,structure,isHiLo,isPlayMoney,currency,buyIn,rake,knockout,speedDisplay,minPlayers,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,scalePM,brandAccessMask,timedTournType,timedTournTime,visibilityCriteria,maxPerTable,timedTournPlayersPercent,tournFlags,tournFlags2,satelliteTarget,satelliteTargetReference,tournFlagsServInt,regTournId,mobileName,tournGroup,maxPlayers,lastEntry,numAdmissions<admissions>,fppBuyIn,numPrizes<M(min,max,numTickets,numWinners<M(amount,flags)>)>,numTickets<M(ticketId,admission)>,awardScheme,tournGroupName,tournGroupRef,tournSitesEx,userHasTicket)>,numSagTypes<M(M(active[scriptId,flags,brandMask,siteMask,buyin,rake,currency,scalePM,game,isHiLo,structure,speedDisplay,minPrizePool,maxPrizePool,maxPayout,promoRef,minClientVersion,maxClientVersion,numMods<M(numUsers,numSpinnerPrizes<M(level,type,value,targetRef)>)>,numTickets<tickets>,customSpeedDisplayName,restrictCountryInversion,numStatesByCountry<country,stateInversion,numStates<states>>,visibilityCriteria,mobileName,tournGroup,numAdmissions<admissions>,isPlayMoney,tournFlags,tournGroupName,tournGroupRef,tournSites]),lastEntry,userHasTicket,ngSagFlags)>,numZoomTypes<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,isPlayMoney,isMorphLobby,scalePM,server,name,replayerInstance,isOneOnOne,tableFlags,chatLang,quickLobbyVisible,blitzFlags,brandMask,serverObj, <FIXME>tableStakes</FIXME> ,visibilityMaskEx,tableFlags2),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,publProp,avgPlayers,avgVpip,earlyBirdMins,numEarlyBirdMultipliers<M(licenseId,multiplier)>,licenseEarlyBirdMultiplier),lastEntry)>,numSeatFinders<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,replayerAddress,replayerInstance,minPlayersPerTable,isPasswordProtected,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,flags,flags2,isPM,scalePM, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,numTables,numFullTables),lastEntry)>,numGameOrder<gameOrder>,totalItems,minBuyIn,maxBuyIn,M(gameMask,tableSizeMask,speedMask,tournVariantMask,minNumPlayers,maxNumPlayers,minBuyIn,maxBuyIn,tournStateMask,gameCategoryMask)
			ThinAtf::LAtfVector< TournDataStruct, 4 > tourns;
			ThinAtf::LAtfVector< TableDataStruct, 4 > tableTypes;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_FILTER_GAMES_PS_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_FILTER_GAMES_PS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_SUGGESTED_GAMES2
		{
			//! M(48884<M(484884444444sb4<4>4444)>4<M(48b8844s44444884)>4<M(484884444sb444<4>444)>) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4)4 - M(locale,tournMedianValue,sngMedianValue,ringMedianValue,numTournFilters<M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,tournTypeMask,currencyMask,tableSizeMask,tournVariantMask,tournStateMask,startingWithin,country,isPM,numTournGroups<tournGroups>,lateRegCutoff,genderRestrictMask,tournDisplayMask,negateTournVariantMask)>,numTableFilters<M(locale,gameMask,isPlayMoney,minStake,maxStake,currencyMask,tableSizeMask,country,gameCategoryMask,capMask,anteMask,minDeepRatio,maxDeepRatio,minBuyIn,maxBuyIn,variantMask)>,numSngFilters<M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,currencyMask,tableSizeMask,tournVariantMask,country,isPM,tableNumMask,gameCategoryMask,numTournGroups<tournGroups>,tournStateMask,negateTournVariantMask,numPlayers)>), <FIXME>loginExtraData</FIXME> ,M(context),licenseId
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_SUGGESTED_GAMES2; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_SUGGESTED_GAMES2"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_PS
		{
			//! M(48884<M(484884444444sb4<4>4444)>4<M(48b8844s44444884)>4<M(484884444sb444<4>444)>) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4)4 - M(locale,tournMedianValue,sngMedianValue,ringMedianValue,numTournFilters<M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,tournTypeMask,currencyMask,tableSizeMask,tournVariantMask,tournStateMask,startingWithin,country,isPM,numTournGroups<tournGroups>,lateRegCutoff,genderRestrictMask,tournDisplayMask,negateTournVariantMask)>,numTableFilters<M(locale,gameMask,isPlayMoney,minStake,maxStake,currencyMask,tableSizeMask,country,gameCategoryMask,capMask,anteMask,minDeepRatio,maxDeepRatio,minBuyIn,maxBuyIn,variantMask)>,numSngFilters<M(locale,gameMask,buyInMask,minBuyIn,maxBuyIn,speedMask,currencyMask,tableSizeMask,tournVariantMask,country,isPM,tableNumMask,gameCategoryMask,numTournGroups<tournGroups>,tournStateMask,negateTournVariantMask,numPlayers)>), <FIXME>loginExtraData</FIXME> ,M(context),licenseId
			SuggestedGames2SelectionFilter filter;
			CommonThin::AtfShared::LoginExtra loginExtraData;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_PS; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_PS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_PS_REPLY
		{
			//! 4<M(M(8ssst44411ss14441114444t444b4<s>14ts2s44s241s1121bs4112sss88t4bM( <FIXME>TournClientThin::NStackTournInfoStruct</FIXME> )44s4141444ss444<s>ss4m)M(441414<M(2444tm)>44b4441)tb)>4<M(41111414444s44b4<s>b444444<4>bbt <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>48m)>4<M(44b1111s44414b4<s>4412s41484s48s44t4<s>44<M(4444<M(41)>)>4<M(2s)>4ssmb)>4<M(M(b[444444441111444s444<M(14<M(114s)>)>4<4>sb4<sb4<s>>ss44<s>b4ssm])tb4)>4<M(M(411114444s4444sb4<s>1b4sss142b44s <FIXME>TableCommonThin::TableStakes</FIXME> m8)M(444411144<M(44)>4)t)>4<M(M(411114444s4444sb4<s>ss1b44<4>48b4 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m)M(444444)t)>4<4> - numTourns<M(M(tournamentId,server,targetServer,hasSatellite,whenStart,buyIn,rake,fppBuyIn,isRestricted,isPwdProtected,name,admissionId,isPlayMoney,satelliteTarget,minPlayers,tournFlags,game,isHiLo,structure,tournMask,tournSites,whenStartInt,tournMask2,targetWhenStart,tournMask3,tournMask4,maxPerTable,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,hasDayTwoStart,dayTwoStartSec,dayTwoStart,shortText,chatLang,currency,tournFlagsServInt,knockout,satelliteTargetReference,satelliteTargetReferenceLock,maxPlayers,speedDisplay,nameSnG,step,timedTournType,timedTournTime,timedTournPayout,isFlightTourn,tournBrand,scalePM,progressiveKnockout,awardScheme,numReentries,internalReference,favReference,satelliteTargetName,admissionPrice,tournFlags2,regEndAbs,regEndAbsInt,doNotAllowToUnreg,M( <FIXME>nStackInfo</FIXME> ),tournMask5,tournMask6,satelliteTargetNameMTT,liveEventMask,timedTournPlayersPercent,dummy1,rmPmLobby,brandAccessMask,activeFlags,sngScriptId,customSpeedDisplayName,mobileName,tournGroup,guaranteedPrizePool,numAdmissions<admissions>,serverObj,tournGroupRef,maxPayoutSag,tournSitesEx),M(fakeStatus,entrants,publProp,prizePoolToPublish,prizePoolUnit,numHappyHoursMultipliers<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,goldenSnGMilestoneAwardStub,dummy1,goldenSnGEligibleStub,goldenSnGTotalAddonStub,prizePoolMoneyToPublish,timedTournPlayersThreshold,mixTournSatellite),lastEntry,userHasTicket)>,numTableTypes<M(id,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,structure,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,visible,scalePM,defaultBuyIn,brandMask,seatFinderId,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,isPasswordProtected,isMorphLobby,lastEntry, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,tableFlags,tableFlags2,visibilityMaskEx)>,numSngTypes<M(id,tournSites,visible,game,structure,isHiLo,isPlayMoney,currency,buyIn,rake,knockout,speedDisplay,minPlayers,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,scalePM,brandAccessMask,timedTournType,timedTournTime,visibilityCriteria,maxPerTable,timedTournPlayersPercent,tournFlags,tournFlags2,satelliteTarget,satelliteTargetReference,tournFlagsServInt,regTournId,mobileName,tournGroup,maxPlayers,lastEntry,numAdmissions<admissions>,fppBuyIn,numPrizes<M(min,max,numTickets,numWinners<M(amount,flags)>)>,numTickets<M(ticketId,admission)>,awardScheme,tournGroupName,tournGroupRef,tournSitesEx,userHasTicket)>,numSagTypes<M(M(active[scriptId,flags,brandMask,siteMask,buyin,rake,currency,scalePM,game,isHiLo,structure,speedDisplay,minPrizePool,maxPrizePool,maxPayout,promoRef,minClientVersion,maxClientVersion,numMods<M(numUsers,numSpinnerPrizes<M(level,type,value,targetRef)>)>,numTickets<tickets>,customSpeedDisplayName,restrictCountryInversion,numStatesByCountry<country,stateInversion,numStates<states>>,visibilityCriteria,mobileName,tournGroup,numAdmissions<admissions>,isPlayMoney,tournFlags,tournGroupName,tournGroupRef,tournSites]),lastEntry,userHasTicket,ngSagFlags)>,numZoomTypes<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,isPlayMoney,isMorphLobby,scalePM,server,name,replayerInstance,isOneOnOne,tableFlags,chatLang,quickLobbyVisible,blitzFlags,brandMask,serverObj, <FIXME>tableStakes</FIXME> ,visibilityMaskEx,tableFlags2),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,publProp,avgPlayers,avgVpip,earlyBirdMins,numEarlyBirdMultipliers<M(licenseId,multiplier)>,licenseEarlyBirdMultiplier),lastEntry)>,numSeatFinders<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,replayerAddress,replayerInstance,minPlayersPerTable,isPasswordProtected,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,flags,flags2,isPM,scalePM, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,numTables,numFullTables),lastEntry)>,numGameOrder<gameOrder>
			ThinAtf::LAtfVector< TournDataStruct, 4 > tourns;
			ThinAtf::LAtfVector< TableDataStruct, 4 > tableTypes;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_PS_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_SUGGESTED_GAMES2_PS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_SEARCH_BY_NAME
		{
			//! M(4ssb)M(4) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4) - M(locale,name,country,isPM),M(maxItems), <FIXME>loginExtraData</FIXME> ,M(context)
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_SEARCH_BY_NAME; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_SEARCH_BY_NAME"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_SEARCH_BY_NAME_REPLY
		{
			//! 4<M(M(8ssst44411ss14441114444t444b4<s>14ts2s44s241s1121bs4112sss88t4bM( <FIXME>TournClientThin::NStackTournInfoStruct</FIXME> )44s4141444ss444<s>ss4m)M(441414<M(2444tm)>44b4441)tb)>4<M(41111414444s44b4<s>b444444<4>bbt <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>48m)>4<M(44b1111s44414b4<s>4412s41484s48s44t4<s>44<M(4444<M(41)>)>4<M(2s)>4ssmb)>4<M(M(b[444444441111444s444<M(14<M(114s)>)>4<4>sb4<sb4<s>>ss44<s>b4ssm])tb4)>4<M(M(411114444s4444sb4<s>1b4sss142b44s <FIXME>TableCommonThin::TableStakes</FIXME> m8)M(444411144<M(44)>4)t)>4<M(M(411114444s4444sb4<s>ss1b44<4>48b4 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m)M(444444)t)>4<4> - numTourns<M(M(tournamentId,server,targetServer,hasSatellite,whenStart,buyIn,rake,fppBuyIn,isRestricted,isPwdProtected,name,admissionId,isPlayMoney,satelliteTarget,minPlayers,tournFlags,game,isHiLo,structure,tournMask,tournSites,whenStartInt,tournMask2,targetWhenStart,tournMask3,tournMask4,maxPerTable,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,hasDayTwoStart,dayTwoStartSec,dayTwoStart,shortText,chatLang,currency,tournFlagsServInt,knockout,satelliteTargetReference,satelliteTargetReferenceLock,maxPlayers,speedDisplay,nameSnG,step,timedTournType,timedTournTime,timedTournPayout,isFlightTourn,tournBrand,scalePM,progressiveKnockout,awardScheme,numReentries,internalReference,favReference,satelliteTargetName,admissionPrice,tournFlags2,regEndAbs,regEndAbsInt,doNotAllowToUnreg,M( <FIXME>nStackInfo</FIXME> ),tournMask5,tournMask6,satelliteTargetNameMTT,liveEventMask,timedTournPlayersPercent,dummy1,rmPmLobby,brandAccessMask,activeFlags,sngScriptId,customSpeedDisplayName,mobileName,tournGroup,guaranteedPrizePool,numAdmissions<admissions>,serverObj,tournGroupRef,maxPayoutSag,tournSitesEx),M(fakeStatus,entrants,publProp,prizePoolToPublish,prizePoolUnit,numHappyHoursMultipliers<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,goldenSnGMilestoneAwardStub,dummy1,goldenSnGEligibleStub,goldenSnGTotalAddonStub,prizePoolMoneyToPublish,timedTournPlayersThreshold,mixTournSatellite),lastEntry,userHasTicket)>,numTableTypes<M(id,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,structure,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,visible,scalePM,defaultBuyIn,brandMask,seatFinderId,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,isPasswordProtected,isMorphLobby,lastEntry, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,tableFlags,tableFlags2,visibilityMaskEx)>,numSngTypes<M(id,tournSites,visible,game,structure,isHiLo,isPlayMoney,currency,buyIn,rake,knockout,speedDisplay,minPlayers,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,scalePM,brandAccessMask,timedTournType,timedTournTime,visibilityCriteria,maxPerTable,timedTournPlayersPercent,tournFlags,tournFlags2,satelliteTarget,satelliteTargetReference,tournFlagsServInt,regTournId,mobileName,tournGroup,maxPlayers,lastEntry,numAdmissions<admissions>,fppBuyIn,numPrizes<M(min,max,numTickets,numWinners<M(amount,flags)>)>,numTickets<M(ticketId,admission)>,awardScheme,tournGroupName,tournGroupRef,tournSitesEx,userHasTicket)>,numSagTypes<M(M(active[scriptId,flags,brandMask,siteMask,buyin,rake,currency,scalePM,game,isHiLo,structure,speedDisplay,minPrizePool,maxPrizePool,maxPayout,promoRef,minClientVersion,maxClientVersion,numMods<M(numUsers,numSpinnerPrizes<M(level,type,value,targetRef)>)>,numTickets<tickets>,customSpeedDisplayName,restrictCountryInversion,numStatesByCountry<country,stateInversion,numStates<states>>,visibilityCriteria,mobileName,tournGroup,numAdmissions<admissions>,isPlayMoney,tournFlags,tournGroupName,tournGroupRef,tournSites]),lastEntry,userHasTicket,ngSagFlags)>,numZoomTypes<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,isPlayMoney,isMorphLobby,scalePM,server,name,replayerInstance,isOneOnOne,tableFlags,chatLang,quickLobbyVisible,blitzFlags,brandMask,serverObj, <FIXME>tableStakes</FIXME> ,visibilityMaskEx,tableFlags2),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,publProp,avgPlayers,avgVpip,earlyBirdMins,numEarlyBirdMultipliers<M(licenseId,multiplier)>,licenseEarlyBirdMultiplier),lastEntry)>,numSeatFinders<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,replayerAddress,replayerInstance,minPlayersPerTable,isPasswordProtected,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,flags,flags2,isPM,scalePM, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,numTables,numFullTables),lastEntry)>,numGameOrder<gameOrder>
			ThinAtf::LAtfVector< TournDataStruct, 4 > tourns;
			ThinAtf::LAtfVector< TableDataStruct, 4 > tableTypes;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_SEARCH_BY_NAME_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_SEARCH_BY_NAME_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_SEARCH_BY_NAME_PS
		{
			//! M(4ssb)M(4) <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4) - M(locale,name,country,isPM),M(maxItems), <FIXME>loginExtraData</FIXME> ,M(context)
			NameSearchSelectionFilter filter;
			FilterGamesResultCriteria criteria;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_SEARCH_BY_NAME_PS; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_SEARCH_BY_NAME_PS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_SEARCH_BY_NAME_PS_REPLY
		{
			//! 4<M(M(8ssst44411ss14441114444t444b4<s>14ts2s44s241s1121bs4112sss88t4bM( <FIXME>TournClientThin::NStackTournInfoStruct</FIXME> )44s4141444ss444<s>ss4m)M(441414<M(2444tm)>44b4441)tb)>4<M(41111414444s44b4<s>b444444<4>bbt <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>48m)>4<M(44b1111s44414b4<s>4412s41484s48s44t4<s>44<M(4444<M(41)>)>4<M(2s)>4ssmb)>4<M(M(b[444444441111444s444<M(14<M(114s)>)>4<4>sb4<sb4<s>>ss44<s>b4ssm])tb4)>4<M(M(411114444s4444sb4<s>1b4sss142b44s <FIXME>TableCommonThin::TableStakes</FIXME> m8)M(444411144<M(44)>4)t)>4<M(M(411114444s4444sb4<s>ss1b44<4>48b4 <FIXME>TableCommonThin::TableStakes</FIXME> 4<8>m)M(444444)t)>4<4> - numTourns<M(M(tournamentId,server,targetServer,hasSatellite,whenStart,buyIn,rake,fppBuyIn,isRestricted,isPwdProtected,name,admissionId,isPlayMoney,satelliteTarget,minPlayers,tournFlags,game,isHiLo,structure,tournMask,tournSites,whenStartInt,tournMask2,targetWhenStart,tournMask3,tournMask4,maxPerTable,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,hasDayTwoStart,dayTwoStartSec,dayTwoStart,shortText,chatLang,currency,tournFlagsServInt,knockout,satelliteTargetReference,satelliteTargetReferenceLock,maxPlayers,speedDisplay,nameSnG,step,timedTournType,timedTournTime,timedTournPayout,isFlightTourn,tournBrand,scalePM,progressiveKnockout,awardScheme,numReentries,internalReference,favReference,satelliteTargetName,admissionPrice,tournFlags2,regEndAbs,regEndAbsInt,doNotAllowToUnreg,M( <FIXME>nStackInfo</FIXME> ),tournMask5,tournMask6,satelliteTargetNameMTT,liveEventMask,timedTournPlayersPercent,dummy1,rmPmLobby,brandAccessMask,activeFlags,sngScriptId,customSpeedDisplayName,mobileName,tournGroup,guaranteedPrizePool,numAdmissions<admissions>,serverObj,tournGroupRef,maxPayoutSag,tournSitesEx),M(fakeStatus,entrants,publProp,prizePoolToPublish,prizePoolUnit,numHappyHoursMultipliers<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,goldenSnGMilestoneAwardStub,dummy1,goldenSnGEligibleStub,goldenSnGTotalAddonStub,prizePoolMoneyToPublish,timedTournPlayersThreshold,mixTournSatellite),lastEntry,userHasTicket)>,numTableTypes<M(id,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,structure,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,visible,scalePM,defaultBuyIn,brandMask,seatFinderId,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,isPasswordProtected,isMorphLobby,lastEntry, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,tableFlags,tableFlags2,visibilityMaskEx)>,numSngTypes<M(id,tournSites,visible,game,structure,isHiLo,isPlayMoney,currency,buyIn,rake,knockout,speedDisplay,minPlayers,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,scalePM,brandAccessMask,timedTournType,timedTournTime,visibilityCriteria,maxPerTable,timedTournPlayersPercent,tournFlags,tournFlags2,satelliteTarget,satelliteTargetReference,tournFlagsServInt,regTournId,mobileName,tournGroup,maxPlayers,lastEntry,numAdmissions<admissions>,fppBuyIn,numPrizes<M(min,max,numTickets,numWinners<M(amount,flags)>)>,numTickets<M(ticketId,admission)>,awardScheme,tournGroupName,tournGroupRef,tournSitesEx,userHasTicket)>,numSagTypes<M(M(active[scriptId,flags,brandMask,siteMask,buyin,rake,currency,scalePM,game,isHiLo,structure,speedDisplay,minPrizePool,maxPrizePool,maxPayout,promoRef,minClientVersion,maxClientVersion,numMods<M(numUsers,numSpinnerPrizes<M(level,type,value,targetRef)>)>,numTickets<tickets>,customSpeedDisplayName,restrictCountryInversion,numStatesByCountry<country,stateInversion,numStates<states>>,visibilityCriteria,mobileName,tournGroup,numAdmissions<admissions>,isPlayMoney,tournFlags,tournGroupName,tournGroupRef,tournSites]),lastEntry,userHasTicket,ngSagFlags)>,numZoomTypes<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,isPlayMoney,isMorphLobby,scalePM,server,name,replayerInstance,isOneOnOne,tableFlags,chatLang,quickLobbyVisible,blitzFlags,brandMask,serverObj, <FIXME>tableStakes</FIXME> ,visibilityMaskEx,tableFlags2),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,publProp,avgPlayers,avgVpip,earlyBirdMins,numEarlyBirdMultipliers<M(licenseId,multiplier)>,licenseEarlyBirdMultiplier),lastEntry)>,numSeatFinders<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,replayerAddress,replayerInstance,minPlayersPerTable,isPasswordProtected,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,flags,flags2,isPM,scalePM, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,numTables,numFullTables),lastEntry)>,numGameOrder<gameOrder>
			ThinAtf::LAtfVector< TournDataStruct, 4 > tourns;
			ThinAtf::LAtfVector< TableDataStruct, 4 > tableTypes;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_SEARCH_BY_NAME_PS_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_SEARCH_BY_NAME_PS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_FILTER_TICKET_TOURNS
		{
			// M(4<s>44M(444ssb)4<M(t41144244824s4s)>8) - M(numTicketNames<ticketNames>,gameCategoryMask,ticketTournRequestMask,M(locale,siteId,brandId,country,state,isPM),numActivities<M(eventTime,gameCategory,handType,limit,minPlayers,maxPlayers,playersPerTable,loBet,hiBet,buyIn,speed,tournVariant,strRef,flags,currency)>,gameMask)
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_FILTER_TICKET_TOURNS; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_FILTER_TICKET_TOURNS"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_FILTER_TICKET_TOURNS_REPLY
		{
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_FILTER_TICKET_TOURNS_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_FILTER_TICKET_TOURNS_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_BRANDED_LOBBIES
		{
			//! 4 <FIXME>CommonThin::AtfShared::LoginExtra</FIXME> M(4)4sb - locale, <FIXME>loginExtraData</FIXME> ,M(context),currencyMask,country,isPM
			UINT32 locale;
			CommonThin::AtfShared::LoginExtra loginExtraData;
			ClientMarkers clientMarkers;
			UINT32 currencyMask;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_BRANDED_LOBBIES; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_BRANDED_LOBBIES"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_GET_BRANDED_LOBBIES_REPLY
		{
			...
			ThinAtf::LAtfVector< BrandedLobbyInfo, 4 > lobbies;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_GET_BRANDED_LOBBIES_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_GET_BRANDED_LOBBIES_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_FIND_TOURNS_BY_REF
		{
			// M(s44sbb4) - M(internalRef,siteId,brandId,country,usePMFlag,isPM,locale)
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_FIND_TOURNS_BY_REF; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_FIND_TOURNS_BY_REF"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBYNG_FIND_TOURNS_BY_REF_REPLY
		{
			//! 4<M(M(8ssst44411ss14441114444t444b4<s>14ts2s44s241s1121bs4112sss88t4bM( <FIXME>TournClientThin::NStackTournInfoStruct</FIXME> )44s4141444ss444<s>ss4m)M(441414<M(2444tm)>44b4441)tb)> - numTourns<M(M(tournamentId,server,targetServer,hasSatellite,whenStart,buyIn,rake,fppBuyIn,isRestricted,isPwdProtected,name,admissionId,isPlayMoney,satelliteTarget,minPlayers,tournFlags,game,isHiLo,structure,tournMask,tournSites,whenStartInt,tournMask2,targetWhenStart,tournMask3,tournMask4,maxPerTable,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,hasDayTwoStart,dayTwoStartSec,dayTwoStart,shortText,chatLang,currency,tournFlagsServInt,knockout,satelliteTargetReference,satelliteTargetReferenceLock,maxPlayers,speedDisplay,nameSnG,step,timedTournType,timedTournTime,timedTournPayout,isFlightTourn,tournBrand,scalePM,progressiveKnockout,awardScheme,numReentries,internalReference,favReference,satelliteTargetName,admissionPrice,tournFlags2,regEndAbs,regEndAbsInt,doNotAllowToUnreg,M( <FIXME>nStackInfo</FIXME> ),tournMask5,tournMask6,satelliteTargetNameMTT,liveEventMask,timedTournPlayersPercent,dummy1,rmPmLobby,brandAccessMask,activeFlags,sngScriptId,customSpeedDisplayName,mobileName,tournGroup,guaranteedPrizePool,numAdmissions<admissions>,serverObj,tournGroupRef,maxPayoutSag,tournSitesEx),M(fakeStatus,entrants,publProp,prizePoolToPublish,prizePoolUnit,numHappyHoursMultipliers<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,goldenSnGMilestoneAwardStub,dummy1,goldenSnGEligibleStub,goldenSnGTotalAddonStub,prizePoolMoneyToPublish,timedTournPlayersThreshold,mixTournSatellite),lastEntry,userHasTicket)>
			ThinAtf::LAtfVector< TournDataStruct, 4 > tourns;
			...
			static UINT32 getMsgId() { return MSG_MLOBBYNG_FIND_TOURNS_BY_REF_REPLY; }
			static const char *getMsgIdString() { return "MSG_MLOBBYNG_FIND_TOURNS_BY_REF_REPLY"; }
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
