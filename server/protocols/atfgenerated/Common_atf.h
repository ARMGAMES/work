...
#ifndef ATF_PROTOCOL_DEFFILE_COMMON_ATF_H
#define ATF_PROTOCOL_DEFFILE_COMMON_ATF_H
...
namespace Common
{
	namespace AtfShared
	{
		...
		struct CurrencyContextOptionalMsgBody
		{
			...
			SrvTime srvTime;
			Atf::LAtfVector< ConvRatesAndMarginsStruct, 4 > convRatesAndMargins;	// ??? pending maxsize
		...
		struct UserCurrencyAccounts
		{
			...
			Atf::LAtfVector< UserCurrencyAccount, 4 > exAccounts;
		...
		struct UserWithProperties
		{
			...
			Atf::LAtfVector< UserPropertyLegacy, 4 > userProps;
