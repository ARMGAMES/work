...
#ifndef ATF_PROTOCOL_DEFFILE_MTLOBBY_ATF_CLI_H
#define ATF_PROTOCOL_DEFFILE_MTLOBBY_ATF_CLI_H
...
namespace MTLobbyCli
{
	...
	namespace publication
	{
		...
		struct TournSubscr_Static	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_STATIC_LEAF }
		{
			...
			UINT32 tournProp2;
			Atf::LAtfVector< P_TicketType , 4 > ticketTypes;
			UINT32 tableLogo;
			...
			UINT32 bounty;
			Atf::LAtfVector< UINT32 , 4 > fallbackSatelliteTargets;

			Atf::LAtfVector< UINT32 , 4 > teamProBounties;
			Atf::LAtfVector< UINT32 , 4 > bountyMultipliers;
			...
			bool _obsolete_3;
			Atf::LAtfVector< P_FppReward , 4 > fppRewards;
			BYTE speedDisplay;
			PString tournBrand;
			UINT32 scalePM;
			...
			Atf::LAtfVector< P_MultiDayInfo , 4 > multiDayInfo;
			PString criteria;
		...
		struct TournSubscr_Awards	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_DYNAMIC_AWARDS_LEAF }
		{
			...
			Atf::LAtfVector< UINT32 , 4 > prizes;
		...
		struct TournSubscr_SpinGoPrize	// Path { PUBL_TOURN2004_ROOT, PUBL_TOURN2004_DYNAMIC_SAG_LEAF }
		{
			...
			Atf::LAtfVector< INT64 , 4 > spinGoLevels;
			INT32 spinGoMarker;
			Atf::LAtfVector< I18nPString , 4 > tickets;
			UINT32 level;
			Atf::LAtfVector< TournSubscr_SpinGoPrize_TargetReference , 4 > targetReferences;
			UINT32 spinGoMaxCashout;
			Atf::LAtfVector< TournSubscr_SpinGoPrize_Vector , 4 > spinGoMaxLevels;
		...
		struct TournExtraSubscr_Prize_Prize
		{
			...
			UINT32 max;
			UINT32 numTickets;
			Atf::LAtfVector< TournExtraSubscr_Prize_Winner , 4 > winners;
		...
		struct TournExtraSubscr_Prize	// Path { PUBL_TOURN_INFO_ROOT, PUBL_TOURN_INFO_PRIZES_LEAF }
		{
			...
			UINT32 addOnPrice;
			UINT32 addOnRake;
			Atf::LAtfVector< TournExtraSubscr_Prize_Prize , 4 > prizes;
		...
		struct TournExtraSubscr_Rake	// Path { PUBL_TOURN_INFO_ROOT, PUBL_TOURN_INFO_REBUYRAKECOUNTRIES_LEAF }
		{
			...
			UINT32 sitesNoRake;
			Atf::LAtfVector< TournExtraSubscr_Rake_SitesPerCountry , 4 > sitesPerCountry;

			PBitmask sites4AllCountriesEx;
			PBitmask sitesNoRakeEx;
			Atf::LAtfVector< TournExtraSubscr_Rake_SitesPerCountryEx , 4 > sitesPerCountryEx;
	...
	namespace cli
	{
		...
		{
			//! M(t4< <FIXME>Common::AtfShared::ConvRatesAndMarginsStruct</FIXME> >) - M(srvTime,numConvRatesAndMargins< <FIXME>Common::AtfShared::ConvRatesAndMarginsStruct</FIXME> >)
			SrvTime srvTime;
			Atf::LAtfVector< Common::AtfShared::ConvRatesAndMarginsStruct, 4 > convRatesAndMargins;
		...
		struct ClientCurrencyContext
		{
			...
			INT32 unclearedDst;
			Atf::LAtfVector< OneAccountStruct, 4 > oneAcct;
			UINT32 flags;
			UINT64 flags2;
			UINT32 userRollId;
			INT32 rollAmount;
		...
		struct Protocol_MTL_LOBBY_WHERE_IS_PLAYER : public Atf::MessageProtocol
		{
			// s - userName
			PString userName;
			...
			UINT32 getMsgId() const override { return MTL_LOBBY_WHERE_IS_PLAYER; }
			const char *getMsgIdString() const override { return "MTL_LOBBY_WHERE_IS_PLAYER"; }
		...
		struct Protocol_MTL_LOBBY_WHERE_IS_PLAYER_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_LOBBY_WHERE_IS_PLAYER_REPLY; }
			const char *getMsgIdString() const override { return "MTL_LOBBY_WHERE_IS_PLAYER_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_LOBBY_TOURNAMENT_USER_STATS : public Atf::MessageProtocol
		{
			// s - userName
			PString userName;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_LOBBY_TOURNAMENT_USER_STATS; }
			const char *getMsgIdString() const override { return "MTL_LOBBY_TOURNAMENT_USER_STATS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_LOBBY_TOURNAMENT_USER_STATS_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_LOBBY_TOURNAMENT_USER_STATS_REPLY; }
			const char *getMsgIdString() const override { return "MTL_LOBBY_TOURNAMENT_USER_STATS_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBY_TOURN_REG_INFO_REPLY : public Atf::MessageProtocol
		{
			...
			bool isProportional;
			INT64 admPrice;
			Atf::LAtfVector< UserTicketData, 4 > effectiveAdmissions;
			INT64 tournFlags2;
		...
		struct Protocol_MTL_LOBBY_REGISTER_USER : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_LOBBY_REGISTER_USER; }
			const char *getMsgIdString() const override { return "MTL_LOBBY_REGISTER_USER"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_LOBBY_REGISTER_USER_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_LOBBY_REGISTER_USER_REPLY; }
			const char *getMsgIdString() const override { return "MTL_LOBBY_REGISTER_USER_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_LOBBY_UNREGISTER_USER : public Atf::MessageProtocol
		{
			// 4s - tournId,userName
			UINT32 tournId;
			PString userName;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_LOBBY_UNREGISTER_USER; }
			const char *getMsgIdString() const override { return "MTL_LOBBY_UNREGISTER_USER"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_LOBBY_UNREGISTER_USER_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_LOBBY_UNREGISTER_USER_REPLY; }
			const char *getMsgIdString() const override { return "MTL_LOBBY_UNREGISTER_USER_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct ChipGraphReply
		{
			...
			PString name;
			Atf::LAtfVector< ChipGraphData, 4 > data;
		...
		struct Protocol_MTL_GET_CHIP_GRAPH_DATA : public Atf::MessageProtocol
		{
			// 4<M(s4)> - numRequestData<M(name,time)>
			Atf::LAtfVector< ChipGraphRequest, 4 > requestData;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_GET_CHIP_GRAPH_DATA; }
			const char *getMsgIdString() const override { return "MTL_GET_CHIP_GRAPH_DATA"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_GET_CHIP_GRAPH_DATA_REPLY : public Atf::MessageProtocol
		{
			// 44M() - n,hockeyTime,M()
			UINT32 n;
			UINT32 hockeyTime;
			Atf::CopyableMsgBody chipGraphData;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_GET_CHIP_GRAPH_DATA_REPLY; }
			const char *getMsgIdString() const override { return "MTL_GET_CHIP_GRAPH_DATA_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MTL_GET_SAME_LEVEL_FLIGHTS : public Atf::MessageProtocol
		{
			// 4 - tournId
			UINT32 tournId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MTL_GET_SAME_LEVEL_FLIGHTS; }
			const char *getMsgIdString() const override { return "MSG_MTL_GET_SAME_LEVEL_FLIGHTS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MTL_GET_SAME_LEVEL_FLIGHTS_REPLY : public Atf::MessageProtocol
		{
			...
			UINT32 numLevels;
			Atf::LAtfVector< TGMFlightData, 4 > flightData;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MTL_GET_SAME_LEVEL_FLIGHTS_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MTL_GET_SAME_LEVEL_FLIGHTS_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MTL_CHANGE_FLIGHT : public Atf::MessageProtocol
		{
			// 4 - tournId
			UINT32 tournId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MTL_CHANGE_FLIGHT; }
			const char *getMsgIdString() const override { return "MSG_MTL_CHANGE_FLIGHT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MTL_CHANGE_FLIGHT_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MTL_CHANGE_FLIGHT_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MTL_CHANGE_FLIGHT_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	namespace unauth_cli
	{
		...
		struct Protocol_MSG_LOBBY_OLYMPIC_SNAPSHOT : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBY_OLYMPIC_SNAPSHOT; }
			const char *getMsgIdString() const override { return "MSG_LOBBY_OLYMPIC_SNAPSHOT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBY_OLYMPIC_SNAPSHOT_REPLY : public Atf::MessageProtocol
		{
			...
			INT16 snapshotOk;
			Atf::LAtfVector< SnapshotStruct, 4 > snapshotData;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBY_OLYMPIC_SNAPSHOT_REPLY; }
			const char *getMsgIdString() const override { return "MSG_LOBBY_OLYMPIC_SNAPSHOT_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_TOURN_TEXT_INFO : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_TOURN_TEXT_INFO; }
			const char *getMsgIdString() const override { return "MTL_TOURN_TEXT_INFO"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_TOURN_TEXT_INFO_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_TOURN_TEXT_INFO_REPLY; }
			const char *getMsgIdString() const override { return "MTL_TOURN_TEXT_INFO_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	namespace perm_cli
	{
		...
		struct Protocol_MTL_CLI_GOTO_TABLE : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_CLI_GOTO_TABLE; }
			const char *getMsgIdString() const override { return "GTT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_SITIN : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_SITIN; }
			const char *getMsgIdString() const override { return "MTL_USER_SITIN"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_SITIN_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_SITIN_REPLY; }
			const char *getMsgIdString() const override { return "MTL_USER_SITIN_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_SITOUT : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_SITOUT; }
			const char *getMsgIdString() const override { return "MTL_USER_SITOUT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_SITOUT_REPLY : public Atf::MessageProtocol
		{
			// 2[s] - errCode[errDescr]
			INT16 errCode;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_SITOUT_REPLY; }
			const char *getMsgIdString() const override { return "MTL_USER_SITOUT_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_CLI_GOTO_FINISH : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_CLI_GOTO_FINISH; }
			const char *getMsgIdString() const override { return "GTF"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_REBUY : public Atf::MessageProtocol
		{
			// 1 - numRebuys
			BYTE numRebuys;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_REBUY; }
			const char *getMsgIdString() const override { return "MTL_USER_REBUY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_REBUY_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_REBUY_REPLY; }
			const char *getMsgIdString() const override { return "MTL_USER_REBUY_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_ADDON : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_ADDON; }
			const char *getMsgIdString() const override { return "MTL_USER_ADDON"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_ADDON_REPLY : public Atf::MessageProtocol
		{
			// 1[sM()|4444444s8222M(b[44])] - errCode[errDescr,M()|chipsRecieved,realMoneySpent,playMoneySpent,fppSpent,tChipsSpent,wMoneySpent,isAamsTicket,aamsTicket,playChipsSpent64,rebuysDone,addonsDone,rebuysRemaining,M(limitImposed[spendAmount,spendLimit])]
			BYTE errCode;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_ADDON_REPLY; }
			const char *getMsgIdString() const override { return "MTL_USER_ADDON_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_DECLINE_REBUY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_DECLINE_REBUY; }
			const char *getMsgIdString() const override { return "MTL_USER_DECLINE_REBUY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_SET_IMREADY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_SET_IMREADY; }
			const char *getMsgIdString() const override { return "MTL_SET_IMREADY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_SET_IMREADY_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_SET_IMREADY_REPLY; }
			const char *getMsgIdString() const override { return "MTL_SET_IMREADY_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_GET_IMREADY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_GET_IMREADY; }
			const char *getMsgIdString() const override { return "MTL_GET_IMREADY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_GET_IMREADY_REPLY : public Atf::MessageProtocol
		{
			// 2b - errCode,userReady
			INT16 errCode;
			bool userReady;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_GET_IMREADY_REPLY; }
			const char *getMsgIdString() const override { return "MTL_GET_IMREADY_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_AUTO_RELOAD_STACKS_NOTIFY : public Atf::MessageProtocol
		{
			// 4 - stacksReloaded
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_AUTO_RELOAD_STACKS_NOTIFY; }
			const char *getMsgIdString() const override { return "MTL_USER_AUTO_RELOAD_STACKS_NOTIFY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_RELOAD_STACKS : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_RELOAD_STACKS; }
			const char *getMsgIdString() const override { return "MTL_USER_RELOAD_STACKS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_RELOAD_STACKS_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_RELOAD_STACKS_REPLY; }
			const char *getMsgIdString() const override { return "MTL_USER_RELOAD_STACKS_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MTL_USER_LIMBO_CLIENT_ACTIONTIMER_STARTED : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MTL_USER_LIMBO_CLIENT_ACTIONTIMER_STARTED; }
			const char *getMsgIdString() const override { return "MTL_USER_LIMBO_CLIENT_ACTIONTIMER_STARTED"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
