...
#ifndef ATF_PROTOCOL_DEFFILE_SHADOWLOBBY_ATF_H
#define ATF_PROTOCOL_DEFFILE_SHADOWLOBBY_ATF_H
...
namespace ShadowLobby
{
	namespace publication
	{
		...
		{
			//! 4sss411111441s42s444 <FIXME>Common::AtfShared::LegacyCountryVisibilityFilter</FIXME> 4114b8444844s <FIXME>TableCommon::TableStakes</FIXME> 4<8>m - _obsolete_1,name,server,serverObject,tableFlags,isOneOnOne,isPlayMoney,playerPerTable,game,isHiLo,_obsolete_2,_obsolete_3,structure,typeName,_obsolete_4,chatLang,currency,minChipsLimit,maxBuyIn,_obsolete_5, <FIXME>countryFilter</FIXME> ,cap,iconIndex,filterIndex,tableInstanceFlag,_obsolete_6,tableFlags2,tableTypeId,scalePM,defaultBuyIn,tableId,brandVisibilityMask,_obsolete_7,criteria, <FIXME>tableStakes</FIXME> ,numVarAnte<varAnte>,siteVisibilityMask
			UINT32 _obsolete_1;
			PString name;
			PString server;
			...
			UINT32 maxBuyIn;
			UINT32 _obsolete_5;
			Common::AtfShared::LegacyCountryVisibilityFilter countryFilter;
			UINT32 cap;
			BYTE iconIndex;
			BYTE filterIndex;
			...
			PString criteria;
			TableCommon::TableStakes tableStakes;
			Atf::LAtfVector< INT64 , 4 > varAnte;
		...
		{
			//! 11142141 <FIXME>TableClient::publication::TableSubscr_Static::_HappyHourInfoPublMsgType</FIXME> b - players,waitingList,playersPerFlop,averagePot,handsPerHour,publPropFlag,averageStack,vpip, <FIXME>fppFactor</FIXME> ,active
			BYTE players;
			BYTE waitingList;
			BYTE playersPerFlop;
			UINT32 averagePot;
			...
			UINT32 averageStack;
			BYTE vpip;
			TableClient::publication::TableSubscr_Static::_HappyHourInfoPublMsgType fppFactor;
			bool active;
		...
		struct ReplaySubscr_Static	// Path { 0, n, 0 }
		{
			...
			Atf::LAtfVector< ReplaySubscr_Winner, 4 > winners;
