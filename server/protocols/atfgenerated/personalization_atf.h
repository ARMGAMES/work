...
#ifndef ATF_PROTOCOL_DEFFILE_PERSONALIZATION_ATF_H
#define ATF_PROTOCOL_DEFFILE_PERSONALIZATION_ATF_H
...
namespace PersonalizationATF
{
	...
	namespace cli
	{
		...
		struct Protocol_PS_Q_GET_RECENT_GAME_LIST : public Atf::MessageProtocol
		{
			// 4b - gameTypes,isPM
			...
			UINT32 getMsgId() const override { return PS_Q_GET_RECENT_GAME_LIST; }
			const char *getMsgIdString() const override { return "PS_Q_GET_RECENT_GAME_LIST"; }
		...
		struct Protocol_PS_A_GET_RECENT_GAME_LIST : public Atf::MessageProtocol
		{
			...
			Atf::LAtfVector< MLobbyNG::cli::TournDataStruct, 4 > tourns;
			Atf::LAtfVector< MLobbyNG::cli::TableDataStruct, 4 > tableTypes;
			Atf::LAtfVector< MLobbyNG::cli::SngDataStruct, 4 > sngTypes;
			Atf::LAtfVector< MLobbyNG::cli::SagDataStruct, 4 > sagTypes;
			Atf::LAtfVector< MLobbyNG::cli::ZoomDataStruct, 4 > zoomTypes;
			Atf::LAtfVector< MLobbyNG::cli::SeatFinderDataStruct, 4 > seatFinders;
			Atf::LAtfVector< UINT32, 4 > gameOrder;
			Atf::LAtfVector< MLobbyNG::cli::PPPDataStruct, 4 > pppTypes;	// PYR-123925
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_GET_RECENT_GAME_LIST; }
			const char *getMsgIdString() const override { return "PS_A_GET_RECENT_GAME_LIST"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_ADMIN_GET_RECENT_GAME_LIST : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_ADMIN_GET_RECENT_GAME_LIST; }
			const char *getMsgIdString() const override { return "PS_Q_ADMIN_GET_RECENT_GAME_LIST"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_ADMIN_GET_RECENT_GAME_LIST : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_ADMIN_GET_RECENT_GAME_LIST; }
			const char *getMsgIdString() const override { return "PS_A_ADMIN_GET_RECENT_GAME_LIST"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_U_GET_CURRENTLY_SEATED_AT : public Atf::MessageProtocol
		{
			...
			Atf::LAtfVector< MLobbyNG::cli::TournDataStruct, 4 > tourns;
			Atf::LAtfVector< MLobbyNG::cli::TableData, 4 > tables;
			Atf::LAtfVector< MLobbyNG::cli::ZoomDataStruct, 4 > zoomTypes;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_U_GET_CURRENTLY_SEATED_AT; }
			const char *getMsgIdString() const override { return "PS_U_GET_CURRENTLY_SEATED_AT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_GET_TICKET_TOURNS : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_GET_TICKET_TOURNS; }
			const char *getMsgIdString() const override { return "PS_Q_GET_TICKET_TOURNS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_GET_TICKET_TOURNS : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_GET_TICKET_TOURNS; }
			const char *getMsgIdString() const override { return "PS_A_GET_TICKET_TOURNS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_FILTER_GAMES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_FILTER_GAMES; }
			const char *getMsgIdString() const override { return "PS_Q_FILTER_GAMES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_FILTER_GAMES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_FILTER_GAMES; }
			const char *getMsgIdString() const override { return "PS_A_FILTER_GAMES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_GET_BRANDED_LOBBIES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_GET_BRANDED_LOBBIES; }
			const char *getMsgIdString() const override { return "PS_Q_GET_BRANDED_LOBBIES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_GET_BRANDED_LOBBIES : public Atf::MessageProtocol
		{
			//! 4< <FIXME>MLobbyNG::cli::BrandedLobbyInfo</FIXME> > - numLobbies< <FIXME>MLobbyNG::cli::BrandedLobbyInfo</FIXME> >
			Atf::LAtfVector< MLobbyNG::cli::BrandedLobbyInfo, 4 > lobbies;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_GET_BRANDED_LOBBIES; }
			const char *getMsgIdString() const override { return "PS_A_GET_BRANDED_LOBBIES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_INIT_BRANDED_LOBBIES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_INIT_BRANDED_LOBBIES; }
			const char *getMsgIdString() const override { return "PS_Q_INIT_BRANDED_LOBBIES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_INIT_BRANDED_LOBBIES : public Atf::MessageProtocol
		{
			//! 4< <FIXME>MLobbyNG::cli::FullBrandedLobbyInfo</FIXME> > - numLobbies< <FIXME>MLobbyNG::cli::FullBrandedLobbyInfo</FIXME> >
			Atf::LAtfVector< MLobbyNG::cli::FullBrandedLobbyInfo, 4 > lobbies;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_INIT_BRANDED_LOBBIES; }
			const char *getMsgIdString() const override { return "PS_A_INIT_BRANDED_LOBBIES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_ADMIN_UPDATE_LOBBIES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_ADMIN_UPDATE_LOBBIES; }
			const char *getMsgIdString() const override { return "PS_Q_ADMIN_UPDATE_LOBBIES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_ADMIN_UPDATE_LOBBIES : public Atf::MessageProtocol
		{
			// 2[s] - errCode[errMsg]
			INT16 errCode;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_ADMIN_UPDATE_LOBBIES; }
			const char *getMsgIdString() const override { return "PS_A_ADMIN_UPDATE_LOBBIES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_GET_SUGGESTED_GAMES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_GET_SUGGESTED_GAMES; }
			const char *getMsgIdString() const override { return "PS_Q_GET_SUGGESTED_GAMES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_GET_SUGGESTED_GAMES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_GET_SUGGESTED_GAMES; }
			const char *getMsgIdString() const override { return "PS_A_GET_SUGGESTED_GAMES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_SEARCH_BY_NAME : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_SEARCH_BY_NAME; }
			const char *getMsgIdString() const override { return "PS_Q_SEARCH_BY_NAME"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_SEARCH_BY_NAME : public Atf::MessageProtocol
		{
			//! 4< <FIXME>MLobbyNG::cli::TournDataStruct</FIXME> >4< <FIXME>MLobbyNG::cli::TableDataStruct</FIXME> >4< <FIXME>MLobbyNG::cli::SngDataStruct</FIXME> >4< <FIXME>MLobbyNG::cli::SagDataStruct</FIXME> >4< <FIXME>MLobbyNG::cli::ZoomDataStruct</FIXME> >4< <FIXME>MLobbyNG::cli::SeatFinderDataStruct</FIXME> >4<4> - numTourns< <FIXME>MLobbyNG::cli::TournDataStruct</FIXME> >,numTableTypes< <FIXME>MLobbyNG::cli::TableDataStruct</FIXME> >,numSngTypes< <FIXME>MLobbyNG::cli::SngDataStruct</FIXME> >,numSagTypes< <FIXME>MLobbyNG::cli::SagDataStruct</FIXME> >,numZoomTypes< <FIXME>MLobbyNG::cli::ZoomDataStruct</FIXME> >,numSeatFinders< <FIXME>MLobbyNG::cli::SeatFinderDataStruct</FIXME> >,numGameOrder<gameOrder>
			Atf::LAtfVector< MLobbyNG::cli::TournDataStruct, 4 > tourns;
			Atf::LAtfVector< MLobbyNG::cli::TableDataStruct, 4 > tableTypes;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_SEARCH_BY_NAME; }
			const char *getMsgIdString() const override { return "PS_A_SEARCH_BY_NAME"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_Q_GET_TICKET_COUNTS : public Atf::MessageProtocol
		{
			// M(8) - M(gameMask)
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_Q_GET_TICKET_COUNTS; }
			const char *getMsgIdString() const override { return "PS_Q_GET_TICKET_COUNTS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_PS_A_GET_TICKET_COUNTS : public Atf::MessageProtocol
		{
			// 4<M(4sb4stt4)> - numTickets<M(ticketId,ticketName,multiTourn,price,currency,issued,expireAt,tournNumber)>
			Atf::LAtfVector< TournTicketInfo, 4 > tickets;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return PS_A_GET_TICKET_COUNTS; }
			const char *getMsgIdString() const override { return "PS_A_GET_TICKET_COUNTS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
