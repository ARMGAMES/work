...
#ifndef ATF_PROTOCOL_DEFFILE_SAGSTARTER_ATF_H
#define ATF_PROTOCOL_DEFFILE_SAGSTARTER_ATF_H
...
namespace SagStarter
{
	...
	namespace cli
	{
		struct Protocol_MSG_SAG_TOURN_REG_INFO_BY_SCRIPTID : public Atf::MessageProtocol	// alternative message exists in sagStarterProtocols.txt (for LobbyEtc->SagStarter communication)
		{
			...
			UINT32 getMsgId() const override { return MSG_SAG_TOURN_REG_INFO_BY_SCRIPTID; }
			const char *getMsgIdString() const override { return "MSG_SAG_TOURN_REG_INFO_BY_SCRIPTID"; }
		...
		struct Protocol_MSG_SAG_REGISTER_TOURNAMENT_USER_BY_SCRIPTID : public Atf::MessageProtocol	// alternative message exists in sagStarterProtocols.txt (for LobbyEtc->SagStarter communication)
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_SAG_REGISTER_TOURNAMENT_USER_BY_SCRIPTID; }
			const char *getMsgIdString() const override { return "MSG_SAG_REGISTER_TOURNAMENT_USER_BY_SCRIPTID"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_SAG_REGISTER_TOURNAMENT_USER_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_SAG_REGISTER_TOURNAMENT_USER_REPLY; }
			const char *getMsgIdString() const override { return "MSG_SAG_REGISTER_TOURNAMENT_USER_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct SagDataExCli
		{
			...
			SrvTime finished;
			INT32 levelMark;
			Atf::LAtfVector< SagWinnerInfo, 4 > winners;
	...
	namespace srv
	{
		struct SagTournFinishInfo
		{
			...
			INT32 buyIn;
			INT32 rake;
			Atf::LAtfVector< cli::SagWinnerInfo, 4 > winners;
