...
#ifndef ATF_PROTOCOL_DEFFILE_MLOBBY_ATF_H
#define ATF_PROTOCOL_DEFFILE_MLOBBY_ATF_H
...
namespace MLobby
{
	...
	namespace cli
	{
		...
		struct Protocol_MSG_MLOBBY_FIND_RINGGAMES : public Atf::MessageProtocol
		{
			...
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_RINGGAMES; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_RINGGAMES"; }
		...
		struct Protocol_MSG_MLOBBY_FIND_TOURNAMENTS : public Atf::MessageProtocol
		{
			//! M(14s411144444411144441 <FIXME_COND_IF> b <FIXME_COND_ELSE> 44 <FIXME_COND_ELSE> 444 <FIXME_COND_ELSE> b <FIXME_COND_ELSE> s4 <FIXME_COND_ELSE> 4 <FIXME_COND_ELSE> 4 <FIXME_COND_ELSE> 1 <FIXME_COND_ELSE> 1 <FIXME_COND_ENDIF> )4 - M(version,locale,country,siteId,game,hiLo,limit,minStake,maxStake,buyInMask,minBuyIn,maxBuyIn,maxPlayers,minSeated,minAvailable,speed,currencies,format,startingSoon,state,order <FIXME_COND_IF> ,realMoney <FIXME_COND_ELSE> ,minEntrants,maxEntrants <FIXME_COND_ELSE> ,zoomTournaments,multiplierPM,features <FIXME_COND_ELSE> ,tableStarters <FIXME_COND_ELSE> ,nameCriteria,specialSearchMode <FIXME_COND_ELSE> ,clientSortingSeed <FIXME_COND_ELSE> ,brandMask <FIXME_COND_ELSE> ,notUsed <FIXME_COND_ELSE> ,seatFindersAndBlitzes <FIXME_COND_ENDIF> ),maxItems
			Filter filter;
			UINT32 maxItems;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_TOURNAMENTS; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_TOURNAMENTS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_TABLE_OLD : public Atf::MessageProtocol
		{
			...
			Filter filter;
			Atf::LAtfVector< UINT32, 4 > excludedTables;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_TABLE_OLD; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_TABLE_OLD"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_TABLE64 : public Atf::MessageProtocol
		{
			...
			Filter filter;
			Atf::LAtfVector< UINT64, 4 > excludedTables;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_TABLE64; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_TABLE64"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_BLITZ : public Atf::MessageProtocol
		{
			//! M(14s411144444411144441 <FIXME_COND_IF> b <FIXME_COND_ELSE> 44 <FIXME_COND_ELSE> 444 <FIXME_COND_ELSE> b <FIXME_COND_ELSE> s4 <FIXME_COND_ELSE> 4 <FIXME_COND_ELSE> 4 <FIXME_COND_ELSE> 1 <FIXME_COND_ELSE> 1 <FIXME_COND_ENDIF> )4 - M(version,locale,country,siteId,game,hiLo,limit,minStake,maxStake,buyInMask,minBuyIn,maxBuyIn,maxPlayers,minSeated,minAvailable,speed,currencies,format,startingSoon,state,order <FIXME_COND_IF> ,realMoney <FIXME_COND_ELSE> ,minEntrants,maxEntrants <FIXME_COND_ELSE> ,zoomTournaments,multiplierPM,features <FIXME_COND_ELSE> ,tableStarters <FIXME_COND_ELSE> ,nameCriteria,specialSearchMode <FIXME_COND_ELSE> ,clientSortingSeed <FIXME_COND_ELSE> ,brandMask <FIXME_COND_ELSE> ,notUsed <FIXME_COND_ELSE> ,seatFindersAndBlitzes <FIXME_COND_ENDIF> ),maxItems
			Filter filter;
			UINT32 maxItems;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_BLITZ; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_BLITZ"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES : public Atf::MessageProtocol
		{
			...
			Filter filter;
			UINT32 maxItems;
			Atf::LAtfVector< UINT32, 4 > excludedFinders;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct TournSelectionFilter
		{
			...
			UINT32 tableSize;
			Atf::LAtfVector< PString , 4 > visibilityStrings;
			Atf::LAtfVector< PString, 4 > tournLobbies;
		...
		struct RingDynaData
		{
			...
			BYTE vpip;
			Atf::LAtfVector< FppFactorStruct, 4 > fppFactors;
		...
		{
			//! M(M(4sss411111441s42s444b4<s>4114b8444844s <FIXME>TableCommon::TableStakes</FIXME> 4<8>m)M(111421414<M(2444tm)>b)) - M(M(tableId32,name,server,serverObject,tableFlags,isOneOnOne,isPlayMoney,maxPlayers,game,isHiLo,loBet,hiBet,structure,specialName,visibilityMask,chatLang,currency,minChipsLimit,maxBuyIn,ante,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,cap,icon,filter,tableInstanceFlags,isTableStarter,tableFlags2,tableTypeId,scalePM,defaultBuyIn,tableId,brandMask,poolBlockMinHands,visibilityCriteria, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(numPlayers,wait,playersPerFlop,potSize,handsPerHour,publProp,averageStackSize,vpip,numFppFactors<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,isTableDealingCards))
		...
		struct Protocol_MSG_MLOBBY_FIND_RINGGAMES2 : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_RINGGAMES2; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_RINGGAMES2"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_RINGGAMES2_REPLY : public Atf::MessageProtocol
		{
			//! 44<M(M(4sss411111441s42s444b4<s>4114b8444844s <FIXME>TableCommon::TableStakes</FIXME> 4<8>m)M(111421414<M(2444tm)>b))> - totalItems,numTables<M(M(tableId32,name,server,serverObject,tableFlags,isOneOnOne,isPlayMoney,maxPlayers,game,isHiLo,loBet,hiBet,structure,specialName,visibilityMask,chatLang,currency,minChipsLimit,maxBuyIn,ante,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,cap,icon,filter,tableInstanceFlags,isTableStarter,tableFlags2,tableTypeId,scalePM,defaultBuyIn,tableId,brandMask,poolBlockMinHands,visibilityCriteria, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(numPlayers,wait,playersPerFlop,potSize,handsPerHour,publProp,averageStackSize,vpip,numFppFactors<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,isTableDealingCards))>
			UINT32 totalItems;
			Atf::LAtfVector< RingDataStruct, 4 > tables;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_RINGGAMES2_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_RINGGAMES2_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_TOURNAMENTS2 : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_TOURNAMENTS2; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_TOURNAMENTS2"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_TOURNAMENTS2_REPLY : public Atf::MessageProtocol
		{
			//! 44<M(M(4ssst44411ss14441114444t444b4<s>14tI2s44s241I1121bs4112sss88t4b <FIXME>TournClient::NStackTournInfoStruct</FIXME> 44s4141444sm)M(441414<M(2444tm)>44b4441))> - totalItems,numTourns<M(M(tournamentId,server,targetServer,hasSatellite,whenStart,buyIn,rake,fppBuyIn,isRestricted,isPwdProtected,name,admissionId,isPlayMoney,satelliteTarget,minPlayers,tournFlags,game,isHiLo,structure,tournMask,tournSites,whenStartInt,tournMask2,targetWhenStart,tournMask3,tournMask4,maxPerTable,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,hasDayTwoStart,dayTwoStartSec,dayTwoStart,shortText,chatLang,currency,tournFlagsServInt,knockout,satelliteTargetReference,satelliteTargetReferenceLock,maxPlayers,speedDisplay,nameSnG,step,timedTournType,timedTournTime,timedTournPayout,isFlightTourn,tournBrand,scalePM,progressiveKnockout,awardScheme,numReentries,internalReference,favReference,satelliteTargetName,admissionPrice,tournFlags2,regEndAbs,regEndAbsInt,doNotAllowToUnreg, <FIXME>nStackInfo</FIXME> ,tournMask5,tournMask6,satelliteTargetNameMTT,liveEventMask,timedTournPlayersPercent,dummy1,rmPmLobby,brandAccessMask,activeFlags,sngScriptId,customSpeedDisplayName,tournSitesEx),M(fakeStatus,entrants,publProp,prizePoolToPublish,prizePoolUnit,numHappyHoursMultipliers<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,goldenSnGMilestoneAwardStub,dummy1,goldenSnGEligibleStub,goldenSnGTotalAddonStub,prizePoolMoneyToPublish,timedTournPlayersThreshold,mixTournSatellite))>
			UINT32 totalItems;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_TOURNAMENTS2_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_TOURNAMENTS2_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES2 : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES2; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES2"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES2_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES2_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_SEATFINDERS_AND_BLITZES2_REPLY"; }
		...
		struct Protocol_MSG_MLOBBY_FIND_TABLE64_2 : public Atf::MessageProtocol
		{
			// M(1s44848844444b)44<8>4s - M(version,country,siteId,brandId,gameMask,buyInMask,minBuyIn,maxBuyIn,multiplierPM,currencyMask,sortOrder,maxPlayerMask,clientSortingSeed,standardFormatOnly),maxItems,numExcludedTables<excludedTables>,context,installId
			TableSelectionFilter filter;
			UINT32 maxItems;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_TABLE64_2; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_TABLE64_2"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_TABLE64_2_REPLY : public Atf::MessageProtocol
		{
			//! 44<M(M(4sss411111441s42s444b4<s>4114b8444844s <FIXME>TableCommon::TableStakes</FIXME> 4<8>m)M(111421414<M(2444tm)>b))> - totalItems,numTables<M(M(tableId32,name,server,serverObject,tableFlags,isOneOnOne,isPlayMoney,maxPlayers,game,isHiLo,loBet,hiBet,structure,specialName,visibilityMask,chatLang,currency,minChipsLimit,maxBuyIn,ante,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,cap,icon,filter,tableInstanceFlags,isTableStarter,tableFlags2,tableTypeId,scalePM,defaultBuyIn,tableId,brandMask,poolBlockMinHands,visibilityCriteria, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(numPlayers,wait,playersPerFlop,potSize,handsPerHour,publProp,averageStackSize,vpip,numFppFactors<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,isTableDealingCards))>
			UINT32 totalItems;
			Atf::LAtfVector< RingDataStruct, 4 > tables;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_TABLE64_2_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_TABLE64_2_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct ZoomDynaDataStruct
		{
			...
			Atf::LAtfVector< EarlyBirdMultiplier, 4 > earlyBirdMultipliers;	// PYR-114224, if client license has multiplier > 0 then early bird eligible
		...
		{
			//! M(M(411114444s4444sb4<s>1b4sss142b44s <FIXME>TableCommon::TableStakes</FIXME> m8)M(44441114<M(2444tm)>44<M(44)>)) - M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,isPlayMoney,isMorphLobby,scalePM,server,name,replayerInstance,isOneOnOne,tableFlags,chatLang,quickLobbyVisible,blitzFlags,brandMask,serverObj, <FIXME>tableStakes</FIXME> ,visibilityMaskEx,tableFlags2),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,publProp,avgPlayers,avgVpip,numFppFactors<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,earlyBirdMins,numEarlyBirdMultipliers<M(licenseId,multiplier)>))
		...
		struct Protocol_MSG_MLOBBY_FIND_MORPH_LOBBIES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_MORPH_LOBBIES; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_MORPH_LOBBIES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_MORPH_LOBBIES_REPLY : public Atf::MessageProtocol
		{
			//! 44<M(411114444s4444sb4<s>ss1b44<4>48b4444444 <FIXME>TableCommon::TableStakes</FIXME> 4<8>m)> - totalItems,numSf<M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,replayerAddress,replayerInstance,minPlayersPerTable,isPasswordProtected,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,flags,flags2,isPM,scalePM,handsPerHour,avgPotSize,avgStackSize,numPlayers,numTables,numFullTables, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx)>
			UINT32 totalItems;
			Atf::LAtfVector< SeatFinderStruct, 4 > sf;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_MORPH_LOBBIES_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_MORPH_LOBBIES_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_HYBRID_GAMES : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_HYBRID_GAMES; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_HYBRID_GAMES"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_HYBRID_GAMES_REPLY : public Atf::MessageProtocol
		{
			//! 44<M(M(411114444s4444sb4<s>ss1b44<4>48b4 <FIXME>TableCommon::TableStakes</FIXME> 4<8>m)M(444444))>4<M(M(411114444s4444sb4<s>1b4sss142b44s <FIXME>TableCommon::TableStakes</FIXME> m8)M(44441114<M(2444tm)>44<M(44)>))>4<M(M(41111414444s44b4<s>b444444<4>bb <FIXME>TableCommon::TableStakes</FIXME> 4<8>sm)M(44))>4<4> - totalItems,numSfs<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,replayerAddress,replayerInstance,minPlayersPerTable,isPasswordProtected,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,flags,flags2,isPM,scalePM, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,numTables,numFullTables))>,numBlitzes<M(M(id,game,structure,isHiLo,maxPlayersPerTable,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,visibilityMask,defaultBuyIn,specialName,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,isPlayMoney,isMorphLobby,scalePM,server,name,replayerInstance,isOneOnOne,tableFlags,chatLang,quickLobbyVisible,blitzFlags,brandMask,serverObj, <FIXME>tableStakes</FIXME> ,visibilityMaskEx,tableFlags2),M(handsPerHour,avgPotSize,avgStackSize,numPlayers,publProp,avgPlayers,avgVpip,numFppFactors<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,earlyBirdMins,numEarlyBirdMultipliers<M(licenseId,multiplier)>))>,numTableTypes<M(M(id,isPlayMoney,game,isHiLo,maxPlayers,visibilityMask,structure,loBet,hiBet,ante,cap,currency,minChipsLimit,maxBuyIn,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,visible,scalePM,defaultBuyIn,brandMask,seatFinderId,poolBlockMinHands,numPoolBlockTimePenalty<poolBlockTimePenalty>,isPasswordProtected,isMorphLobby, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,specialName,visibilityMaskEx),M(numPlayers,numTables))>,numGameOrder<gameOrder>
			UINT32 totalItems;
			Atf::LAtfVector< SeatFinderDataStruct, 4 > sfs;
			Atf::LAtfVector< ZoomDataStruct, 4 > blitzes;
			Atf::LAtfVector< TableTypeDataStruct, 4 > tableTypes;
			Atf::LAtfVector< UINT32, 4 > gameOrder;	// MobileHybridLobbyGameTypes
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_HYBRID_GAMES_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_HYBRID_GAMES_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_RING_GAME_BY_TYPE : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_RING_GAME_BY_TYPE; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_RING_GAME_BY_TYPE"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_MLOBBY_FIND_RING_GAME_BY_TYPE_REPLY : public Atf::MessageProtocol
		{
			//! 44<M(M(4sss411111441s42s444b4<s>4114b8444844s <FIXME>TableCommon::TableStakes</FIXME> 4<8>m)M(111421414<M(2444tm)>b))> - totalItems,numTables<M(M(tableId32,name,server,serverObject,tableFlags,isOneOnOne,isPlayMoney,maxPlayers,game,isHiLo,loBet,hiBet,structure,specialName,visibilityMask,chatLang,currency,minChipsLimit,maxBuyIn,ante,countryRestrictionInverted,numRestrictedCountries<restrictedCountries>,cap,icon,filter,tableInstanceFlags,isTableStarter,tableFlags2,tableTypeId,scalePM,defaultBuyIn,tableId,brandMask,poolBlockMinHands,visibilityCriteria, <FIXME>tableStakes</FIXME> ,numVariableAntes<variableAntes>,visibilityMaskEx),M(numPlayers,wait,playersPerFlop,potSize,handsPerHour,publProp,averageStackSize,vpip,numFppFactors<M(fppFactor,sites,gameCategory,number,endT,sitesEx)>,isTableDealingCards))>
			UINT32 totalItems;
			Atf::LAtfVector< RingDataStruct, 4 > tables;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_MLOBBY_FIND_RING_GAME_BY_TYPE_REPLY; }
			const char *getMsgIdString() const override { return "MSG_MLOBBY_FIND_RING_GAME_BY_TYPE_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
