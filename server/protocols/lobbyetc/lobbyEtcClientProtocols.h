...
#ifndef ATF_PROTOCOL_DEFFILE_LOBBYETCCLIENTPROTOCOLS_H
#define ATF_PROTOCOL_DEFFILE_LOBBYETCCLIENTPROTOCOLS_H
...
namespace LobbyEtcClient
{
	...
	namespace player
	{
		struct Protocol_MSG_LOBBYETC_GENERAL_CLIENT_ERROR_NOTIF : public Atf::MessageProtocol
		{
			...
			UINT32 getMsgId() const override { return MSG_LOBBYETC_GENERAL_CLIENT_ERROR_NOTIF; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_GENERAL_CLIENT_ERROR_NOTIF"; }
		...
		struct Protocol_MSG_LOBBYETC_GENERAL_CLIENT_ERROR_WITH_CLIENT_ID : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_GENERAL_CLIENT_ERROR_WITH_CLIENT_ID; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_GENERAL_CLIENT_ERROR_WITH_CLIENT_ID"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_RECONNECT : public Atf::MessageProtocol
		{
			// empty message
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_RECONNECT; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_RECONNECT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_NOTIF_GEOIP_RESULT : public Atf::MessageProtocol
		{
			// 4s - result,resultStr
			UINT32 result;
			PString resultStr;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_NOTIF_GEOIP_RESULT; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_NOTIF_GEOIP_RESULT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_GEOCOMPLY_LOCATE : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_GEOCOMPLY_LOCATE; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_GEOCOMPLY_LOCATE"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_START_MOBILE_VERIFICATION : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_START_MOBILE_VERIFICATION; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_START_MOBILE_VERIFICATION"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_NOTIF_MOBILE_REQUIRED_STATUS : public Atf::MessageProtocol
		{
			// 4s - status,statusStr
			UINT32 status;
			PString statusStr;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_NOTIF_MOBILE_REQUIRED_STATUS; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_NOTIF_MOBILE_REQUIRED_STATUS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_REQUEST_USER_LOCAID_CONSENT : public Atf::MessageProtocol
		{
			// empty message
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_REQUEST_USER_LOCAID_CONSENT; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_REQUEST_USER_LOCAID_CONSENT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct UnsolicitedNotification_Throwables
		{
			...
			Atf::LAtfVector< ThrowableElement, 4 > throwableEnablements;
		...
		struct Protocol_MSG_LOBBYETC_CLI_UNSOLICITED_NOTIFICATION : public Atf::MessageProtocol
		{
			// 4M() - notifType,M()
			UINT32 notifType;	// enum UnsolicitedNotificationType in LobbyEtc.h
			Atf::CopyableMsgBody notifMsg;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_UNSOLICITED_NOTIFICATION; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_UNSOLICITED_NOTIFICATION"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		// PYR-106819
		struct Protocol_MSG_LOBBYETC_CLI_MG_SIDEBET_HISTORY_AUDIT : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_MG_SIDEBET_HISTORY_AUDIT; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_MG_SIDEBET_HISTORY_AUDIT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_MG_SIDEBET_HISTORY_AUDIT_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_MG_SIDEBET_HISTORY_AUDIT_REPLY; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_MG_SIDEBET_HISTORY_AUDIT_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_OUTBOUND_BOLDCHAT_NOTIFICATION : public Atf::MessageProtocol
		{
			// 1 - boldChatType
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_OUTBOUND_BOLDCHAT_NOTIFICATION; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_OUTBOUND_BOLDCHAT_NOTIFICATION"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	namespace MiniGameTickets
	{
		...
		struct Protocol_MSG_LOBBYETC_GET_TICKETS_WITH_TYPE : public Atf::MessageProtocol
		{
			// 8 - requestId
			INT64 requestId;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_GET_TICKETS_WITH_TYPE; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_GET_TICKETS_WITH_TYPE"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_GET_TICKETS_WITH_TYPE_REPLY : public Atf::MessageProtocol
		{
			...
			Atf::LAtfVector< GameTicketWithTypeAndMiniGameData , 4 > ticketsWithMinigames;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_GET_TICKETS_WITH_TYPE_REPLY; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_GET_TICKETS_WITH_TYPE_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct FixedPrizeWonAttributes
		{
			...
			Atf::LAtfVector< Prize , 4 > prizes;
			Atf::LAtfVector< Winner , 4 > winners;
		...
		struct MyStarsData
		{
			...
			PString type;
			PString state;	//
			Atf::LAtfVector< FixedPrizeTicketNotifMsg , 4 > tickets;	// aggergated
			Atf::LAtfVector< FixedPrizeWonNotifMsg , 4 > wins;	// all wins
			Atf::LAtfVector< FixedPrizeLostNotifMsg , 4 > losts;	// all losts
		...
		// PYR-123376
		struct Protocol_MSG_LOBBYETC_CLI_GET_MG_MY_STARS_DATA : public Atf::MessageProtocol
		{
			// empty
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_GET_MG_MY_STARS_DATA; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_GET_MG_MY_STARS_DATA"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		// PYR-123376
		struct Protocol_MSG_LOBBYETC_CLI_GET_MG_MY_STARS_DATA_REPLY : public Atf::MessageProtocol
		{
			// s - json
			PString json;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_GET_MG_MY_STARS_DATA_REPLY; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_GET_MG_MY_STARS_DATA_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	namespace ImageGallery
	{
		...
		struct Category
		{
			...
			PString catName;
			Atf::LAtfVector< UINT32, 4 > imageIds;
			Atf::LAtfVector< SubCategory, 4 > subcategories;
		...
		struct Protocol_MSG_LOBBYETC_CLI_GET_IMAGE_GALLERY_REPLY : public Atf::MessageProtocol
		{
			...
			Atf::LAtfVector< Image, 4 > images;
			Atf::LAtfVector< Category, 4 > categories;
	...
	namespace Twitch
	{
		...
		struct Protocol_MSG_LOBBYETC_CLI_CHECK_TWITCH_CONNECTION_STATUS : public Atf::MessageProtocol
		{
			// empty message
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_CHECK_TWITCH_CONNECTION_STATUS; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_CHECK_TWITCH_CONNECTION_STATUS"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		};
		struct Protocol_MSG_LOBBYETC_CLI_CHECK_TWITCH_CONNECTION_STATUS_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_CHECK_TWITCH_CONNECTION_STATUS_REPLY; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_CHECK_TWITCH_CONNECTION_STATUS_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_TWITCH_CONNECT : public Atf::MessageProtocol
		{
			// s - authorizationCode
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_TWITCH_CONNECT; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_TWITCH_CONNECT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_TWITCH_CONNECT_REPLY : public Atf::MessageProtocol
		{
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_TWITCH_CONNECT_REPLY; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_TWITCH_CONNECT_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_TWITCH_DISCONNECT : public Atf::MessageProtocol
		{
			// empty message
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_TWITCH_DISCONNECT; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_TWITCH_DISCONNECT"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		...
		struct Protocol_MSG_LOBBYETC_CLI_TWITCH_DISCONNECT_REPLY : public Atf::MessageProtocol
		{
			// 2[s] - errCode[errString]
			INT16 errCode;
			...
			void parseMsg(CommMsgParser& _parser) override;
			void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
			UINT32 getMsgId() const override { return MSG_LOBBYETC_CLI_TWITCH_DISCONNECT_REPLY; }
			const char *getMsgIdString() const override { return "MSG_LOBBYETC_CLI_TWITCH_DISCONNECT_REPLY"; }
			const char *asJSONString(PString& _buf) const override;
			void loadFromJSONString(const PString& _jsonString) override;
			static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
			static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
