...
#ifndef ATF_PROTOCOL_DEFFILE_CROSSGAMEBUTTONSSERVERPROT_H
#define ATF_PROTOCOL_DEFFILE_CROSSGAMEBUTTONSSERVERPROT_H
...
namespace CrossGameLinkServer
{
	...
	struct Protocol_CRM_Q_GET_CROSSLINK_BUTTONS : public Atf::MessageProtocol
	{
		...
		UINT32 getMsgId() const override { return CRM_Q_GET_CROSSLINK_BUTTONS; }
		const char *getMsgIdString() const override { return "CRM_Q_GET_CROSSLINK_BUTTONS"; }
	...
	struct Protocol_CRM_A_GET_CROSSLINK_BUTTONS : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return CRM_A_GET_CROSSLINK_BUTTONS; }
		const char *getMsgIdString() const override { return "CRM_A_GET_CROSSLINK_BUTTONS"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MSG_LOBBYETC_CROSSLINK_BUTTONS_CREATE : public Atf::MessageProtocol
	{
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MSG_LOBBYETC_CROSSLINK_BUTTONS_CREATE; }
		const char *getMsgIdString() const override { return "MSG_LOBBYETC_CROSSLINK_BUTTONS_CREATE"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_MSG_LOBBYETC_CROSSLINK_BUTTONS_CREATE_REPLY : public Atf::MessageProtocol
	{
		// 2[s] - errCode[errStr]
		INT16 errCode;
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return MSG_LOBBYETC_CROSSLINK_BUTTONS_CREATE_REPLY; }
		const char *getMsgIdString() const override { return "MSG_LOBBYETC_CROSSLINK_BUTTONS_CREATE_REPLY"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_CRM_Q_CREATE_CROSSLINK_BUTTONS : public Atf::MessageProtocol
	{
		//! 44< <FIXME>CrossGameLinkCommon::CrossGameLinkButtonData</FIXME> > - adminIntId,numButtons< <FIXME>CrossGameLinkCommon::CrossGameLinkButtonData</FIXME> >
		UINT32 adminIntId;
		Atf::LAtfVector< CrossGameLinkCommon::CrossGameLinkButtonData, 4 > buttons;
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return CRM_Q_CREATE_CROSSLINK_BUTTONS; }
		const char *getMsgIdString() const override { return "CRM_Q_CREATE_CROSSLINK_BUTTONS"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
	...
	struct Protocol_CRM_A_CREATE_CROSSLINK_BUTTONS : public Atf::MessageProtocol
	{
		// 2[s] - errCode[errStr]
		INT16 errCode;
		...
		void parseMsg(CommMsgParser& _parser) override;
		void composeMsg(CommMsgBody& _body, bool _ignoreJSON = COMPOSEMSG_IGNORE_JSON_DEFAULT) const override;
		UINT32 getMsgId() const override { return CRM_A_CREATE_CROSSLINK_BUTTONS; }
		const char *getMsgIdString() const override { return "CRM_A_CREATE_CROSSLINK_BUTTONS"; }
		const char *asJSONString(PString& _buf) const override;
		void loadFromJSONString(const PString& _jsonString) override;
		static void validateJSONString(const PString& _jsonString, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
		static void validateMsg(CommMsgParser& _parser, const AtfMsgChecker* _checker, PString& _fieldsWithUnparsedContent);
