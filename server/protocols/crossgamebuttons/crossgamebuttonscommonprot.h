...
#ifndef ATF_PROTOCOL_DEFFILE_CROSSGAMEBUTTONSCOMMONPROT_H
#define ATF_PROTOCOL_DEFFILE_CROSSGAMEBUTTONSCOMMONPROT_H
...
{	//------------------------------------------------------------------------------
	...
	struct CrossGameLinkButtonData
	{
		...
		Atf::LAtfVector< CrossGameLinkButtonCriteria, 4 > userCriteria;
		Atf::LAtfVector< CrossGameLinkButtonCriteria, 4 > gameCriteria;
