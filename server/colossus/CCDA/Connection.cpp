...
GenericSrvConnection::GenericSrvConnection(ColCdaServerObject& obj_, ServerConnectionType connectionType_)
...
GenericPrivilegedSrvConnection::GenericPrivilegedSrvConnection(ColCdaServerObject& obj_, ServerConnectionType connectionType_) :
...
AdminSrvConnection::AdminSrvConnection(ColCdaServerObject& obj_) :
...
void AdminSrvConnection::getUserAuth( const char* guardType, const char* user, CommMsgBody& /*clientExtra*/, CommMsgBody& authBody )
{
	...
	obj.postToLogin(DBM_Q_USER_AUTH, request, 
		new AdminAuthAsyncCall(obj, &ColCdaServerObject::receiveAdminAuth, this->id()));
}

///////////////////////////////////////////////////////////////////////////////

TrustedAdminSrvConnection::TrustedAdminSrvConnection(ColCdaServerObject& obj_) :
