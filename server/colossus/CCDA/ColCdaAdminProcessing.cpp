...
void ColCdaServerObject::processAdminMessage(UINT32 msgId, const CommMsgBody& body, GenericSrvConnection* conn)
{
...
void ColCdaServerObject::processTrustedAdminMessage(UINT32 msgId, const CommMsgBody& body, GenericSrvConnection* conn)
{
...
void ColCdaServerObject::processKillServer(const char* adminId)
{
...
void ColCdaServerObject::processRereadSettings(const char* adminId, CommMsgBody& reply)
{
...
void ColCdaServerObject::receiveAdminAuth(UINT32 /*replyId*/, CommMsgParser& parser, AdminAuthAsyncCall& callState)
{
	INT16 errCode;
...
bool ColCdaServerObject::checkAdminRight(const char* right, const GenericPrivilegedSrvConnection* pConn, CommMsgBody& reply)
{
