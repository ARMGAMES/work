...
{
	TrustedAdmin = 1,
	SomeTypeDbm,												// any descriptive enum for connection type - OlapMd, Colossus, etc...
};
...
//////////////////////////////////////////////////////////////////////////////////
class PROJECTServerObject : public DbmServerObjectCommon
{
...
private:
	void processServerDbmMessage( UINT32 msgId, const CommMsgBody & body, PROJECTServerConnection* conn );
