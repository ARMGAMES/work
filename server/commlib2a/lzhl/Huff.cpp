...
UINT32 _randomWrite = 1;
UINT32 _randomRead = 1;
HuffStat::HuffStat()
{
...
static inline int cmpHuffStatTmpStruct( const HuffStatTmpStruct& a, const HuffStatTmpStruct& b )
{
	int cmp = b.n - a.n;
...
const LZHLEncoderStat::Symbol LZHLEncoderStat::symbolTable0[ NHUFFSYMBOLS ]
=  {
#include "Henc.tbl"
};
...
#error
	...
	const DispItem* item = &_dispTable[ disp >> (LZBUFBITS - 7) ];
...
const LZHLDecoderStat::Group LZHLDecoderStat::groupTable0[ 16 ]
=  {
#include "Hdec_g.tbl"
};

const HUFFINT LZHLDecoderStat::symbolTable0[ NHUFFSYMBOLS ]
=  {
#include "Hdec_s.tbl"
};
...
LZHLDecompressor::LZHLDecompressor(CommStreamEncryption * encryption_)
{
