...
/* static */ CommServerNullGuardFactory SrvTemplateDbmServerObject::guardFactory;
/* static */ CommServerPlainTextPasswordSidGuardFactory SrvTemplateDbmServerObject::authGuardFactory;
/* static */ CommClientNullGuardFactory SrvTemplateDbmServerObject::clientNullGuardFactory;

////////////////////////////////////////////////////////////////////////////////

SrvTemplateDbmServerObject::SrvTemplateDbmServerObject(_CommInterface& inter) : 
...
SrvTemplateDbmServerObject::~SrvTemplateDbmServerObject()
{
	if (heLogger)
	{
		stopHeLogger();
...
bool SrvTemplateDbmServerObject::registerAllFactories() // override
{
...
void SrvTemplateDbmServerObject::init(CommMsgBody& initMsg)
{
...
void SrvTemplateDbmServerObject::dynamicInit()
{
	PLog("dynamicInit");
...
void SrvTemplateDbmServerObject::reconnect(GenericOutgoingConnection& conn, const char* const serverName, const char* const serverObject, const char* const serverConnectionType)
{
...
void SrvTemplateDbmServerObject::startup()
{
	if (dumpFile.length())
	{
		try
...
/*virtual*/ void SrvTemplateDbmServerObject::shutdown() // override
{
	if (dumpFile.length())
	{
		try
...
void SrvTemplateDbmServerObject::postReply(GenericSrvConnection* pConn, UINT32 msgId, CommMsgBody& body)
{
	if (pConn)
	{
...
void SrvTemplateDbmServerObject::setReply(CommMsgBody& reply, INT16 errCode, const char* errDesc /*= ""*/)
{
...
void SrvTemplateDbmServerObject::replyMsg(UINT32 connId, UINT32 msgId, CommMsgBody& body)
{
	if (!connId)
	{
...
void SrvTemplateDbmServerObject::processCallback(UINT32 reqId, UINT32 msgId, const CommMsgBody& body, CommClientGConnection::AsyncCall* pCall)
{
...
void SrvTemplateDbmServerObject::processCommonServerMessage(UINT32 msgId, const CommMsgBody& body, ServerConnectionType connType, GenericSrvConnection* conn)
{
...
void SrvTemplateDbmServerObject::processExampleSrvMessage(UINT32 msgId, const CommMsgBody & body, GenericSrvConnection* conn)
{
	CommMsgParser parser(body);
	switch (msgId)
	{
...
void SrvTemplateDbmServerObject::startHeLogger(const char * strServerAddress, const char * strStationName )
{
	PLog(__FUNCTION__);
...
void SrvTemplateDbmServerObject::stopHeLogger()
{
	PLog(__FUNCTION__);
...
void SrvTemplateDbmServerObject::reportPerformance()
{
	PTRACE(__FUNCTION__);
...
void SrvTemplateDbmServerObject::processTimerMessage( UINT32 /*handle*/, UINT32 msgId, CommMsgBody& body )
{
	HiresCounter counter;
