...
void SrvTemplateDbmServerObject::processAdminMessage(UINT32 msgId, const CommMsgBody& body, GenericSrvConnection* conn)
{
...
void SrvTemplateDbmServerObject::processTrustedAdminMessage(UINT32 msgId, const CommMsgBody& body, GenericSrvConnection* conn)
{
...
void SrvTemplateDbmServerObject::processKillServer(const char* adminId)
{
...
void SrvTemplateDbmServerObject::processRereadSettings(const char* adminId, CommMsgBody& reply)
{
...
void SrvTemplateDbmServerObject::receiveAdminAuth(UINT32 /*replyId*/, CommMsgParser& parser, AdminAuthAsyncCall& callState)
{
	INT16 errCode;
...
bool SrvTemplateDbmServerObject::checkAdminRight(const char* right, const GenericPrivilegedSrvConnection* pConn, CommMsgBody& reply)
{
