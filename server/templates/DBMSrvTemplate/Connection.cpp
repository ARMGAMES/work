...
GenericSrvConnection::GenericSrvConnection(SrvTemplateDbmServerObject& obj_, ServerConnectionType connectionType_)
...
GenericPrivilegedSrvConnection::GenericPrivilegedSrvConnection(SrvTemplateDbmServerObject& obj_, ServerConnectionType connectionType_) :
...
AdminSrvConnection::AdminSrvConnection(SrvTemplateDbmServerObject& obj_) :
...
void AdminSrvConnection::getUserAuth( const char* guardType, const char* user, CommMsgBody& /*clientExtra*/, CommMsgBody& authBody )
{
	...
	obj.postToLogin(DBM_Q_USER_AUTH, request, 
		new AdminAuthAsyncCall(obj, &SrvTemplateDbmServerObject::receiveAdminAuth, this->id()));
}

///////////////////////////////////////////////////////////////////////////////

TrustedAdminSrvConnection::TrustedAdminSrvConnection(SrvTemplateDbmServerObject& obj_) :
