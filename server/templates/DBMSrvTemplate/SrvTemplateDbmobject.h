...
#include "SrvTemplateCacheTypes.h"
#include "SrvTemplateDbmshared.h"
...
// server config files
#define SERVER_CONFIG_FILE "SrvTemplateDbm.ini"

using AdminAuthAsyncCall = NoReplyAsyncCall<SrvTemplateDbmServerObject, UINT32 /* connId */>;

//////////////////////////////////////////////////////////////////////////////////
class SrvTemplateDbmServerObject : public DbmServerObjectCommon
{
private:
	...
	SrvTemplateDbmManager				dbManager;
...
public:
	SrvTemplateDbmServerObject( _CommInterface& inter );
	~SrvTemplateDbmServerObject();
...
class SrvTemplateDbmServerObjectFactory : public CommServerObjectFactory
{
public:
	/* new */ CommServerObject* createServerObject( _CommInterface& inter ) const override
	{
		return new SrvTemplateDbmServerObject( inter );
	}
};
