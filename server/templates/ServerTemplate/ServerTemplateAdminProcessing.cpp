...
void ServerTemplateServerObject::processAdminMessage(UINT32 msgId, const CommMsgBody& body, GenericSrvConnection* conn)
{
...
void ServerTemplateServerObject::processTrustedAdminMessage(UINT32 msgId, const CommMsgBody& body, GenericSrvConnection* conn)
{
...
void ServerTemplateServerObject::processKillServer(const char* adminId)
{
...
void ServerTemplateServerObject::processRereadSettings(const char* adminId, CommMsgBody& reply)
{
...
void ServerTemplateServerObject::receiveAdminAuth(UINT32 /*replyId*/, CommMsgParser& parser, AdminAuthAsyncCall& callState)
{
	INT16 errCode;
...
bool ServerTemplateServerObject::checkAdminRight(const char* right, const GenericPrivilegedSrvConnection* pConn, CommMsgBody& reply)
{
