...
GenericSrvConnection::GenericSrvConnection(ServerTemplateServerObject& obj_, ServerConnectionType connectionType_)
...
GenericPrivilegedSrvConnection::GenericPrivilegedSrvConnection(ServerTemplateServerObject& obj_, ServerConnectionType connectionType_) :
...
AdminSrvConnection::AdminSrvConnection(ServerTemplateServerObject& obj_) :
...
void AdminSrvConnection::getUserAuth( const char* guardType, const char* user, CommMsgBody& /*clientExtra*/, CommMsgBody& authBody )
{
	...
	obj.postToLogin(DBM_Q_USER_AUTH, request, 
		new AdminAuthAsyncCall(obj, &ServerTemplateServerObject::receiveAdminAuth, this->id()));
}

///////////////////////////////////////////////////////////////////////////////

TrustedAdminSrvConnection::TrustedAdminSrvConnection(ServerTemplateServerObject& obj_) :
