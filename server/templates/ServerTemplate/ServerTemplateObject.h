...
#include "ServerTemplateCacheTypes.h"
#include "ServerTemplateshared.h"
...
// server config files
#define SERVER_CONFIG_FILE "ServerTemplate.ini"

using AdminAuthAsyncCall = NoReplyAsyncCall<ServerTemplateServerObject, UINT32 /* connId */>;

//////////////////////////////////////////////////////////////////////////////////
class ServerTemplateServerObject : public CommServerObject
{
private:
...
public:
	explicit ServerTemplateServerObject(_CommInterface& inter);
	~ServerTemplateServerObject();
...
class ServerTemplateServerObjectFactory : public CommServerObjectFactory
{
public:
	CommServerObject* createServerObject(_CommInterface& inter) const override
	{
		return new ServerTemplateServerObject(inter);
	}
};
