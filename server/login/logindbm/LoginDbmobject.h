...
#include "LoginCacheTypes.h"
#include "LoginDbmshared.h"
...
// server config files
#define SERVER_CONFIG_FILE "LoginDbm.ini"

using AdminAuthAsyncCall = NoReplyAsyncCall<LoginDbmServerObject, UINT32 /* connId */>;

//////////////////////////////////////////////////////////////////////////////////
class LoginDbmServerObject : public DbmServerObjectCommon
{
private:
...
public:
	LoginDbmServerObject( _CommInterface& inter );
	~LoginDbmServerObject();
...
class LoginDbmServerObjectFactory : public CommServerObjectFactory
{
public:
	/* new */ CommServerObject* createServerObject( _CommInterface& inter ) const override
	{
		return new LoginDbmServerObject( inter );
	}
};
