...
{
protected:
	LoginDbmServerObject& obj;
	ServerConnectionType connectionType;

public:
	GenericSrvConnection(LoginDbmServerObject& obj_, ServerConnectionType connectionType_);
...
{
protected:
	GenericPrivilegedSrvConnection(LoginDbmServerObject& obj_, ServerConnectionType connectionType_);
...
{
public:
	explicit AdminSrvConnection(LoginDbmServerObject& obj_);
...
{
public:
	explicit TrustedAdminSrvConnection(LoginDbmServerObject& obj_);
...
{
public:
	GenericServerConnFactory(LoginDbmServerObject& obj_, CommServerGuardFactory& guardFactory, ServerConnectionType connectionType_ )
...
{
public:
	AdminServerConnFactory(LoginDbmServerObject& obj_, CommServerGuardFactory& guardFactory )
...
{
public:
	TrustedAdminServerConnFactory(LoginDbmServerObject& obj_, CommServerGuardFactory& guardFactory )
		: CommServerConnectionFactory( guardFactory ), obj(obj_)
	{
		++normalPriority;
		++authPriority;
...
{
public:
	GenericOutgoingConnection(LoginDbmServerObject& obj_, CommClientGuardFactory& guardFactory, const char* name_, char symbol_)
