...
GenericSrvConnection::GenericSrvConnection(LoginDbmServerObject& obj_, ServerConnectionType connectionType_)
...
GenericPrivilegedSrvConnection::GenericPrivilegedSrvConnection(LoginDbmServerObject& obj_, ServerConnectionType connectionType_) :
...
AdminSrvConnection::AdminSrvConnection(LoginDbmServerObject& obj_) :
...
TrustedAdminSrvConnection::TrustedAdminSrvConnection(LoginDbmServerObject& obj_) :
