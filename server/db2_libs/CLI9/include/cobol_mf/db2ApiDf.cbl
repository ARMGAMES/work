      ...
      * Indicates log extent is undefined.
       78  DB2LOG-EXTENT-UNDEFINED   value    -1.
      *************************************************************************
      ...
      * Max size of db2PartLoadIn - iFileTransferCmd
       78  DB2LOAD-MAX-FILETRANSFERCMD-SZ VALUE 260.
      * Max size of db2LoadUserExit - iSourceUserExitCmd
       78  DB2LOAD-MAX-USEREXITCMD-SZ VALUE   260.
      ...
      * NOTE:  These lengths do not include NULL terminators
       ...
       78  DB2HISTORY-TABLE-QUAL-SZ  VALUE    128.
      ...
      * Structure db2LSN
           05 DB2-O-LAST-LSN.
               10 DB2-LSN-U64        PIC 9(18) COMP-5 VALUE 0.
      * Structure db2HistoryEID
           05 DB2-O-EID.
      ...
      * 
      **************************************************************************
       01 DB2HISTORY-GET-ENTRY-STRUCT980.
      * History entry data area
           05 DB2-PIO-HIST-DATA      USAGE IS POINTER.
      * History scan handle
           05 DB2-I-HANDLE           PIC 9(4) COMP-5.
      ...
      * History Operations
       ...
       78  DB2HIST-OP-MERGEBACKUP    value    "M".
      ...
      * History Objects
       ...
       78  DB2HISTORY-GRAN-RPTABLE   value    "R".
      ...
      * Backup/Restore Optypes
       ...
       78  DB2HISTORY-OPTYPE-REBUILD value    "R".
      ...
      * Archive Log Optypes
       78  DB2HISTORY-OPTYPE-ARCHIVE-CMD value "N".
      ...
      * History Entry Status Flags
       ...
       78  DB2HISTORY-STATUS-DO-NOT-DEL value "X".
      ...
      * Define for reorg reclaim extents
