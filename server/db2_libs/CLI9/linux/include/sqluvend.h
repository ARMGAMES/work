...
/*** High-Level image name fragments.***/
#define SQLUV_HL_DBPART    "DBPART"
#define SQLUV_HL_DBPART_SZ 6
#define SQLUV_HL_NODE      "NODE"
#define SQLUV_HL_NODE_SZ   4
...
** |-----------------|--------------------|----------------------------------|
** |dbPartition      |db2NodeType         |DB partition number.              |
** |-----------------|--------------------|----------------------------------|
**
...
typedef struct DB2_info
{
  ...
  db2NodeType dbPartition;     /* DB partition number               */
} DB2_info ;
