...
#define db2Version1058   SQL_REL10508                /* Version 10.5.0.8      */
...
** 
** piObjKeyInput. The object key to be cataloged.
** 
** iRecovDefault
** Input. A TRUE or FALSE flag that indicates whether the alias is to be
**  set as the recovery default or not.
** 
*******************************************************************************/
typedef SQL_STRUCTURE db2CatRemStgStruct
{
             ...
             db2Uint16     iRecovDefault;    /* Input: set recovery default   */
} db2CatRemStgStruct;
...
**  be cleared of the recovery default or not.
** 
*******************************************************************************/
typedef SQL_STRUCTURE db2UncatRemStgStruct
{
             char          *piAliasName;     /* Input: alias name             */
             db2Uint16     iRecovDefault;    /* Input: clear default          */
...
** The container name.
** 
** objKeyThe object key.
** 
** recovDefault
** A TRUE or FALSE flag that indicates whether the current entry is
**  a recovery default or not.
** 
*******************************************************************************/
typedef SQL_STRUCTURE db2RemStgEntry
{
             ...
             db2Uint16     recovDefault;     /* recovery default              */
} db2RemStgEntry;
