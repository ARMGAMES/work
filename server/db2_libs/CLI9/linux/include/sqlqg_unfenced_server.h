...
#define SQLQG_SERVER_CONSISTENT       0x0040 // to identify a server
...
public:
  ...
  // get the trusted context user
  virtual Sqlqg_Return_Code find_current_tc_originator (UnfencedRemote_User** a_user,
                                                        bool*                 a_is_new_catalog_info,
  ...
  sqlint32  get_requests_io_block_buf (void);
  ...
  */
  ...
  /**
   ...
   \return 0 or DB2/WSII error code
  */
  sqlint32 create_set_my_server_attributes (Server_Info* a_server_info);

  virtual Sint count_row_num(struct sqlri_rcollist *a_runtime_input_column_list, Sint *a_number_of_rows);
...
protected:
  ...
  */
  ...
  sqlint32  m_requests_io_block_buf;          // DB2_REQUESTS_IO_BLOCK_BUF
...
inline sqlint32
UnfencedServer::get_requests_io_block_buf (void)
{
  return m_requests_io_block_buf;
}
