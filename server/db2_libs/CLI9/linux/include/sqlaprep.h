...
#define SQLA_OPTPROFILE_OPT    SQL_OPTPROFILE_OPT /* The optimization         */
                                                 /* profile name              */
#define SQLA_FEDASYNC_OPT      SQL_FEDASYNC_OPT  /* Specifies whether or not  */
                                                 /* the query is executed     */
                                                 /* using asynchrony          */
#define SQLA_CONCURRENTAR_OPT  SQL_CONCURRENTAR_OPT /* Specifies to use       */
                                                 /* currently committed data  */
                                                 /* or to wait for results    */
#define SQLA_APREUSE_OPT       SQL_APREUSE_OPT   /* Specifies whether or not  */
                                                 /* the compiler should use   */
                                                 /* an access plan which is   */
                                                 /* similar to the one        */
                                                 /* currently stored in the   */
                                                 /* package if it already     */
                                                 /* exists - bind, rebind     */
                                                 /* and precompile option     */
#define SQLA_EXTENDEDINDICATOR_OPT SQL_EXTENDEDINDICATOR_OPT /* Specifies     */
                                                 /* extended indicator        */
                                                 /* support                   */
#define SQLA_COMPT_MODE_OPT    SQL_COMPT_MODE_OPT /* Specifies whether or     */
                                                 /* not the new compatible    */
                                                 /* mode syntax is supported  */
#define SQLA_BUSTIMESENSITIVE_OPT SQL_BUSTIMESENSITIVE_OPT /* Specifies       */
                                                 /* whether or not this       */
                                                 /* statement will replace    */
                                                 /* temporal table queries    */
                                                 /* with an AS OF value       */
                                                 /* equal to special          */
                                                 /* register CURRENT          */
                                                 /* TEMPORAL BUSINESS_TIME    */
#define SQLA_SYSTIMESENSITIVE_OPT SQL_SYSTIMESENSITIVE_OPT /* Specifies       */
                                                 /* whether or not this       */
                                                 /* statement will replace    */
                                                 /* temporal table queries    */
                                                 /* with an AS OF value       */
...
#define SQLA_UNSAFENULL_OPT    SQL_UNSAFENULL_OPT /* Specifies whether the    */
                                                 /* UNSAFENULL is handled or  */
                                                 /* not                       */
#define SQLA_STRING_UNITS_OPT  SQL_STRING_UNITS_OPT /* Specifies whether the  */
                                                 /* default STRING_UNITS for  */
                                                 /* character-based type      */
                                                 /* specifications in         */
                                                 /* statements compiled       */
                                                 /* during BIND will be       */
                                                 /* SYSTEM or CODEUNITS32 -   */
                                                 /* bind and precompile       */
                                                 /* option.                   */
...
#define SQLA_EXPLAIN_REOPT     SQL_EXPLAIN_REOPT /* EXPLAIN output produced   */
                                                 ...
                                                 /* statements.               */
#define SQLA_EXPLAIN_ONLY      SQL_EXPLAIN_ONLY  /* EXPLAIN output produced.  */
...
#define SQLA_STATICRO_INSENSITIVE SQL_STATICRO_INSENSITIVE /* Any static      */
                                                 /* cursor that does not      */
                                                 /* contain the FOR UPDATE    */
                                                 /* or FOR DELETE clause      */
                                                 /* will be considered READ   */
                                                 /* ONLY. and insensitive     */
/* Values used for option[n].val when option[n].type is SQLA_FEDASYNC_OPT.    */
#define SQLA_FEDASYNC_MIN      SQL_FEDASYNC_MIN  /* No asynchrony is used     */
#define SQLA_FEDASYNC_ANY      SQL_FEDASYNC_ANY  /* Allows the optimizer to   */
                                                 /* determine the level of    */
                                                 /* asynchrony.               */
#define SQLA_FEDASYNC_MAX      SQL_FEDASYNC_MAX  /* Maximum value             */

/* Values used for option[n].val when option[n].type is SQLA_STRING_UNITS     */
/* OPT                                                                        */
#define SQLA_STRING_UNITS_SYS  SQL_STRING_UNITS_SYS /* The default STRING     */
                                                 /* UNITS for character       */
                                                 /* based type                */
                                                 /* specifications in the     */
                                                 /* statement will be         */
                                                 /* SYSTEM.                   */
#define SQLA_STRING_UNITS_CU32 SQL_STRING_UNITS_CU32 /* The default STRING    */
                                                 /* UNITS for character       */
                                                 /* based type                */
                                                 /* specifications in the     */
                                                 /* statement will be         */
...
#define SQLA_ALLOCATE_CURSOR             24 /* Generate code for ALLOCATE     */
                                            /* CURSOR                         */
#define SQLA_NEXT_FUNCTION_STMT          25 /* Request the outer precompiler  */
                                            /* to get the next function SQL   */
                                            /* statement                      */
...
#define SQL_PID_LENGTH_V610    40      /* length of precompiler pid for V6.1  */
                                       /* or earlier                          */
#define SQL_PID_LENGTH_v71     162     /* length of precompiler pid for V7.1  */
                                       /* to V9                               */
#define SQL_PID_LENGTH         292     /* length of precompiler pid           */
#define SQL_MIN_PID_LENGTH     164     /* minimum length of precompiler pid   */
...
#define SQLA_RC_IND_ARR_SMALL          -20549
#define SQLA_RC_MIN_ROW_FETCH          20537
#define SQLA_RC_COMPAT_MODE_NOT_SET    -1696
#define SQLA_RC_SIND_UNEQUAL_MEMBERS   -1697
#define SQLA_RC_UNSUPPORTED_HVAR_TYPE  -1727
...
SQL_STRUCTURE sqla_program_id_v71
{
        unsigned short    length;
        unsigned short    rp_rel_num;
        unsigned short    db_rel_num;
