...
struct SQLO_MEM_POOL;

// Simulation Tool Constants
#define SQLQG_SIM_CONFIG_NUM_COLS  256   // Max characters allowed in any
                                         // config-file entry
#define SQLQG_SIM_CONFIG_NUM_LINES 100   // Max lines allowed in config-file

// XML data handling constants
#define SQLQG_MAX_REMOTE_ENCODING_NAME_LEN 32  // Max encoding string length
...
#if 0
#include "sqlriSectionDJX.h" // SQLRI_QG_ROW_DONE
// Don't modify the below lines!
// Because they are rolling update sensitive, pls modify the SQLRI_* flags in
// sqlriSectionDJX.h directly
#define    SQLQG_NON_LOB         SQLRI_QG_NON_LOB
#define    SQLQG_LOB_INIT        SQLRI_QG_LOB_INIT
#define    SQLQG_LOB_NEW         SQLRI_QG_LOB_NEW
#define    SQLQG_LOB_MORE        SQLRI_QG_LOB_MORE
#define    SQLQG_LOB_LAST        SQLRI_QG_LOB_LAST
#define    SQLQG_ROW_DONE        SQLRI_QG_ROW_DONE
#define    SQLQG_XML_ILLFORMED   SQLRI_QG_XML_ILLFORMED
#define    SQLQG_LOB_UNUSED      SQLRI_QG_LOB_UNUSED

#define    SQLQG_LOB_FLAG   SQLRI_QG_LOB_FLAG
#endif
...
///////////////////////////////////////////////////////////////////////////////
// is_valid_umplugin_lang_option()
//
// Returns true if string is "C" or "JAVA" ignoring case. Otherwise, false.
///////////////////////////////////////////////////////////////////////////////
bool is_valid_umplugin_lang_option (const sqluint8* a_string);

///////////////////////////////////////////////////////////////////////////////
// is_value_32bit()
//
// Returns 1 if the string is 32BIT (case insensitive) and 0 otherwise.
// String will be converted to upper case if it is a valid value
///////////////////////////////////////////////////////////////////////////////
bool is_value_32bit (sqluint8* a_string);
...
private:
  ...
  SQLO_MEM_POOL*                     entry_pool;        // new entry storage
...
#define SQLQG_PROCEDURE_OPTION "PROCEDURE"

///////////////////////////////////////////////////////////////////////////////
// Valid wrapper options
// The following is a list of currently supported  wrapper options
//
...
///////////////////////////////////////////////////////////////////////////////
//    Wrapper Option: DB2_SOURCE_CLIENT_MODE
//       Description: Whether remote client is 32bit on 64bit instance or not.
// Optional/Required: Optional
//     Default value: NONE
//      Valid values: '32BIT' (case insensitive)
// Extracted/verified by: UnfencedWrapper class.
///////////////////////////////////////////////////////////////////////////////
#define SQLQG_WRAPPER_CLIENT_MODE_OPTION  "DB2_SOURCE_CLIENT_MODE"
#define SQLQG_32BIT                       "32BIT"
...
// String constant for DB2 compiler to identify that statement passed in
// is SQL-- that should be directly pushed into BLU
#define SQLQG_BLUQUERY "BLUQUERY"

/// CDE wrapper library name
#define SQLQG_DB2BLU_LIBRARY_NAME  OSSE_SHARED_LIB_NAME(db2cde)
