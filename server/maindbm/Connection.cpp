...
GenericSrvConnection::GenericSrvConnection(MainDbmServerObject& obj_, ServerConnectionType connectionType_)
...
GenericPrivilegedSrvConnection::GenericPrivilegedSrvConnection(MainDbmServerObject& obj_, ServerConnectionType connectionType_) :
...
AdminSrvConnection::AdminSrvConnection(MainDbmServerObject& obj_) :
...
void AdminSrvConnection::getUserAuth( const char* guardType, const char* user, CommMsgBody& /*clientExtra*/, CommMsgBody& authBody )
{
	...
	obj.postToLogin(DBM_Q_USER_AUTH, request, 
		new AdminAuthAsyncCall(obj, &MainDbmServerObject::receiveAdminAuth, this->id()));
}

///////////////////////////////////////////////////////////////////////////////

TrustedAdminSrvConnection::TrustedAdminSrvConnection(MainDbmServerObject& obj_) :
