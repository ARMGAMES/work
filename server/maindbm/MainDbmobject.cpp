...
/* static */ CommServerNullGuardFactory MainDbmServerObject::guardFactory;
/* static */ CommServerPlainTextPasswordSidGuardFactory MainDbmServerObject::authGuardFactory;
/* static */ CommClientNullGuardFactory MainDbmServerObject::clientNullGuardFactory;

////////////////////////////////////////////////////////////////////////////////

MainDbmServerObject::MainDbmServerObject(_CommInterface& inter) : 
...
MainDbmServerObject::~MainDbmServerObject()
{
	if (heLogger)
	{
		stopHeLogger();
...
bool MainDbmServerObject::registerAllFactories() // override
{
...
void MainDbmServerObject::init(CommMsgBody& initMsg)
{
...
void MainDbmServerObject::dynamicInit()
{
	PLog("dynamicInit");
...
void MainDbmServerObject::startup()
{
	if (dumpFile.length())
	{
		try
...
/*virtual*/ void MainDbmServerObject::shutdown() // override
{
	if (dumpFile.length())
	{
		try
...
void MainDbmServerObject::postReply(GenericSrvConnection* pConn, UINT32 msgId, CommMsgBody& body)
{
	if (pConn)
	{
...
void MainDbmServerObject::setReply(CommMsgBody& reply, INT16 errCode, const char* errDesc /*= ""*/)
{
...
void MainDbmServerObject::replyMsg(UINT32 connId, UINT32 msgId, CommMsgBody& body)
{
	if (!connId)
	{
...
void MainDbmServerObject::processCallback(UINT32 reqId, UINT32 msgId, const CommMsgBody& body, CommClientGConnection::AsyncCall* pCall)
{
...
void MainDbmServerObject::processCommonServerMessage(UINT32 msgId, const CommMsgBody& body, ServerConnectionType connType, GenericSrvConnection* conn)
{
...
void MainDbmServerObject::startHeLogger(const char * strServerAddress, const char * strStationName )
{
	PLog(__FUNCTION__);
...
void MainDbmServerObject::stopHeLogger()
{
	PLog(__FUNCTION__);
...
void MainDbmServerObject::reportPerformance()
{
	PTRACE(__FUNCTION__);
...
void MainDbmServerObject::processTimerMessage( UINT32 /*handle*/, UINT32 msgId, CommMsgBody& body )
{
	HiresCounter counter;
