...
void MainDbmServerObject::processAdminMessage(UINT32 msgId, const CommMsgBody& body, GenericSrvConnection* conn)
{
...
void MainDbmServerObject::processTrustedAdminMessage(UINT32 msgId, const CommMsgBody& body, GenericSrvConnection* conn)
{
...
void MainDbmServerObject::processKillServer(const char* adminId)
{
...
void MainDbmServerObject::processRereadSettings(const char* adminId, CommMsgBody& reply)
{
...
void MainDbmServerObject::receiveAdminAuth(UINT32 /*replyId*/, CommMsgParser& parser, AdminAuthAsyncCall& callState)
{
	INT16 errCode;
...
bool MainDbmServerObject::checkAdminRight(const char* right, const GenericPrivilegedSrvConnection* pConn, CommMsgBody& reply)
{
